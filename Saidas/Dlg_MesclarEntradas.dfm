inherited DlgMesclarEntradas: TDlgMesclarEntradas
  Left = 243
  Top = 164
  Width = 750
  Height = 406
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 334
      AutoSize = True
      Caption = 'Compras Realizadas ao Fornecedor'
  ...
  inherited pnDados: TTS_Panel
    ...
    object TS_Label1: TTS_Label
      ...
      Top = 12
      Width = 419
      Caption = 'Informe o N'#250'mero da Nota a Devolver, (BRANCO  = Todas as Notas):'
      FormatoTabela = False
      LinkToResult = 0
    end
    ...
    object dbgItens: TTS_QDBGrid
      ...
      object dbgItensQTDRECEBIDA: TdxDBGridColumn
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      #9'tp.Descricao as DescTipoPadrao'
        ...
        'Movimento)  INNER JOIN TiposPadrao tp ON tp.TipoPadrao = t.TipoP' +
        'adrao)  '
      
        'Where (XX) and e.Situacao = '#39'N'#39'  and KK and  e.TipoPadrao in (ZZ' +
  ...
  object Q_Itens: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select ei.*, i.TipoItem, i.Codigo, i.Referencia, ei.QtdRecebida ' +
        'as OldQtdRecebida'
      'from EntradasItens ei LEFT JOIN Itens i ON ei.Item = i.Item'
      'Where ei.Entrada = :ENTRADA and ei.Status <> '#39'H'#39
      'order by ei.Ordem')
    Left = 235
    Top = 184
    ParamData = <
  ...
  object Q_Filhos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select ei.*, i.codigo, i.descricao '
      'from entradasitensfilhos ei, itens i '
      'where ei.item = i.item and ei.entradaitem = :IDITEM')
    Left = 311
    Top = 185
    ParamData = <
      item
  ...
  object Q_PesquisaNota: TIBQuery
    Database = DMProjeto.DB_Projeto
    Transaction = DMProjeto.IBT_Projeto
    BufferChunks = 1000
    CachedUpdates = False
