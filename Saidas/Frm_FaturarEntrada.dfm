inherited FrmFaturarEntrada: TFrmFaturarEntrada
  Left = 136
  Top = 139
  Width = 1135
  Height = 491
  ...
  inherited pnDados: TTS_Panel
    ...
    object GridMovs: TTS_QDBGrid
      ...
      object GridMovsEntrada: TdxDBGridColumn
        Caption = 'Entrada'
        DisableEditor = True
        HeaderAlignment = taCenter
        Visible = False
    ...
    object Panel1: TPanel
      ...
      object lcbTipoMovimento: TTS_LookupComboBox
        Left = 469
        Top = 8
        Width = 265
        Font.Charset = ANSI_CHARSET
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      '    left join statussaidas ss on s.status = ss.status'
      'Where s.Situacao = '#39'N'#39
      'and s.TipoPadrao in (101)'
      'and s.Data >= :DataInicial'
      'and s.Data <= :DataFinal'
      'order by s.entrada asc, s.numero asc')
    UniDirectional = True
    Left = 31
    Top = 114
    ParamData = <
  ...
  object C_Movimentos: TClientDataSet
    ...
    object C_MovimentosDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  ...
  object Q_EntradasItens: TIBQuery
    Database = DMProjeto.DB_Projeto
    Transaction = DMProjeto.IBT_Projeto
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * '
      'from entradasitens ss'
      'where ss.entrada = :entrada')
    Left = 32
    Top = 220
    ParamData = <
      item
  ...
  object Q_EntradasItensDs: TDataSource
    DataSet = Q_EntradasItens
    Left = 291
    Top = 221
  end
  object P_EntradasItens: TDataSetProvider
    DataSet = Q_EntradasItens
    Constraints = True
    Left = 115
    Top = 219
  end
  object C_EntradasItens: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'P_EntradasItens'
    Left = 201
    Top = 221
  end
  object Q_Titulos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select tr.id, tr.titulo '
      'from titulosareceber tr '
      'where tr.venda = :entrada and tr.pdv = :pdv'
      'order by tr.pdv asc, tr.venda asc, tr.id asc')
    Left = 30
    Top = 280
    ParamData = <
      item
  ...
  object Q_TiposMovimento: TIBQuery
    ...
    SQL.Strings = (
      'select tm.tipomovimento, tm.descricao, tm.tipopadrao,'
      
        'coalesce(tm.siglainicial, upper(substring(tm.descricao from 1 fo' +
        'r 2))) as siglainicial,'
      'coalesce(tm.baixaestoque, '#39'N'#39') as baixaestoque,'
      'coalesce(tm.baixaestoquefiscal, '#39'N'#39') as baixaestoquefiscal,'
      'coalesce(tm.calccomissao, '#39'N'#39') as calccomissao,'
      'coalesce(tm.gerafinanceiro, '#39'N'#39') as gerafinanceiro,'
      'coalesce(tm.tipoimpressao_op, '#39'N'#39') as tipoimpressao_op,'
      'coalesce(tm.possuiicms, '#39'N'#39') as possuiicms,'
      'coalesce(tm.possuiipi, '#39'N'#39') as possuiipi,'
      'coalesce(tm.possuiiss, '#39'N'#39') as possuiiss,'
      'coalesce(tm.possuientrega, '#39'N'#39') as possuientrega,'
      'coalesce(tm.modelodoc, '#39'01'#39') as modelodoc,'
      'coalesce(tm.cb_notafiscal, '#39'N'#39') as cb_notafiscal,'
      'coalesce(tm.serie,'#39'01'#39') as SerieNota'
      'from tiposmovimento tm'
      'where tm.tipomovimento = 2'
      'order by tm.tipomovimento asc')
    Left = 607
    Top = 126
    object Q_TiposMovimentoTIPOMOVIMENTO: TIntegerField
      FieldName = 'TIPOMOVIMENTO'
      Origin = 'TIPOSMOVIMENTO.TIPOMOVIMENTO'
      Required = True
    end
    object Q_TiposMovimentoDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Origin = 'TIPOSMOVIMENTO.DESCRICAO'
      Size = 50
    end
    object Q_TiposMovimentoTIPOPADRAO: TIntegerField
      FieldName = 'TIPOPADRAO'
      Origin = 'TIPOSMOVIMENTO.TIPOPADRAO'
    end
    object Q_TiposMovimentoBAIXAESTOQUE: TIBStringField
      FieldName = 'BAIXAESTOQUE'
      Origin = 'TIPOSMOVIMENTO.BAIXAESTOQUE'
      Size = 1
    end
    object Q_TiposMovimentoBAIXAESTOQUEFISCAL: TIBStringField
      FieldName = 'BAIXAESTOQUEFISCAL'
      Origin = 'TIPOSMOVIMENTO.BAIXAESTOQUEFISCAL'
      FixedChar = True
      Size = 1
    end
    object Q_TiposMovimentoCALCCOMISSAO: TIBStringField
      FieldName = 'CALCCOMISSAO'
      Origin = 'TIPOSMOVIMENTO.CALCCOMISSAO'
      Size = 1
    end
    object Q_TiposMovimentoGERAFINANCEIRO: TIBStringField
      FieldName = 'GERAFINANCEIRO'
      Origin = 'TIPOSMOVIMENTO.GERAFINANCEIRO'
      Size = 1
    end
    object Q_TiposMovimentoTIPOIMPRESSAO_OP: TIBStringField
      FieldName = 'TIPOIMPRESSAO_OP'
      Origin = 'TIPOSMOVIMENTO.TIPOIMPRESSAO_OP'
      Size = 3
    end
    object Q_TiposMovimentoPOSSUIICMS: TIBStringField
      FieldName = 'POSSUIICMS'
      Origin = 'TIPOSMOVIMENTO.POSSUIICMS'
      Size = 1
    end
    object Q_TiposMovimentoPOSSUIIPI: TIBStringField
      FieldName = 'POSSUIIPI'
      Origin = 'TIPOSMOVIMENTO.POSSUIIPI'
      Size = 1
    end
    object Q_TiposMovimentoPOSSUIISS: TIBStringField
      FieldName = 'POSSUIISS'
      Origin = 'TIPOSMOVIMENTO.POSSUIISS'
      Size = 1
    end
    object Q_TiposMovimentoPOSSUIENTREGA: TIBStringField
      FieldName = 'POSSUIENTREGA'
      Origin = 'TIPOSMOVIMENTO.POSSUIENTREGA'
      Size = 1
    end
    object Q_TiposMovimentoMODELODOC: TIBStringField
      FieldName = 'MODELODOC'
      Origin = 'TIPOSMOVIMENTO.MODELODOC'
      Size = 2
    end
    object Q_TiposMovimentoCB_NOTAFISCAL: TIBStringField
      FieldName = 'CB_NOTAFISCAL'
      Size = 1
    end
    object Q_TiposMovimentoSIGLAINICIAL: TIBStringField
      FieldName = 'SIGLAINICIAL'
      Size = 50
    end
    object Q_TiposMovimentoSERIENOTA: TIBStringField
      FieldName = 'SERIENOTA'
      Size = 3
    end
  end
