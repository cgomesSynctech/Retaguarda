...
procedure TDMSaidas.RateiaDesconto;
var
    SomaRateio: Currency;
begin
    inherited;

    C_Itens.AfterPost := nil;
    C_Itens.BeforePost := nil;
    SomaRateio := 0.00;
    if (C_TabelaDesconto.Value <> 0) then begin
            C_Itens.DisableControls;
            C_Itens.First;
            while not C_Itens.EOF do
                begin
                    ...
                    C_ItensBASECALCICMSPROD.Value := C_ItensSubTotal.Value - SomaRateio;
                    C_Itens.Post;
                    C_Itens.Next;
                end;
    ...
    C_Itens.AfterPost := C_ItensAfterPost;
    C_Itens.BeforePost := C_ItensBeforePost;
End;
