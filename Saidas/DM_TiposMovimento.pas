...
type
  TDMTiposMovimento = class(TDMManutencao)
    ...
    C_TabelaCB_NOTAENTREGA: TStringField;
    C_TabelaCB_CSTPISCOFINSPADRAO: TStringField;
    Q_CSTPISCONFINS: TIBQuery;
    P_CSTPISCONFINS: TDataSetProvider;
    C_CSTPISCONFINS: TClientDataSet;
    C_CSTPISCONFINSCSTPISCOFINS: TStringField;
    C_CSTPISCONFINSDESCRICAO: TStringField;
    C_CSTPISCONFINSDs: TDataSource;
    C_TabelaCST_PIS_COFINS_MOVIMENTO: TStringField;
    C_TabelalkCST_PisCofinsPadrao: TStringField;
    C_TabelaCB_CSTIPIPADRAO: TStringField;
    C_TabelaCST_IPI_PADRAO: TStringField;
    Q_CSTIPI: TIBQuery;
    ...
    C_TabelalkCSTIPI: TStringField;
    C_TabelaCB_DOC2: TStringField;
    C_TabelaTIPOIMPRESSAO_OP2: TStringField;
    C_TabelaDescTipoImpressao2: TStringField;
    Q_CSTRTC: TIBQuery;
    P_CSTRTC: TDataSetProvider;
    C_CSTRTC: TClientDataSet;
    C_CSTRTCds: TDataSource;
    Q_ClassTribRTC: TIBQuery;
    P_ClassTribRTC: TDataSetProvider;
    C_ClassTribRTC: TClientDataSet;
    C_ClassTribRTCds: TDataSource;
    C_CSTRTCCST: TStringField;
    C_CSTRTCDESCRICAO: TStringField;
    C_ClassTribRTCCODIGO: TStringField;
    C_ClassTribRTCDESCRICAO: TStringField;
    C_TabelaCST_RTC_PADRAO: TStringField;
    C_TabelaCB_CST_RTC_PADRAO: TStringField;
    C_TabelaCB_CLASSTRIB_RTC_PADRAO: TStringField;
    C_TabelaCLASSTRIB_RTC_PADRAO: TStringField;
    C_TabelalkCST_RTC_PADRAO: TStringField;
    C_TabelalkCLASSTRIB_RTC: TStringField;
