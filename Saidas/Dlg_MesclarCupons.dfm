inherited DlgMesclarCupons: TDlgMesclarCupons
  Left = 321
  Top = 159
  Width = 750
  Height = 377
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbEstadoForm: TTS_Label
      Top = 25
      Width = 273
      Caption = 'Escolha as Opera'#231#245'es e os Itens que ser'#227'o aproveitados'
    end
  ...
  inherited pnDados: TTS_Panel
    ...
    object GridMovs: TTS_QDBGrid
      ...
      object GridMovsPedidoCliente: TdxDBGridColumn
        Caption = 'Ped. Cliente'
        DisableEditor = True
        HeaderAlignment = taCenter
        Width = 78
      ...
      object GridMovsVendedor: TdxDBGridColumn
        Caption = 'Vendedor'
        DisableEditor = True
        HeaderAlignment = taCenter
        Visible = False
    ...
    object dbgItens: TTS_QDBGrid
      ...
      object dbgItensUNIDADE: TdxDBGridColumn
        Caption = 'Unidade'
        DisableEditor = True
        Width = 51
        BandIndex = 0
      ...
      object dbgItensPRECOTABELA: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensFUNCPRODUCAO: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensCOLUNA1: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensCOLUNA2: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensCOLUNA3: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensCOLUNA4: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensCONTRATOREF: TdxDBGridMaskColumn
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
        HeaderAlignment = taCenter
      ...
      object dbgItensSITUACAOECF: TdxDBGridColumn
        Caption = 'Trib.'
        Color = 15461355
        DisableCustomizing = True
        DisableEditor = True
    ...
    object dfCupom: TTS_Edit
      Left = 540
      Top = 8
      Width = 78
      TabOrder = 0
      OnKeyPress = dfCupomKeyPress
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      'Select     s.*,'
      '    f.Nome, t.Descricao as DescTipoMov, '
      '    tp.Descricao as DescTipoPadrao,'
      '    v.Nome as NomeVendedor'
      'From Saidas s '
      '         INNER JOIN Favorecidos f ON f.Favorecido = s.Favorecido'
      
        '         INNER JOIN TiposMovimento t ON t.TipoMovimento = s.Tipo' +
        'Movimento'
      ...
      ''
      'Where     s.Situacao = '#39'N'#39'  and KK and  s.TipoPadrao in (ZZ)'
  ...
  object C_Movimentos: TClientDataSet
    ...
    object C_MovimentosNOMEVENDEDOR: TStringField
      FieldName = 'NOMEVENDEDOR'
  ...
  object Q_Itens: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select si.*, i.TipoItem, i.Codigo, i.Referencia, si.QtdFaturada ' +
        'as OldQtdFaturada'
      'from SaidasItens si '
      '        INNER JOIN Itens i ON si.Item = i.Item'
      'Where '
      'si.Saida = :SAIDA and si.pdv = :PDV and '
      'si.Status <> '#39'H'#39'  and '
      'si.situacao <> '#39'C'#39' and'
      '(si.situacaoecf <> '#39'C'#39')'
      'order by si.Ordem')
    Left = 235
    Top = 184
    ParamData = <
  ...
  object C_Itens: TClientDataSet
    ...
    object C_ItensUSOTIPOITEM: TStringField
      FieldName = 'USOTIPOITEM'
      Origin = 'SAIDASITENS.USOTIPOITEM'
      Size = 15
    end
    ...
    object C_ItensHASCHILDREN: TStringField
      FieldName = 'HASCHILDREN'
      Origin = 'SAIDASITENS.HASCHILDREN'
      Size = 1
    end
    ...
    object C_ItensCONTRATOREF: TIntegerField
      FieldName = 'CONTRATOREF'
      Origin = 'SAIDASITENS.CONTRATOREF'
    end
    ...
    object C_ItensOLDQTDFATURADA: TFloatField
      FieldName = 'OLDQTDFATURADA'
    end
