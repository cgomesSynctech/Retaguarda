inherited DlgFaturarPedidos: TDlgFaturarPedidos
  Left = 149
  Top = 126
  Width = 750
  Height = 390
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 288
      AutoSize = True
      Caption = 'Aproveitamento de Opera'#231#245'es'
  ...
  inherited pnDados: TTS_Panel
    ...
    object lbReducao: TTS_Label
      Left = 458
      Top = 29
      Width = 74
      Caption = 'Acrescimo de:'
      Visible = False
      FormatoTabela = False
      LinkToResult = 0
    end
    ...
    object cbPrecoCompra: TTS_CheckBox
      Left = 308
      Top = 27
      Width = 130
      ...
      TabOrder = 4
      Visible = False
      Caption = 'Pelo pre'#231'o de compra'
      StyleController = DMProjeto.esClientes
      OnChange = cbPrecoCompraChange
      DisableEdit = False
      Height = 19
    end
  end
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      #9'v.Nome as NomeVendedor'
      'From Saidas s '
      '    left JOIN Favorecidos f ON s.Favorecido = f.Favorecido'
      '    LEFT JOIN Favorecidos v ON  s.Vendedor = v.Favorecido'
      
        '    INNER JOIN TiposMovimento t ON t.TipoMovimento = s.TipoMovim' +
        'ento'
      '    INNER JOIN TiposPadrao tp ON tp.TipoPadrao = t.TipoPadrao'
      ''
      'Where '#9's.Situacao = '#39'N'#39'  and KK and  s.TipoPadrao in (ZZ)'
      'and '#9's.Favorecido in (XX)'
      '')
    UniDirectional = True
    Left = 49
    Top = 180
  ...
  object C_Movimentos: TClientDataSet
    ...
    object C_MovimentosPCOMISSAO: TBCDField
      FieldName = 'PCOMISSAO'
  ...
  object Q_Itens: TIBQuery
    ...
    SQL.Strings = (
      ...
      'Where si.Saida = :SAIDA and si.Status <> '#39'H'#39
      'order by si.Ordem')
    Left = 236
    Top = 183
    ParamData = <
  ...
  object C_Itens: TClientDataSet
    ...
    object C_ItensPRECOTABELA: TBCDField
      FieldName = 'PRECOTABELA'
    ...
    object C_ItensQTDFATURADA: TBCDField
      FieldName = 'QTDFATURADA'
    ...
    object C_ItensOLDQTDFATURADA: TBCDField
      FieldName = 'OLDQTDFATURADA'
      Origin = 'SAIDASITENS.OLDQTDFATURADA'
      Precision = 18
      Size = 3
    end
    ...
    object C_ItensPRECOSEMPROMOCAO: TBCDField
