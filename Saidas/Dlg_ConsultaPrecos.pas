...
begin
  inherited;
  if (DMProjeto.GetParametrosForm(1) <> null) and dfCliente.Visible then //Cliente da Venda, a tabela de preços já deve ser a do cliente.
