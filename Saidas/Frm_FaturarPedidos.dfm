inherited FrmFaturarPedidos: TFrmFaturarPedidos
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'order by s.saida asc, s.numero asc')
    UniDirectional = True
    Left = 31
    Top = 114
    ParamData = <
  ...
  object Q_SaidasItens: TIBQuery
    ...
    SQL.Strings = (
      'select * '
      'from saidasitens ss'
      'where ss.saida = :saida and ss.pdv = :pdv')
    Left = 32
    Top = 220
    ParamData = <
      item
  ...
  object Q_Titulos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'where tr.venda = :saida and tr.pdv = :pdv '
  ...
  object Q_TiposMovimento: TIBQuery
    ...
    SQL.Strings = (
      ...
      'where tm.tipopadrao = 1 and tm.tipomovimento not in (7, 700)'
