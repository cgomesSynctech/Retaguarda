inherited DMEstimates: TDMEstimates
  Top = 89
  Height = 597
  ...
  inherited Q_TiposMovimento: TIBQuery
    SQL.Strings = (
      ...
      'From TiposMovimento t '
        ...
        '          inner join TiposPadrao tp on t.TipoPadrao = tp.TipoPad' +
        'rao '
      'Where t.TipoPadrao = 3 and t.Tipo = '#39'S'#39
  ...
  inherited Q_Status: TIBQuery
    SQL.Strings = (
      ...
      'where status not in ('#39'B'#39', '#39'C'#39', '#39'E'#39')'
      'order by Ordem')
  end
end
