inherited FrmTransfereReposicao: TFrmTransfereReposicao
  Left = 86
  Top = 145
  Width = 1135
  Height = 491
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 357
      AutoSize = True
      Caption = 'Reposi'#231#245'es para Transfer'#234'ncia Almox'
  ...
  object C_Movimentos: TClientDataSet
    ...
    object C_MovimentosORIGEM: TIntegerField
      FieldName = 'ORIGEM'
      Required = True
    end
    object C_MovimentosDESTINO: TIntegerField
      FieldName = 'DESTINO'
      Required = True
    end
  end
