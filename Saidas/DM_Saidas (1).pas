...
begin
    ...
    SomaRateio := 0.00;
    if (C_TabelaVALORSEGURO.Value <> null) then
        begin
            C_Itens.DisableControls;
            C_Itens.First;
            while not C_Itens.EOF do
    ...
    SomaRateio := 0.00;
    if (C_TabelaFRETE.Value <> null) then
        begin
            C_Itens.DisableControls;
            C_Itens.First;
            while not C_Itens.EOF do
...
begin
    ...
    try
        ...
        if (DMProjeto.Parametro('Lei1274112') = 'S') and (C_TiposMovimentoCB_NOTAFISCAL.Value = 'S') then
            begin
