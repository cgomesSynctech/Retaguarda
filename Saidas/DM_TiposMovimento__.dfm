inherited DMTiposMovimento: TDMTiposMovimento
  ...
  inherited U_Tabela: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  ALIQPIS_MOVIMENTO = :ALIQPIS_MOVIMENTO,'
      '  ALIQCOFINS_MOVIMENTO = :ALIQCOFINS_MOVIMENTO,'
    ...
    InsertSQL.Strings = (
      ...
      '  (DESCRICAO, TIPO, BAIXAESTOQUE, CALCCOMISSAO, GERAFINANCEIRO, '
      'POSSUIENTREGA, '
      ...
      'TIT1_IPI, '
        ...
        '   TIT2_IPI, CB_IPI, POSSUITAX, CB_LICITACAO, CB_CFOP, TIT1_CFOP' +
        ', '
      'TIT2_CFOP, '
      '   TIPOCOB_PADRAO, CB_NOTAFISCAL, TIPONOTAFISCAL, '
      'TEMPLATENOTAFISCAL, CB_DUPLICATA, '
      '   CB_BOLETO, CB_CARNE, CB_RECIBO, CB_IMPDOC, CB_IDENTIFICACAO, '
      'CB_OPCOESIMPRESSAO, '
      '   TEMPLATEDUPLICATA, TEMPLATEBOLETO, CB_DESCONTOITEM, '
      'CB_COMPENSACAO, '
      '   CB_COMPENSACAONOCUSTO, TIPO_CARTEIRA_PADRAO, '
      'CB_ORDEM_IMP_ITENS, CB_DUPLICATA_IMPRESSA, '
      '   CB_ENTRADAPRECOVENDA, CB_IMPRESSAOSEMVALORES, '
      'BAIXAESTOQUEFISCAL, CB_SOLICITACAOALMOX, '
      '   CB_CARNEIDENTIFICADO, LIVROFISCAL, CST_PIS_COFINS_MOVIMENTO, '
      'ALIQPIS_MOVIMENTO, '
      '   ALIQCOFINS_MOVIMENTO, CALCULAPISCOFINS, CB_CSTPADRAO, '
      'CST_PADRAO, ORDEM, '
      '   IND_EMIT, ORIGEMREPLIC, CB_IMPRESSORAPADRAO, NOMEIMPRESSORA, '
      'PAPELIMPRESSORA, '
      '   COD_CTA, CB_MENSAGEMTRIBUTOS)'
      'values'
      
        '  (:DESCRICAO, :TIPO, :BAIXAESTOQUE, :CALCCOMISSAO, :GERAFINANCE' +
        'IRO, '
      ':POSSUIENTREGA, '
      '   :BLOQUEARSEATRASADO, :BLOQUEARPORSITUACAO, '
      ':BLOQUEARPORESTOQUE, :LIMITEFAVORECIDO, '
      ...
      ':POSSUITAX, '
        ...
        '   :CB_LICITACAO, :CB_CFOP, :TIT1_CFOP, :TIT2_CFOP, :TIPOCOB_PAD' +
        'RAO, '
      ':CB_NOTAFISCAL, '
      
        '   :TIPONOTAFISCAL, :TEMPLATENOTAFISCAL, :CB_DUPLICATA, :CB_BOLE' +
        'TO, '
      ':CB_CARNE, '
      
        '   :CB_RECIBO, :CB_IMPDOC, :CB_IDENTIFICACAO, :CB_OPCOESIMPRESSA' +
        'O, '
      ':TEMPLATEDUPLICATA, '
      '   :TEMPLATEBOLETO, :CB_DESCONTOITEM, :CB_COMPENSACAO, '
      ':CB_COMPENSACAONOCUSTO, '
      '   :TIPO_CARTEIRA_PADRAO, :CB_ORDEM_IMP_ITENS, '
      ':CB_DUPLICATA_IMPRESSA, '
      '   :CB_ENTRADAPRECOVENDA, :CB_IMPRESSAOSEMVALORES, '
      ':BAIXAESTOQUEFISCAL, '
      '   :CB_SOLICITACAOALMOX, :CB_CARNEIDENTIFICADO, :LIVROFISCAL, '
      ':CST_PIS_COFINS_MOVIMENTO, '
      
        '   :ALIQPIS_MOVIMENTO, :ALIQCOFINS_MOVIMENTO, :CALCULAPISCOFINS,' +
        ' '
      ':CB_CSTPADRAO, '
      '   :CST_PADRAO, :ORDEM, :IND_EMIT, :ORIGEMREPLIC, '
      ':CB_IMPRESSORAPADRAO, '
      '   :NOMEIMPRESSORA, :PAPELIMPRESSORA, :COD_CTA, '
      ':CB_MENSAGEMTRIBUTOS)')
    DeleteSQL.Strings = (
