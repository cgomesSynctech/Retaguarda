inherited FrmRomaneioSeparacao: TFrmRomaneioSeparacao
  Left = 330
  Top = 141
  Width = 678
    ...
    inherited sbDados: TTS_Panel
      ...
      object TS_Panel1: TTS_Panel
        ...
        object dbgItens: TTS_QDBGrid
          ...
          Font.Style = []
          ParentFont = False
          PopupMenu = ppmGridRomaneioSeparacao
          TabOrder = 0
          ...
          BandFont.Style = []
          DataSource = DMRomaneioSeparacao.C_DetalheDs
          Filter.Criteria = {00000000}
          ...
          object dbgItensTOTAL: TdxDBGridCurrencyColumn
            Caption = 'Total'
            BandIndex = 0
            RowIndex = 0
            FieldName = 'TOTAL'
  ...
  object Q_Separacao: TIBQuery
    Database = DMProjeto.DB_Projeto
    Transaction = DMProjeto.IBT_Projeto
    OnCalcFields = Q_SeparacaoCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT l.loteseparacao,'
      '       l.data,'
      '       li.descricao as Localizacao,'
      '       g.descricaogrupo,'
      '       i.Descricao as Item,'
      '       si.fator,'
      '       si.unidade,'
      ...
      'FROM lotesseparacao l'
      
        '   Inner join lotesseparacaosaidas ls on ls.loteseparacao = l.lo' +
        'teseparacao'
      ...
      '   Left Join LOCALIZACOES li ON Li.LOCALIZACAO = I.LOCALIZACAO'
      '   left join ALMOXARIFADOS a on si.ALMOXARIFADO = a.ALMOXARIFADO'
      'where l.loteseparacao = :LOTESEPARACAO'
      'Group By l.loteseparacao,'
      '       l.data,'
      '       li.descricao ,'
      '       g.descricaogrupo,'
      '       i.Descricao,'
      ...
      '       a.DESCRICAO,'
      '       iu.qtdembalagem'
      'Order By li.Descricao desc,  g.descricaogrupo, i.descricao')
    Left = 300
    Top = 297
    ParamData = <
      item
    ...
    object Q_SeparacaoLOTESEPARACAO: TIntegerField
    ...
    object Q_SeparacaocQtdEmb: TFloatField
  ...
  object ppmGridRomaneioSeparacao: TTS_PopupMenu
    Left = 128
    Top = 225
  end
  object ppDBSeparacao: TppDBPipeline
    ...
    Left = 258
    Top = 188
    object ppDBSeparacaoppField1: TppField
      Alignment = taRightJustify
      FieldAlias = 'LOTESEPARACAO'
      FieldName = 'LOTESEPARACAO'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 0
    ...
    object ppDBSeparacaoppField2: TppField
      FieldAlias = 'DATA'
      FieldName = 'DATA'
      FieldLength = 0
      DataType = dtDate
    ...
    object ppDBSeparacaoppField3: TppField
    ...
    object ppDBSeparacaoppField4: TppField
    ...
    object ppDBSeparacaoppField5: TppField
      FieldAlias = 'ITEM'
      FieldName = 'ITEM'
      FieldLength = 50
      DisplayWidth = 50
    ...
    object ppDBSeparacaoppField6: TppField
      Alignment = taRightJustify
      FieldAlias = 'FATOR'
      FieldName = 'FATOR'
      FieldLength = 0
    ...
    object ppDBSeparacaoppField7: TppField
      FieldAlias = 'UNIDADE'
      FieldName = 'UNIDADE'
      FieldLength = 6
      DisplayWidth = 6
    ...
    object ppDBSeparacaoppField8: TppField
    ...
    object ppDBSeparacaoppField9: TppField
      Alignment = taRightJustify
    ...
    object ppDBSeparacaoppField10: TppField
      FieldAlias = 'CODIGO'
      FieldName = 'CODIGO'
      FieldLength = 13
      DisplayWidth = 13
    ...
    object ppDBSeparacaoppField11: TppField
    ...
    object ppDBSeparacaoppField12: TppField
      Alignment = taRightJustify
      FieldAlias = 'QTDITEM'
      FieldName = 'QTDITEM'
      FieldLength = 3
    ...
    object ppDBSeparacaoppField13: TppField
      Alignment = taRightJustify
      FieldAlias = 'cQtdEmb'
      FieldName = 'cQtdEmb'
      FieldLength = 0
  ...
  object ppSeparacao: TppReport
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel35: TppLabel
        UserName = 'Label35'
        Caption = 'Separa'#231#227'o N'#186':'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Tahoma'
        Font.Size = 10
