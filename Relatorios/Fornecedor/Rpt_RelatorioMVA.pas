...
uses
  ...
  TS_DateTimePicker, CheckLst, TS_CheckListBox, TS_PopupEdit;
...
type
  TRptRelatorioMVA = class(TFormPadrao)
    Q_Consulta: TIBQuery;
    ...
    dbgConsultaMVA: TdxDBGridMaskColumn;
    TS_Label1: TTS_Label;
    DataI: TTS_DateTimePicker;
    TS_Label3: TTS_Label;
    ppeTipoOperacao: TTS_PopupEdit;
    Q_TiposOperacao: TIBQuery;
    P_TiposOperacao: TDataSetProvider;
    C_TiposOperacao: TClientDataSet;
    C_TiposOperacaoDS: TDataSource;
    clbTipoOperacao: TTS_CheckListBox;
    C_TiposOperacaoTIPOMVA: TIntegerField;
    C_TiposOperacaoTIPOMVADESC: TStringField;
    C_ConsultaPRECOCOMPRA: TFloatField;
    C_ConsultaESTOQUE: TBCDField;
    C_ConsultaNCMSH: TStringField;
    C_ConsultaMVA: TStringField;
...
var
  RptRelatorioMVA: TRptRelatorioMVA;
...
procedure TRptRelatorioMVA.FormClose(Sender: TObject; var Action: TCloseAction);
Var
  sValor: String;
begin
//  sValor := 'N';
...
procedure TRptRelatorioMVA.dxBarSubItem4Click(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptRelatorioMVA.btSairClick(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptRelatorioMVA.FormCreate(Sender: TObject);
...
procedure TRptRelatorioMVA.btLayoutLarguraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.LarguraAutomatica( btLayoutLargura.Checked );
end;

procedure TRptRelatorioMVA.btImprimirVisualClick(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.btAgrupamentoPainelClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.MostrarPainelAgrupamento( btAgrupamentoPainel.Checked );
end;

procedure TRptRelatorioMVA.btDadosFiltrarClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AtivarFiltro( btDadosFiltrar.Checked );
end;

procedure TRptRelatorioMVA.btSumarizacaoRodapeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarRodape( btSumarizacaoRodape.Checked );
end;

procedure TRptRelatorioMVA.btLayoutGradeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarGrade( btLayoutGrade.Checked );
end;

procedure TRptRelatorioMVA.TotalizarEmBaixoClick(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.btLayoutFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteCabecalho;
end;

procedure TRptRelatorioMVA.btDadosFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteDados;
end;

procedure TRptRelatorioMVA.btExportacaoHtmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarHtml(self);
end;

procedure TRptRelatorioMVA.btExportacaoExcelClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarExcel(self);
end;

procedure TRptRelatorioMVA.btExportacaoXmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarXml(self);
end;

procedure TRptRelatorioMVA.btExportacaoTextoClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ExportarTexto(self);
end;

procedure TRptRelatorioMVA.btAgrupamentoExpandirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExpandirGrupos;
end;

procedure TRptRelatorioMVA.btLayoutColunasClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AdicionarColunas;
end;

procedure TRptRelatorioMVA.btImprimirImpressoraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.Print;
end;

procedure TRptRelatorioMVA.btAgrupamentoResumirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ResumirGrupos;
end;

procedure TRptRelatorioMVA.btAgrupamentoFontClick(Sender: TObject);
begin
  dbgConsulta.FonteGrupo;
end;

procedure TRptRelatorioMVA.FormShow(Sender: TObject);
var
  sWhere : string;
  ArquivoIni : TIniFile;
...
begin
  ...
  C_TiposOperacao.Open;
  clbTipoOperacao.SetDataSet(C_TiposOperacao);
  clbTipoOperacao.UpdateItems;
  ppeTipoOperacao.Text := clbTipoOperacao.Selecionados( true );
end;

procedure TRptRelatorioMVA.RefreshMsg(var Msg:TMessage);
begin
  Refresh;
end;

procedure TRptRelatorioMVA.Refresh;
begin
...
procedure TRptRelatorioMVA.RefreshDataSets;
var
  i, j:integer;
  Key : Variant;
  s : String;
...
procedure TRptRelatorioMVA.CorFundo1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoDados;
end;

procedure TRptRelatorioMVA.CorFundo2Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoGrupo;
end;

procedure TRptRelatorioMVA.btDadosMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btAgrupamentoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btLayoutMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btSumarizacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btExportacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btImprimirMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.Ajuda1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptRelatorioMVA.RelatrioPadro1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptRelatorioMVA.btHelpClick(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.EnviarparaoEmail1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.PrintEmail(FormsComponent.Caption+';'+DMProject.sNomeEmpresa);
end;

procedure TRptRelatorioMVA.dbgConsultaMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.dbgConsultaDblClick(Sender: TObject);
begin
  inherited;
  bCarregando := false;
end;

procedure TRptRelatorioMVA.BarradeBotoesClick(Sender: TObject);
begin
  inherited;
	TS_Panel1.Visible := not TS_Panel1.Visible;
end;

procedure TRptRelatorioMVA.GridPrinterLinkCustomDrawHeaderCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; AColumn: TdxTreeListColumn; var AText: String;
  var AColor: TColor; AFont: TFont; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var ASorted: TdxCellSortOrder;
...
procedure TRptRelatorioMVA.GridPrinterLinkCustomDrawPageHeader(Sender: TObject;
  ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect; ANom,
  ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
var
  APixel: Integer;
...
procedure TRptRelatorioMVA.GridPrinterLinkCustomDrawReportLinkTitle(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect; ANom,
  ADenom: Integer; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var AColor: TColor; AFont: TFont;
  var ADone: Boolean);
...
procedure TRptRelatorioMVA.GridPrinterLinkMeasureReportLinkTitle(
  Sender: TBasedxReportLink; var AHeight: Integer);
var
  s : String;
begin
...
function TRptRelatorioMVA.getTitulos : string;
var sString : string;
		i : integer;
begin
  sString := '';
...
procedure TRptRelatorioMVA.GerarEtiquetas1Click(Sender: TObject);
var sSQL : string;
begin
  inherited;
...
function TRptRelatorioMVA.getSQLParam(Query : TIBQuery) : string;
var sSQL : string;
		i : integer;
begin
  with Query do begin
...
procedure TRptRelatorioMVA.GridPrinterLinkCustomDrawCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
...
procedure TRptRelatorioMVA.FormatoPijamaClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FormatoPijama;
end;

procedure TRptRelatorioMVA.ConfigurarColunaClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarColuna;
end;

procedure TRptRelatorioMVA.CordaGrade1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.CorGrade;
end;

procedure TRptRelatorioMVA.ppmLayoutPopup(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.AlturaAutomtica1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.AlturaCelula;
end;

procedure TRptRelatorioMVA.ppmSumarizacaoPopup(Sender: TObject);
begin
  inherited;
  with dbgConsulta do begin
...
procedure TRptRelatorioMVA.GridPrinterLinkCustomDrawRowFooterCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
...
procedure TRptRelatorioMVA.CongelarClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.CongelarColuna(dbgConsulta.TS_SelectedColumn);
end;

procedure TRptRelatorioMVA.DescongelarColuna1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.DesCongelarColuna;
end;

procedure TRptRelatorioMVA.ppmDadosPopup(Sender: TObject);
begin
  inherited;
	btDadosFiltrar.Checked := dbgConsulta.Filter.Active;
end;

procedure TRptRelatorioMVA.ppmAgrupamentoPopup(Sender: TObject);
begin
  inherited;
	btAgrupamentoPainel.Checked := dbgConsulta.ShowGroupPanel;
end;

procedure TRptRelatorioMVA.tulodoRelatrio1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.SalvarTemplate1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.CarregarTemplate1Click(Sender: TObject);
...
procedure TRptRelatorioMVA.btAjudaMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.NenhumTemplate1Click(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
    TS_TemplatePadrao := '';
...
procedure TRptRelatorioMVA.setTemplatePadrao;
begin
...
function TRptRelatorioMVA.getTemplatePadrao : string;
begin
  	with Q_SQLReport do begin
    	close;
...
procedure TRptRelatorioMVA.DefinirPadraoClick(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
...
procedure TRptRelatorioMVA.ExcluirTemplate1Click(Sender: TObject);
...
procedure TRptRelatorioMVA.FormResize(Sender: TObject);
begin
  inherited;
...
function TRptRelatorioMVA.getCampos : string;
begin
  with Q_SQLReport do begin
    close;
...
function TRptRelatorioMVA.getTabelas : string;
var sTabelas : string;
		i : integer;
begin
	with Q_SQLReport do begin
...
function TRptRelatorioMVA.getListaTabelas( bSomenteAdicional : boolean = false) : TStringList;
...
procedure TRptRelatorioMVA.CriarCampos;
var i : integer;
		sCampo : string;
begin
	with Q_SQLReport do begin
...
procedure TRptRelatorioMVA.CriarCampo( sCampo, sTitulo, sTipoCampo : string );
...
procedure TRptRelatorioMVA.RemoverCampo( sCampo : string );
begin
...
procedure TRptRelatorioMVA.AdicionarCampo( sTabelas, sCampo, sTitulo, sTipo, sAlias : string );
...
procedure TRptRelatorioMVA.AdicionarSubSelect( sSelect, sAlias, sTitulo, sTipo : string );
var bJaExiste : boolean;
		sCampo : string;
begin
...
function TRptRelatorioMVA.getListaCampos : TStringList;
var i : integer;
...
procedure TRptRelatorioMVA.AlterarCampo( CampoAlterar, Campo, Tabela, Titulo, Tipo, Alias : string);
...
procedure TRptRelatorioMVA.AlterarSubSelect( CampoAlterar, Select, Alias, Titulo, Tipo : string);
var sCampo, sCampoAdicional, sTituloAdicional, sTipoAdicional : string;
		Index : integer;
begin
  with Q_SQLReport do begin
...
procedure TRptRelatorioMVA.TotalizarEmCimaClick(Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.ppmTemplatesPopup(Sender: TObject);
begin
  inherited;
	DefinirPadrao.Enabled := dbgConsulta.TS_TemplatePadrao<>'';
end;

procedure TRptRelatorioMVA.TrocaTemplate( Sender : TObject );
begin
...
procedure TRptRelatorioMVA.btTemplatesMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptRelatorioMVA.btTemplatesMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var i : integer;
 		MenuItem : TMenuItem;
begin
...
procedure TRptRelatorioMVA.ppmSelTemplatePopup(Sender: TObject);
var i : integer;
begin
  inherited;
...
function TRptRelatorioMVA.getTipoCampo( sTabela, sCampo : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
function TRptRelatorioMVA.getTipoCampo( sSQL : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
procedure TRptRelatorioMVA.Adicionar2Click(Sender: TObject);
...
procedure TRptRelatorioMVA.Alterar2Click(Sender: TObject);
var sCampo : String;
		Index : integer;
begin
  inherited;
...
procedure TRptRelatorioMVA.Remover2Click(Sender: TObject);
...
procedure TRptRelatorioMVA.ExecutarArquivo1Click(Sender: TObject);
...
procedure TRptRelatorioMVA.btMostrarCabClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ShowHeader := btMostrarCab.Checked;
end;

procedure TRptRelatorioMVA.btLayoutMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptRelatorioMVA.dbgConsultaMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptRelatorioMVA.ConfigurarPgina1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarPagina( self );
end;

procedure TRptRelatorioMVA.LayoutdeImpresso1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.LayoutImpressao( self );
end;

procedure TRptRelatorioMVA.ConfigurarImpressora1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarImpressora( self );
end;

procedure TRptRelatorioMVA.FormVisible(var Msg: TMessage);
var
...
procedure TRptRelatorioMVA.GridPrinterStartGenerateReport(Sender: TObject;
  AReportLink: TBasedxReportLink);
...
procedure TRptRelatorioMVA.GridPrinterBeforeDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink;
  ADesignWindow: TAbstractdxReportLinkDesignWindow);
begin
  inherited;
...
procedure TRptRelatorioMVA.GridPrinterDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink; var ADone: Boolean);
begin
  inherited;
  if ADone then
...
procedure TRptRelatorioMVA.ConfigurarRelatrio1Click(Sender: TObject);
var i : integer;
begin
  inherited;
...
procedure TRptRelatorioMVA.GravaRelatorio( sRelatorio, sTitulo, sCabecalho, sImpressora : string; nCopias : integer );
begin
	with Q_SQLReport do begin
  	close;
    sql.text := 'update relatorios '+
...
procedure TRptRelatorioMVA.GetFULLSELECT;
Begin
  with Q_FullSelect do Begin
...
procedure TRptRelatorioMVA.Atualizar;
var
  sTipoOperacao: String;
begin
  with C_Consulta do begin Close;
        CommandText := 'select i.codigo,i.descricao,i.clasfiscal,i.precocompra,iv.estoque,im.ncmsh, case i.aliqicmscompra '+
                       ' when ''4'' then im.mva4 '+
                       ' when ''7'' then im.mva7 '+
...
procedure TRptRelatorioMVA.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
...
procedure TRptRelatorioMVA.btAtualizarClick(Sender: TObject);
begin
  inherited;
  Atualizar;
end;

procedure TRptRelatorioMVA.ppeTipoOperacaoCloseUp(Sender: TObject;
