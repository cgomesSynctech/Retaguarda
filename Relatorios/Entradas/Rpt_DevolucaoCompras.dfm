inherited RptDevolucaoCompras: TRptDevolucaoCompras
  Left = 273
  Top = 124
  Width = 773
  Height = 472
  Caption = 'Clientes / Devolu'#231#227'o'
  PixelsPerInch = 96
  TextHeight = 13
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 218
      Caption = 'Devolu'#231#227'o de Compras'
  ...
  inherited pnGrid: TPanel
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      TS_SelectedColumn = 'NOMEFORNECEDOR'
      ...
      object dbgConsultaTOTALFINAL: TdxDBGridMaskColumn
        Caption = 'Total Final'
        HeaderAlignment = taCenter
        Visible = False
        BandIndex = 0
        RowIndex = 0
        FieldName = 'CalcSubTotalItemDesc'
        SummaryFooterType = cstSum
        SummaryFooterFormat = '#,###,##0.00'
      end
    end
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
      'SELECT si.saidaitem, si.saida, si.descricao, si.unidade,'
      
        '       si.quantidade, si.preco, si.subtotalitem, f.nome as nomec' +
        'liente,'
      
        '       v.nome as nomevendedor, s.data, s.numero,  s.favorecido, ' +
        'f.tipofavorecido, gi.descricaogrupo, fb.descricao as fabricante,' +
        ' fn.nome as nomefornecedor, si.customedio*si.fator as customedio' +
        ', si.custocontabil*si.fator as custocontabil, si.rateiodesconto,' +
        ' si.coluna1, si.coluna2, si.coluna3, si.coluna4,'
      '       m.nome as NOMEMEDICO,'
      
        'Extract(year from s.data)||'#39'/'#39'||Extract(month from s.data) as Me' +
        'sAno '
      'FROM'
      'Saidas s '
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaCalcSubTotalItemDesc: TFloatField
  ...
  inherited FormsComponent: TFormsComponent
    ...
    FormColor = 16116702
    Modulo = 'Clientes / Devolu'#231#227'o'
    Caption = 'Devolu'#231#227'o de Compras'
  end
  object Q_TiposMovimentos: TIBQuery
    ...
    SQL.Strings = (
        ...
        'PADRAO in (6) order by DESCRICAO')
    Left = 424
    Top = 152
