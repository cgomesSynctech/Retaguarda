inherited RptEntradaItem: TRptEntradaItem
  Left = 195
  Top = 127
  Width = 1085
  Height = 592
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      SummaryGroups = <
        item
          ...
          SummaryItems = <
            item
              SummaryField = 'QtdEntrada'
              SummaryFormat = '>QtdEntrada=#,###,##0.00'
              SummaryType = cstSum
            end
            item
      ...
      object dbgConsultaQTDENTRADA: TdxDBGridMaskColumn
        Caption = 'Qtd Compras'
        Width = 79
        BandIndex = 0
        RowIndex = 0
      ...
      object dbgConsultaPRECOMEDIO: TdxDBGridMaskColumn
        Caption = 'Pr. Medio'
        BandIndex = 0
        RowIndex = 0
        FieldName = 'PRECOMEDIO'
      end
      object dbgConsultaTOTALCOMPRA: TdxDBGridCurrencyColumn
        Caption = 'Tot. Compras'
        Width = 118
        BandIndex = 0
        RowIndex = 0
      ...
      object dbgConsultaTRIB_FEDERAL: TdxDBGridMaskColumn
        Visible = False
        Width = 181
        BandIndex = 0
        RowIndex = 0
        FieldName = 'TRIB_FEDERAL'
      end
    end
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select sum(ei.quantidade) as QtdEntrada , avg(ei.preco) as preco' +
        'Medio,  cast(sum(ei.quantidade) * avg(ei.preco) as numeric(15,2)' +
        ') as totalCompra , i.item, i.codigo, i.descricao, i.customedio, ' +
        'i.unidade, i.precocompra, i.custocontabil, i.referencia, i.datac' +
        'adastro,'
      'i.cst, i.situacaoecf, i.clasfiscal,'
      
        'gi.descricaogrupo, fb.descricao as fabricante, t.descricao as Tr' +
        'ib_Federal'
      ''
      ...
      '    left join  Grupos gi on gi.grupo = i.grupo'
        ...
        '    group by i.item, i.codigo, i.descricao, i.customedio, i.unid' +
        'ade, i.precocompra, i.custocontabil, i.referencia, i.datacadastr' +
        'o,'
      'i.cst, i.situacaoecf, i.clasfiscal,'
      'gi.descricaogrupo, fb.descricao, t.descricao')
    Left = 314
    Top = 144
  end
  ...
  inherited C_Consulta: TClientDataSet
    Left = 318
    Top = 248
    object C_ConsultaQTDENTRADA: TFloatField
      FieldName = 'QTDENTRADA'
    end
    object C_ConsultaPRECOMEDIO: TFloatField
      FieldName = 'PRECOMEDIO'
    end
    object C_ConsultaTOTALCOMPRA: TBCDField
      FieldName = 'TOTALCOMPRA'
      Precision = 18
      Size = 2
    end
    ...
    object C_ConsultaTRIB_FEDERAL: TStringField
      FieldName = 'TRIB_FEDERAL'
      Size = 30
    end
  end
