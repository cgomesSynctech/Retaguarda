inherited RptOutrasEntradasProdutos: TRptOutrasEntradasProdutos
  Left = 130
  Top = 128
  Width = 747
  Height = 472
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 292
      Caption = 'Outras Entradas com Produtos'
  ...
  inherited pnGrid: TPanel
    ...
    inherited pnDados: TTS_Panel
      ...
      object TS_LCBTipoMovimento: TTS_LookupComboBox
        ...
        TabOrder = 2
        StyleController = DMProjeto.esFornecedores
        OnChange = TS_LCBTipoMovimentoChange
        ClearKey = 32
  ...
  object Q_TiposMovimentos: TIBQuery
    ...
    SQL.Strings = (
        ...
        'PADRAO in (105,150) order by DESCRICAO')
    Left = 424
    Top = 152
