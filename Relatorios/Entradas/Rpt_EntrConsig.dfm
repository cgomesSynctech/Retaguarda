inherited RptEntrConsig: TRptEntrConsig
  Left = 160
  Top = 103
  Height = 461
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        '.descricao as planopagamento, e.totalpgtos, f.codigo, e.totalite' +
        'ns,'
      ...
      'inner join favorecidos f on e.favorecido=f.favorecido '
        ...
        'where e.data >= :iData and e.data <= :fData AND e.tipopadrao=104' +
