inherited RptEntradas: TRptEntradas
  Left = 72
  Top = 101
  Height = 461
  ...
  inherited pnGrid: TPanel
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      object dbgConsultaVALORIPI: TdxDBGridCurrencyColumn
        Caption = 'IPI'
        HeaderAlignment = taCenter
        Visible = False
        Width = 76
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
      ...
      'e.basecalcicms, e.valoricms, e.valoripi,'
      'tm.descricao as tpMovimento'
      'from entradas e  '
      'inner join favorecidos f on e.favorecido=f.favorecido '
        ...
        'left join tiposmovimento tm on tm.tipomovimento = e.tipomoviment' +
        'o'
