object RptPedidosCompra: TRptPedidosCompra
  ...
  object Q_Invoice: TIBQuery
    ...
    object Q_InvoiceOUTRASDESPESAS: TIBBCDField
      FieldName = 'OUTRASDESPESAS'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceJUROS: TIBBCDField
      FieldName = 'JUROS'
      Precision = 18
      Size = 2
    end
    ...
    object Q_InvoiceIMPOSTO: TIBBCDField
      FieldName = 'IMPOSTO'
    ...
    object Q_InvoiceBASECALCICMS: TIBBCDField
      FieldName = 'BASECALCICMS'
      Origin = 'ENTRADAS.BASECALCICMS'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceVALORICMS: TIBBCDField
      FieldName = 'VALORICMS'
      Origin = 'ENTRADAS.VALORICMS'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceVALORIPI: TIBBCDField
      FieldName = 'VALORIPI'
      Origin = 'ENTRADAS.VALORIPI'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceBASECALCSUBST: TIBBCDField
      FieldName = 'BASECALCSUBST'
      Origin = 'ENTRADAS.BASECALCSUBST'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceVALORICMSSUBST: TIBBCDField
      FieldName = 'VALORICMSSUBST'
      Origin = 'ENTRADAS.VALORICMSSUBST'
      Precision = 18
      Size = 2
    end
    object Q_InvoiceVALORSEGURO: TIBBCDField
      FieldName = 'VALORSEGURO'
      Origin = 'ENTRADAS.VALORSEGURO'
      Precision = 18
      Size = 2
    end
    object Q_InvoicePESOBRUTO: TIBBCDField
      FieldName = 'PESOBRUTO'
      Origin = 'ENTRADAS.PESOBRUTO'
      Precision = 18
      Size = 3
    end
    object Q_InvoicePESOLIQUIDO: TIBBCDField
    ...
    object Q_InvoiceVALORISENTAS: TIBBCDField
    ...
    object Q_InvoiceTOTAL: TIBBCDField
      FieldName = 'TOTAL'
      Origin = 'ENTRADAS.TOTAL'
      Precision = 18
      Size = 3
    end
    object Q_InvoiceTOTALITENS: TIBBCDField
  ...
  object Q_InvItens: TIBQuery
    ...
    object Q_InvItensQUANTIDADE: TIBBCDField
    ...
    object Q_InvItensALIQICMS: TIBBCDField
      FieldName = 'ALIQICMS'
      Origin = 'ENTRADASITENS.ALIQICMS'
      Precision = 18
      Size = 2
    end
    object Q_InvItensIPI: TIBBCDField
      FieldName = 'IPI'
      Origin = 'ENTRADASITENS.IPI'
      Precision = 18
      Size = 2
    end
    object Q_InvItensVALORIPIPROD: TIBBCDField
      FieldName = 'VALORIPIPROD'
      Origin = 'ENTRADASITENS.VALORIPIPROD'
      Precision = 18
      Size = 2
    end
    object Q_InvItensPDESCONTO: TIBBCDField
      FieldName = 'PDESCONTO'
      Origin = 'ENTRADASITENS.PDESCONTO'
      Precision = 18
      Size = 2
    end
    object Q_InvItensDESCONTO: TIBBCDField
      FieldName = 'DESCONTO'
      Origin = 'ENTRADASITENS.DESCONTO'
      Precision = 18
      Size = 2
    end
    object Q_InvItensTOTAL: TIBBCDField
      FieldName = 'TOTAL'
  ...
  object Q_Parcelas: TIBQuery
    ...
    DataSource = Q_InvoiceDS
    SQL.Strings = (
      'Select tr.parcela, tr.valor, tr.vencimento, tr.Compra'
  ...
  object dbSaidasItensIdent: TppDBPipeline
    ...
    Top = 169
    MasterDataPipelineName = 'dbpInvItens'
    object dbSaidasItensIdentppField1: TppField
      Alignment = taRightJustify
      FieldAlias = 'ENTRADAITEMIDENT'
    ...
    object dbSaidasItensIdentppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'ENTRADAITEM'
      FieldName = 'ENTRADAITEM'
      FieldLength = 0
    ...
    object dbSaidasItensIdentppField3: TppField
      Alignment = taRightJustify
      FieldAlias = 'ENTRADA'
      FieldName = 'ENTRADA'
      FieldLength = 0
    ...
    object dbSaidasItensIdentppField4: TppField
      FieldAlias = 'SERIAL'
      FieldName = 'SERIAL'
      FieldLength = 25
      DisplayWidth = 25
