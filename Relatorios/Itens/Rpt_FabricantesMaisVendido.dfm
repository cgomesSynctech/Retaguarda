inherited RptFabricantesMaisVendido: TRptFabricantesMaisVendido
  ...
  inherited pnGrid: TPanel
    inherited pnDados: TTS_Panel
      ...
      object TS_Label1: TTS_Label
        ...
        Caption = 'Os                    fabricantes mais vendido no per'#237'odo de '
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      object dbgConsultaColumn6: TdxDBGridColumn
        Caption = 'Rank'
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select first :quantos i.fabricante, f.descricao, sum(si.quantida' +
