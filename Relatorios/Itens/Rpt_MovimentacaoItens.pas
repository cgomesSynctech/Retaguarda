...
uses
  ...
  TS_PopupEdit, TS_PopupFiltrarItens, TS_DateTimePicker;
...
type
  TRptMovimentacaoItens = class(TFormPadrao)
    Q_Consulta: TIBQuery;
    ...
    dbgConsultaColumn2: TdxDBGridMaskColumn;
    dbgConsultaColumn3: TdxDBGridMaskColumn;
    dbgConsultaColumn4: TdxDBGridMaskColumn;
    dbgConsultaColumn5: TdxDBGridMaskColumn;
    dbgConsultaColumn6: TdxDBGridMaskColumn;
    dbgConsultaColumn7: TdxDBGridMaskColumn;
    dbgConsultaColumn8: TdxDBGridMaskColumn;
    dbgConsultaColumn9: TdxDBGridMaskColumn;
    ...
    dbgConsultaColumn10: TdxDBGridMaskColumn;
    C_ConsultaQTDSAI: TFloatField;
    C_ConsultaPRCSAI: TFloatField;
    C_ConsultaSUBTOTALSAI: TFloatField;
...
var
  RptMovimentacaoItens: TRptMovimentacaoItens;
...
procedure TRptMovimentacaoItens.FormClose(Sender: TObject; var Action: TCloseAction);
Var
  sValor: String;
begin
//  sValor := 'N';
...
procedure TRptMovimentacaoItens.dxBarSubItem4Click(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptMovimentacaoItens.btSairClick(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptMovimentacaoItens.FormCreate(Sender: TObject);
...
procedure TRptMovimentacaoItens.btLayoutLarguraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.LarguraAutomatica( btLayoutLargura.Checked );
end;

procedure TRptMovimentacaoItens.btImprimirVisualClick(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btAgrupamentoPainelClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.MostrarPainelAgrupamento( btAgrupamentoPainel.Checked );
end;

procedure TRptMovimentacaoItens.btDadosFiltrarClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AtivarFiltro( btDadosFiltrar.Checked );
end;

procedure TRptMovimentacaoItens.btSumarizacaoRodapeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarRodape( btSumarizacaoRodape.Checked );
end;

procedure TRptMovimentacaoItens.btLayoutGradeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarGrade( btLayoutGrade.Checked );
end;

procedure TRptMovimentacaoItens.TotalizarEmBaixoClick(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btLayoutFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteCabecalho;
end;

procedure TRptMovimentacaoItens.btDadosFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteDados;
end;

procedure TRptMovimentacaoItens.btExportacaoHtmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarHtml(self);
end;

procedure TRptMovimentacaoItens.btExportacaoExcelClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarExcel(self);
end;

procedure TRptMovimentacaoItens.btExportacaoXmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarXml(self);
end;

procedure TRptMovimentacaoItens.btExportacaoTextoClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ExportarTexto(self);
end;

procedure TRptMovimentacaoItens.btAgrupamentoExpandirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExpandirGrupos;
end;

procedure TRptMovimentacaoItens.btLayoutColunasClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AdicionarColunas;
end;

procedure TRptMovimentacaoItens.btImprimirImpressoraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.Print;
end;

procedure TRptMovimentacaoItens.btAgrupamentoResumirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ResumirGrupos;
end;

procedure TRptMovimentacaoItens.btAgrupamentoFontClick(Sender: TObject);
begin
  dbgConsulta.FonteGrupo;
end;

procedure TRptMovimentacaoItens.FormShow(Sender: TObject);
var
  sWhere : string;
  ArquivoIni : TIniFile;
...
procedure TRptMovimentacaoItens.RefreshMsg(var Msg:TMessage);
begin
  Refresh;
end;

procedure TRptMovimentacaoItens.Refresh;
begin
...
procedure TRptMovimentacaoItens.RefreshDataSets;
var
  i, j:integer;
  Key : Variant;
  s : String;
...
procedure TRptMovimentacaoItens.CorFundo1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoDados;
end;

procedure TRptMovimentacaoItens.CorFundo2Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoGrupo;
end;

procedure TRptMovimentacaoItens.btDadosMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btAgrupamentoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btLayoutMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btSumarizacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btExportacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btImprimirMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.Ajuda1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptMovimentacaoItens.RelatrioPadro1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptMovimentacaoItens.btHelpClick(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.EnviarparaoEmail1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.PrintEmail(FormsComponent.Caption+';'+DMProject.sNomeEmpresa);
end;

procedure TRptMovimentacaoItens.dbgConsultaMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.dbgConsultaDblClick(Sender: TObject);
var
   nItem : Integer;
   sForm : String;
begin
...
procedure TRptMovimentacaoItens.BarradeBotoesClick(Sender: TObject);
begin
  inherited;
	TS_Panel1.Visible := not TS_Panel1.Visible;
end;

procedure TRptMovimentacaoItens.GridPrinterLinkCustomDrawHeaderCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; AColumn: TdxTreeListColumn; var AText: String;
  var AColor: TColor; AFont: TFont; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var ASorted: TdxCellSortOrder;
...
procedure TRptMovimentacaoItens.GridPrinterLinkCustomDrawPageHeader(Sender: TObject;
  ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect; ANom,
  ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
var
  APixel: Integer;
...
procedure TRptMovimentacaoItens.GridPrinterLinkCustomDrawReportLinkTitle(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect; ANom,
  ADenom: Integer; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var AColor: TColor; AFont: TFont;
  var ADone: Boolean);
...
procedure TRptMovimentacaoItens.GridPrinterLinkMeasureReportLinkTitle(
  Sender: TBasedxReportLink; var AHeight: Integer);
var
  s : String;
begin
...
function TRptMovimentacaoItens.getTitulos : string;
var sString : string;
		i : integer;
begin
  sString := '';
...
procedure TRptMovimentacaoItens.GerarEtiquetas1Click(Sender: TObject);
var sSQL : string;
begin
  inherited;
...
function TRptMovimentacaoItens.getSQLParam(Query : TIBQuery) : string;
var sSQL : string;
		i : integer;
begin
  with Query do begin
...
procedure TRptMovimentacaoItens.GridPrinterLinkCustomDrawCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
...
procedure TRptMovimentacaoItens.FormatoPijamaClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FormatoPijama;
end;

procedure TRptMovimentacaoItens.ConfigurarColunaClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarColuna;
end;

procedure TRptMovimentacaoItens.CordaGrade1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.CorGrade;
end;

procedure TRptMovimentacaoItens.ppmLayoutPopup(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.AlturaAutomtica1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.AlturaCelula;
end;

procedure TRptMovimentacaoItens.ppmSumarizacaoPopup(Sender: TObject);
begin
  inherited;
  with dbgConsulta do begin
...
procedure TRptMovimentacaoItens.GridPrinterLinkCustomDrawRowFooterCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
...
procedure TRptMovimentacaoItens.CongelarClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.CongelarColuna(dbgConsulta.TS_SelectedColumn);
end;

procedure TRptMovimentacaoItens.DescongelarColuna1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.DesCongelarColuna;
end;

procedure TRptMovimentacaoItens.ppmDadosPopup(Sender: TObject);
begin
  inherited;
	btDadosFiltrar.Checked := dbgConsulta.Filter.Active;
end;

procedure TRptMovimentacaoItens.ppmAgrupamentoPopup(Sender: TObject);
begin
  inherited;
	btAgrupamentoPainel.Checked := dbgConsulta.ShowGroupPanel;
end;

procedure TRptMovimentacaoItens.tulodoRelatrio1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.SalvarTemplate1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.CarregarTemplate1Click(Sender: TObject);
...
procedure TRptMovimentacaoItens.btAjudaMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.NenhumTemplate1Click(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
    TS_TemplatePadrao := '';
...
procedure TRptMovimentacaoItens.setTemplatePadrao;
begin
...
function TRptMovimentacaoItens.getTemplatePadrao : string;
begin
  	with Q_SQLReport do begin
    	close;
...
procedure TRptMovimentacaoItens.DefinirPadraoClick(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
...
procedure TRptMovimentacaoItens.ExcluirTemplate1Click(Sender: TObject);
...
procedure TRptMovimentacaoItens.FormResize(Sender: TObject);
begin
  inherited;
...
function TRptMovimentacaoItens.getCampos : string;
begin
  with Q_SQLReport do begin
    close;
...
function TRptMovimentacaoItens.getTabelas : string;
var sTabelas : string;
		i : integer;
begin
	with Q_SQLReport do begin
...
function TRptMovimentacaoItens.getListaTabelas( bSomenteAdicional : boolean = false) : TStringList;
...
procedure TRptMovimentacaoItens.CriarCampos;
var i : integer;
		sCampo : string;
begin
	with Q_SQLReport do begin
...
procedure TRptMovimentacaoItens.CriarCampo( sCampo, sTitulo, sTipoCampo : string );
...
procedure TRptMovimentacaoItens.RemoverCampo( sCampo : string );
begin
...
procedure TRptMovimentacaoItens.AdicionarCampo( sTabelas, sCampo, sTitulo, sTipo, sAlias : string );
...
procedure TRptMovimentacaoItens.AdicionarSubSelect( sSelect, sAlias, sTitulo, sTipo : string );
var bJaExiste : boolean;
		sCampo : string;
begin
...
function TRptMovimentacaoItens.getListaCampos : TStringList;
var i : integer;
...
procedure TRptMovimentacaoItens.AlterarCampo( CampoAlterar, Campo, Tabela, Titulo, Tipo, Alias : string);
...
procedure TRptMovimentacaoItens.AlterarSubSelect( CampoAlterar, Select, Alias, Titulo, Tipo : string);
var sCampo, sCampoAdicional, sTituloAdicional, sTipoAdicional : string;
		Index : integer;
begin
  with Q_SQLReport do begin
...
procedure TRptMovimentacaoItens.TotalizarEmCimaClick(Sender: TObject);
begin
  inherited;
...
procedure TRptMovimentacaoItens.ppmTemplatesPopup(Sender: TObject);
begin
  inherited;
	DefinirPadrao.Enabled := dbgConsulta.TS_TemplatePadrao<>'';
end;

procedure TRptMovimentacaoItens.TrocaTemplate( Sender : TObject );
begin
...
procedure TRptMovimentacaoItens.btTemplatesMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptMovimentacaoItens.btTemplatesMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var i : integer;
 		MenuItem : TMenuItem;
begin
...
procedure TRptMovimentacaoItens.ppmSelTemplatePopup(Sender: TObject);
var i : integer;
begin
  inherited;
...
function TRptMovimentacaoItens.getTipoCampo( sTabela, sCampo : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
function TRptMovimentacaoItens.getTipoCampo( sSQL : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
procedure TRptMovimentacaoItens.Adicionar2Click(Sender: TObject);
...
procedure TRptMovimentacaoItens.Alterar2Click(Sender: TObject);
var sCampo : String;
		Index : integer;
begin
  inherited;
...
procedure TRptMovimentacaoItens.Remover2Click(Sender: TObject);
...
procedure TRptMovimentacaoItens.ExecutarArquivo1Click(Sender: TObject);
...
procedure TRptMovimentacaoItens.btMostrarCabClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ShowHeader := btMostrarCab.Checked;
end;

procedure TRptMovimentacaoItens.btLayoutMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptMovimentacaoItens.dbgConsultaMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptMovimentacaoItens.ConfigurarPgina1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarPagina( self );
end;

procedure TRptMovimentacaoItens.LayoutdeImpresso1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.LayoutImpressao( self );
end;

procedure TRptMovimentacaoItens.ConfigurarImpressora1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarImpressora( self );
end;

procedure TRptMovimentacaoItens.FormVisible(var Msg: TMessage);
var
...
procedure TRptMovimentacaoItens.GridPrinterStartGenerateReport(Sender: TObject;
  AReportLink: TBasedxReportLink);
...
procedure TRptMovimentacaoItens.GridPrinterBeforeDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink;
  ADesignWindow: TAbstractdxReportLinkDesignWindow);
begin
  inherited;
...
procedure TRptMovimentacaoItens.GridPrinterDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink; var ADone: Boolean);
begin
  inherited;
  if ADone then
...
procedure TRptMovimentacaoItens.ConfigurarRelatrio1Click(Sender: TObject);
var i : integer;
begin
  inherited;
...
procedure TRptMovimentacaoItens.GravaRelatorio( sRelatorio, sTitulo, sCabecalho, sImpressora : string; nCopias : integer );
begin
	with Q_SQLReport do begin
  	close;
    sql.text := 'update relatorios '+
...
procedure TRptMovimentacaoItens.GetFULLSELECT;
Begin
  with Q_FullSelect do Begin
...
procedure TRptMovimentacaoItens.AtualizaItens(WhereAdicional:string ='');
begin
  ActiveControl := nil;
  with C_Consulta do begin
    ...
    ' Max((select avg(e.preco) from entradasitens e inner join entradas ee on e.entrada = ee.entrada  '+
    ' where ee.data >= :datainicio and ee.data <= :datafinal and e.unidade = s.unidade and e.item = s.item)) as PrcEntra, '+
  ...
  with dbgConsulta do begin
    ...
    TS_ReportFilter.Add(replace(FiltroItens.Hint,#13,' '));
  end;
end;

procedure TRptMovimentacaoItens.btAtualizarClick(Sender: TObject);
begin
  inherited;
  AtualizaItens();
end;

procedure TRptMovimentacaoItens.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
