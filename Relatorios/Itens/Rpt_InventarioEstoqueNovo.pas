unit Rpt_InventarioEstoqueNovo;
...
type
    TRptInventarioEstoqueNovo = class(TFrmModeloCadastros)
        TS_Label1: TTS_Label;
...
var
    RptInventarioEstoqueNovo: TRptInventarioEstoqueNovo;
...
procedure TRptInventarioEstoqueNovo.AtualizaRGInventario;
begin
    Q_Inventarios.Close;
    Q_Inventarios.open;
...
procedure TRptInventarioEstoqueNovo.btLimparClick(Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.FormCreate(Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.Imprimir;
var
    bSimples: boolean;
begin
...
procedure TRptInventarioEstoqueNovo.btGravarClick(Sender: TObject);
begin
    inherited;
    nAcumulaPg:=0;
    nTotPg:=0;
...
procedure TRptInventarioEstoqueNovo.btComando1Click(Sender: TObject);
...
begin
    ...
    try
        ...
        Q_Gerar.SQL.Text := 'EXECUTE PROCEDURE pp_Inventarionovo(:Data) ';
...
procedure TRptInventarioEstoqueNovo.ppTitleBand1BeforeGenerate(
    Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppTitleBand3BeforeGenerate(
    Sender: TObject);
begin
    inherited;
    if Q_Grupos.Recordcount > 0 then
...
procedure TRptInventarioEstoqueNovo.ppTitleBand5BeforeGenerate(
    Sender: TObject);
begin
    inherited;
    if Q_Grupos.Recordcount > 0 then
...
procedure TRptInventarioEstoqueNovo.ppTitleBand9BeforeGenerate(
    Sender: TObject);
begin
    inherited;
    if Q_Grupos.Recordcount > 0 then
...
procedure TRptInventarioEstoqueNovo.Q_EntradasBeforeOpen(DataSet: TDataSet);
begin
    inherited;
    TIBQuery(DataSet).ParamByName('UltInventario').AsDateTime := FUltInventario;
end;

procedure TRptInventarioEstoqueNovo.ppSummaryBand3BeforeGenerate(
    Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppSummaryBand2BeforeGenerate(
    Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppDetailBand1BeforeGenerate(
    Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppLabel22Print(Sender: TObject);
begin
    inherited;
    TppLabel(Sender).Visible := Q_Master.FieldByName('CustoMedio').asFloat = 0;
end;

procedure TRptInventarioEstoqueNovo.InventrioBase1Click(Sender: TObject);
var
    sData: string;
begin
...
procedure TRptInventarioEstoqueNovo.btComando2Click(Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ExcluirInvent;
begin
    if rgInventario.ItemIndex >= 0 then
        begin
...
procedure TRptInventarioEstoqueNovo.rgInventarioClick(Sender: TObject);
begin
    inherited;
    sDataRG := rginventario.Items[rginventario.ItemIndex];
end;

procedure TRptInventarioEstoqueNovo.ppFooterBand1AfterPrint(Sender: TObject);
begin
    inherited;
    nTotPg := 0;
end;

procedure TRptInventarioEstoqueNovo.ppDetailBand7AfterPrint(Sender: TObject);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppSubTotalPaginaGetText(Sender: TObject;
    var Text: string);
begin
    inherited;
...
procedure TRptInventarioEstoqueNovo.ppAcumuladoGetText(Sender: TObject;
    var Text: string);
begin
    inherited;
