inherited RptSaidasItensIdentificados: TRptSaidasItensIdentificados
  Left = 201
  Top = 132
  Width = 993
  Height = 542
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbDescricaoRelatorio: TTS_Label
      Width = 197
      Caption = 'Sa'#237'das de Itens Identificados por per'#237'odo'
    end
  end
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select distinct s.saida, s.numero, s.data, s.favorecido, coalesc' +
        'e(fa.nome, '#39'ND'#39') as nomefavorecido,'
      
        'fa.tipofavorecido, s.totalitens, s.desconto, s.total, tm.tipomov' +
        'imento, tm.descricao as operacao, s.tipopadrao,'
      'coalesce(p.descricao, '#39'N'#227'o Definido'#39') as planopagamento'
      
        'from saidas s inner join transacoesitensident ti on s.saida = ti' +
        '.saida'
      'left join favorecidos fa on s.favorecido = fa.favorecido'
        ...
        'inner join tiposmovimento tm on s.tipomovimento = tm.tipomovimen' +
        'to'
  ...
  inherited FormsComponent: TFormsComponent
    ...
    Modulo = 'Itens Identificados/N'#186' S'#233'rie'
    Caption = 'Sa'#237'das no Per'#237'odo'
  end
  object Q_TiposMovimentos: TIBQuery
    ...
    SQL.Strings = (
      'Select TIPOMOVIMENTO, DESCRICAO'
        ...
        'from TIPOSMOVIMENTO where   TIPOPADRAO in (1, 5, 6, 8, 40 ) orde' +
        'r by TIPOPADRAO ,DESCRICAO')
    Left = 680
    Top = 119
