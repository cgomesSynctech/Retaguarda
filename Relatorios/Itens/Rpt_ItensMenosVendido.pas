...
type
  TRptItensMenosVendido = class(TRptPadrao)
    TS_Label1: TTS_Label;
...
var
  RptItensMenosVendido: TRptItensMenosVendido;
...
procedure TRptItensMenosVendido.Atualizar;
var i : integer;
    nTotal: Currency;
begin
  i := 1;
  ...
  with dbgConsulta do begin
    ...
    TS_ReportFilter.Add('Os '+IntToStr(edQuantos.IntValue)+' itens Menos vendido no período de '+DataI.Text+' a '+DataF.Text);
  end;
end;
          
procedure TRptItensMenosVendido.btAtualizarClick(Sender: TObject);
begin
  inherited;
  Atualizar;
end;

procedure TRptItensMenosVendido.DataIDateChange(Sender: TObject);
begin
  inherited;
  //Atualizar;
end;

procedure TRptItensMenosVendido.edQuantosChange(Sender: TObject);
begin
  inherited;
  //Atualizar;
end;

procedure TRptItensMenosVendido.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
...
procedure TRptItensMenosVendido.btVendedorClick(Sender: TObject);
begin
  inherited;
...
procedure TRptItensMenosVendido.cbVolumeChange(Sender: TObject);
begin
  inherited;
...
procedure TRptItensMenosVendido.cbValorChange(Sender: TObject);
begin
  inherited;
