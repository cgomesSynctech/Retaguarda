inherited RptItensMenosVendido: TRptItensMenosVendido
  Left = 138
  Top = 115
  Width = 911
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 243
      Caption = 'Os Itens Menos Vendidos'
  ...
  inherited pnGrid: TPanel
    ...
    inherited pnDados: TTS_Panel
      ...
      object TS_Label1: TTS_Label
        ...
        Caption = 'Os                    itens Menos vendido no per'#237'odo de '
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      object dbgConsultaRanking: TdxDBGridColumn
        Alignment = taCenter
        Caption = 'Rank'
        Width = 44
        BandIndex = 0
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
      ...
      'from '
        ...
        'saidasitens si  inner join saidas s on (si.empresa = s.empresa) ' +
        'and (si.saida = s.saida) and (si.pdv = s.pdv)  inner join itens ' +
        'i on i.item = si.item  left join grupos g on g.grupo = i.grupo'
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaQTDE: TBCDField
      FieldName = 'QTDE'
      Precision = 18
    end
