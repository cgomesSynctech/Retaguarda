...
uses
  ...
  TS_SpeedButton, dxfLabel, TS_MaxPanel, dxEdLib, TS_DateTimePicker,
  dxEditor, TS_SpinEdit, dxDBTLCl, dxGrClms, TS_CheckBox;

type
  TRptGruposMaisVendido = class(TRptPadrao)
    TS_Label1: TTS_Label;
    TS_Label2: TTS_Label;
    ...
    dbgConsultaRank: TdxDBGridColumn;
...
var
  RptGruposMaisVendido: TRptGruposMaisVendido;
...
procedure TRptGruposMaisVendido.Atualizar;
var i : integer;
nTotal: Currency;
begin
	i := 1;
  ...
  with dbgConsulta do begin
    ...
    TS_ReportFilter.Add('Os '+IntToStr(edQuantos.IntValue)+' grupos de itens mais vendido no período de '+DataI.Text+' a '+DataF.Text);
  end;
end;

procedure TRptGruposMaisVendido.DataIDateChange(Sender: TObject);
begin
  inherited;
	Atualizar;
end;

procedure TRptGruposMaisVendido.edQuantosChange(Sender: TObject);
begin
  inherited;
	Atualizar;
end;

procedure TRptGruposMaisVendido.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
...
procedure TRptGruposMaisVendido.btAtualizarClick(Sender: TObject);
begin
  inherited;
	Atualizar;                            
end;

procedure TRptGruposMaisVendido.btVendedorClick(Sender: TObject);
begin
  inherited;
...
procedure TRptGruposMaisVendido.cbVolumeChange(Sender: TObject);
begin
  inherited;
...
procedure TRptGruposMaisVendido.cbValorChange(Sender: TObject);
begin
  inherited;
