...
type
  TRptVendasItensSimples = class(TRptPadrao)
    TS_Label1: TTS_Label;
    TS_Label2: TTS_Label;
...
var
  RptVendasItensSimples: TRptVendasItensSimples;
...
procedure TRptVendasItensSimples.FormsComponentBeforeClearParams(
  Sender: TObject);
var i : integer;
 sID: String;
begin
...
procedure TRptVendasItensSimples.Atualizar;
var
...
begin
     ...
     with C_Consulta do begin
        ...
        CommandText := 'Select ' + getCampos + ' ' +
                       ...
                       +sSituacao
                       +nTP_MV + ' group by si.item, i.codigo, i.descricao, i.unidade, I.piscofins, gi.descricaogrupo, i.customanual, i.customedio, i.precocompra, i.custocontabil, i.referencia' ;
...
procedure TRptVendasItensSimples.btAtualizarClick(Sender: TObject);
begin
  inherited;
	Atualizar;
end;

procedure TRptVendasItensSimples.DataIDateChange(Sender: TObject);
begin
  inherited;
  //	Atualizar;
end;

procedure TRptVendasItensSimples.PopupFiltrarItensSelecionou(
  Sender: TObject);
begin
  inherited;
  //	Atualizar;
...
procedure TRptVendasItensSimples.btClientesClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasItensSimples.btVendedorClick(Sender: TObject);
begin
  inherited;
  with DMProjeto do begin
...
procedure TRptVendasItensSimples.cbCanceladasChange(Sender: TObject);
begin
  inherited;
  //Atualizar;
end;

procedure TRptVendasItensSimples.ppeTiposMovimentoCloseUp(Sender: TObject;
...
procedure TRptVendasItensSimples.ppeTipoPadraoCloseUp(Sender: TObject;
  var Text: String; var Accept: Boolean);
begin
  inherited;
...
procedure TRptVendasItensSimples.ppeTipoPadraoExit(Sender: TObject);
Var sId: String;
begin
  inherited;
  Q_TiposMovimentos.Close;
...
procedure TRptVendasItensSimples.cbTipoPadraoClick(Sender: TObject);
begin
  inherited;
