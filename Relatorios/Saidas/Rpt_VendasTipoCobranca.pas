...
uses
  ...
  TS_CheckListBox, TS_DateTimePicker, dxEditor, TS_PopupEdit;
...
type
  TRptVendasTipoCobranca = class(TFormPadrao)
    Q_Consulta: TIBQuery;
    ...
    dbgConsultaDTMODIFICACAO: TdxDBGridDateColumn;
    dbgConsultaTOTALITENS: TdxDBGridCurrencyColumn;
    dbgConsultaDEVOLUCAO: TdxDBGridCurrencyColumn;
    ...
    dbgConsultaVALORICMSSUBST: TdxDBGridCurrencyColumn;
    dbgConsultaBASECALCICMS: TdxDBGridCurrencyColumn;
    dbgConsultaBASECALCSUBST: TdxDBGridCurrencyColumn;
    dbgConsultaSUBSTTRIB: TdxDBGridMaskColumn;
    ...
    dbgConsultaENDERECO1: TdxDBGridMaskColumn;
    dbgConsultaBAIRRO1: TdxDBGridMaskColumn;
    dbgConsultaCIDADE1: TdxDBGridMaskColumn;
    dbgConsultaUF1: TdxDBGridMaskColumn;
    dbgConsultaHORA: TdxDBGridTimeColumn;
    dbgConsultaINSCRICAO_EST: TdxDBGridMaskColumn;
    dbgConsultaLOGINNAME: TdxDBGridMaskColumn;
    dbgConsultaMOTIVOCANCELAMENTO: TdxDBGridMaskColumn;
    ...
    dbgConsultaPROFISSIONAL: TdxDBGridMaskColumn;
    dbgConsultaOUTRASDESPESAS: TdxDBGridCurrencyColumn;
    dbgConsultaDESCRICAO: TdxDBGridMaskColumn;
    dbgConsultaTIPODOMOVIMENTO: TdxDBGridMaskColumn;
    ppeTipoMovimento: TTS_PopupEdit;
    TS_Label2: TTS_Label;
    clbTipoMovimento: TTS_CheckListBox;
    C_TipoMovimentoDS: TDataSource;
    C_TipoMovimento: TClientDataSet;
    Q_TipoMovimento: TIBQuery;
    P_TipoMovimento: TDataSetProvider;
    C_TipoMovimentoTIPOMOVIMENTO: TIntegerField;
    C_TipoMovimentoDESCRICAO: TStringField;
    C_ConsultaTIPOCOBRANCA: TIntegerField;
    ...
    C_ConsultaENDERECO1: TStringField;
    C_ConsultaBAIRRO1: TStringField;
    C_ConsultaCIDADE1: TStringField;
    C_ConsultaUF1: TStringField;
    ...
    C_ConsultaTIPODOMOVIMENTO: TStringField;
  ...
  Sender: TBasedxReportLink; var AHeight: Integer);
    ...
    procedure ppeTipoMovimentoCloseUp(Sender: TObject; var Text: String;
      var Accept: Boolean);
  private
...
var
  RptVendasTipoCobranca: TRptVendasTipoCobranca;

implementation

uses Funcoes, TDM_Projeto, Dlg_SalvarTemplate, Dlg_AbrirTemplate,
     Dlg_ApagarTemplate, Dlg_AdicionarCampos, Dlg_RemoverCampos,
  Dlg_ConfiguraRelatorio, DM_Projeto;

{$R *.DFM}

procedure TRptVendasTipoCobranca.FormClose(Sender: TObject; var Action: TCloseAction);
Var
  sValor: String;
begin
//  sValor := 'N';
...
procedure TRptVendasTipoCobranca.dxBarSubItem4Click(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptVendasTipoCobranca.btSairClick(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TRptVendasTipoCobranca.FormCreate(Sender: TObject);
...
procedure TRptVendasTipoCobranca.btLayoutLarguraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.LarguraAutomatica( btLayoutLargura.Checked );
end;

procedure TRptVendasTipoCobranca.btImprimirVisualClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btAgrupamentoPainelClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.MostrarPainelAgrupamento( btAgrupamentoPainel.Checked );
end;

procedure TRptVendasTipoCobranca.btDadosFiltrarClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AtivarFiltro( btDadosFiltrar.Checked );
end;

procedure TRptVendasTipoCobranca.btSumarizacaoRodapeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarRodape( btSumarizacaoRodape.Checked );
end;

procedure TRptVendasTipoCobranca.btLayoutGradeClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.MostrarGrade( btLayoutGrade.Checked );
end;

procedure TRptVendasTipoCobranca.TotalizarEmBaixoClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btLayoutFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteCabecalho;
end;

procedure TRptVendasTipoCobranca.btDadosFontClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FonteDados;
end;

procedure TRptVendasTipoCobranca.btExportacaoHtmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarHtml(self);
end;

procedure TRptVendasTipoCobranca.btExportacaoExcelClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarExcel(self);
end;

procedure TRptVendasTipoCobranca.btExportacaoXmlClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExportarXml(self);
end;

procedure TRptVendasTipoCobranca.btExportacaoTextoClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ExportarTexto(self);
end;

procedure TRptVendasTipoCobranca.btAgrupamentoExpandirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ExpandirGrupos;
end;

procedure TRptVendasTipoCobranca.btLayoutColunasClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.AdicionarColunas;
end;

procedure TRptVendasTipoCobranca.btImprimirImpressoraClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.Print;
end;

procedure TRptVendasTipoCobranca.btAgrupamentoResumirClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.ResumirGrupos;
end;

procedure TRptVendasTipoCobranca.btAgrupamentoFontClick(Sender: TObject);
begin
  dbgConsulta.FonteGrupo;
end;

procedure TRptVendasTipoCobranca.FormShow(Sender: TObject);
var
  sWhere : string;
  ArquivoIni : TIniFile;
...
begin
 ...
 {
  C_TiposCobranca.Open;
  clbTipoOperacao.SetDataSet(C_TiposCobranca);
  clbTipoOperacao.UpdateItems;
  ppeTipoOperacao.Text := clbTipoOperacao.Selecionados( true );}
end;

procedure TRptVendasTipoCobranca.RefreshMsg(var Msg:TMessage);
begin
  Refresh;
end;

procedure TRptVendasTipoCobranca.Refresh;
begin
...
procedure TRptVendasTipoCobranca.RefreshDataSets;
var
  i, j:integer;
  Key : Variant;
  s : String;
...
procedure TRptVendasTipoCobranca.CorFundo1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoDados;
end;

procedure TRptVendasTipoCobranca.CorFundo2Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.CorFundoGrupo;
end;

procedure TRptVendasTipoCobranca.btDadosMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btAgrupamentoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btLayoutMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btSumarizacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btExportacaoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btImprimirMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.Ajuda1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptVendasTipoCobranca.RelatrioPadro1Click(Sender: TObject);
begin
  inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptVendasTipoCobranca.btHelpClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.EnviarparaoEmail1Click(Sender: TObject);
begin
  inherited;
  dbgConsulta.PrintEmail(FormsComponent.Caption+';'+DMProject.sNomeEmpresa);
end;

procedure TRptVendasTipoCobranca.dbgConsultaMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.dbgConsultaDblClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.BarradeBotoesClick(Sender: TObject);
begin
  inherited;
	TS_Panel1.Visible := not TS_Panel1.Visible;
end;

procedure TRptVendasTipoCobranca.GridPrinterLinkCustomDrawHeaderCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; AColumn: TdxTreeListColumn; var AText: String;
  var AColor: TColor; AFont: TFont; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var ASorted: TdxCellSortOrder;
...
procedure TRptVendasTipoCobranca.GridPrinterLinkCustomDrawPageHeader(Sender: TObject;
  ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect; ANom,
  ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
var
  APixel: Integer;
...
procedure TRptVendasTipoCobranca.GridPrinterLinkCustomDrawReportLinkTitle(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect; ANom,
  ADenom: Integer; var ATextAlignX: TdxTextAlignX;
  var ATextAlignY: TdxTextAlignY; var AColor: TColor; AFont: TFont;
  var ADone: Boolean);
...
procedure TRptVendasTipoCobranca.GridPrinterLinkMeasureReportLinkTitle(
  Sender: TBasedxReportLink; var AHeight: Integer);
var
  s : String;
begin
...
function TRptVendasTipoCobranca.getTitulos : string;
var sString : string;
		i : integer;
begin
  sString := '';
...
procedure TRptVendasTipoCobranca.GerarEtiquetas1Click(Sender: TObject);
var sSQL : string;
begin
  inherited;
...
function TRptVendasTipoCobranca.getSQLParam(Query : TIBQuery) : string;
var sSQL : string;
		i : integer;
begin
  with Query do begin
...
procedure TRptVendasTipoCobranca.GridPrinterLinkCustomDrawCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
...
procedure TRptVendasTipoCobranca.FormatoPijamaClick(Sender: TObject);
begin
  inherited;
  dbgConsulta.FormatoPijama;
end;

procedure TRptVendasTipoCobranca.ConfigurarColunaClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarColuna;
end;

procedure TRptVendasTipoCobranca.CordaGrade1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.CorGrade;
end;

procedure TRptVendasTipoCobranca.ppmLayoutPopup(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.AlturaAutomtica1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.AlturaCelula;
end;

procedure TRptVendasTipoCobranca.ppmSumarizacaoPopup(Sender: TObject);
begin
  inherited;
  with dbgConsulta do begin
...
procedure TRptVendasTipoCobranca.GridPrinterLinkCustomDrawRowFooterCell(
  Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
  AClientRect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
...
procedure TRptVendasTipoCobranca.CongelarClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.CongelarColuna(dbgConsulta.TS_SelectedColumn);
end;

procedure TRptVendasTipoCobranca.DescongelarColuna1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.DesCongelarColuna;
end;

procedure TRptVendasTipoCobranca.ppmDadosPopup(Sender: TObject);
begin
  inherited;
	btDadosFiltrar.Checked := dbgConsulta.Filter.Active;
end;

procedure TRptVendasTipoCobranca.ppmAgrupamentoPopup(Sender: TObject);
begin
  inherited;
	btAgrupamentoPainel.Checked := dbgConsulta.ShowGroupPanel;
end;

procedure TRptVendasTipoCobranca.tulodoRelatrio1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.SalvarTemplate1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.CarregarTemplate1Click(Sender: TObject);
...
procedure TRptVendasTipoCobranca.btAjudaMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.NenhumTemplate1Click(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
    TS_TemplatePadrao := '';
...
procedure TRptVendasTipoCobranca.setTemplatePadrao;
begin
...
function TRptVendasTipoCobranca.getTemplatePadrao : string;
begin
  	with Q_SQLReport do begin
    	close;
...
procedure TRptVendasTipoCobranca.DefinirPadraoClick(Sender: TObject);
begin
  inherited;
	with dbgConsulta do begin
...
procedure TRptVendasTipoCobranca.ExcluirTemplate1Click(Sender: TObject);
...
procedure TRptVendasTipoCobranca.FormResize(Sender: TObject);
begin
  inherited;
...
function TRptVendasTipoCobranca.getCampos : string;
begin
  with Q_SQLReport do begin
    close;
...
function TRptVendasTipoCobranca.getTabelas : string;
var sTabelas : string;
		i : integer;
begin
	with Q_SQLReport do begin
...
function TRptVendasTipoCobranca.getListaTabelas( bSomenteAdicional : boolean = false) : TStringList;
...
procedure TRptVendasTipoCobranca.CriarCampos;
var i : integer;
		sCampo : string;
begin
	with Q_SQLReport do begin
...
procedure TRptVendasTipoCobranca.CriarCampo( sCampo, sTitulo, sTipoCampo : string );
...
procedure TRptVendasTipoCobranca.RemoverCampo( sCampo : string );
begin
...
procedure TRptVendasTipoCobranca.AdicionarCampo( sTabelas, sCampo, sTitulo, sTipo, sAlias : string );
...
procedure TRptVendasTipoCobranca.AdicionarSubSelect( sSelect, sAlias, sTitulo, sTipo : string );
var bJaExiste : boolean;
		sCampo : string;
begin
...
function TRptVendasTipoCobranca.getListaCampos : TStringList;
var i : integer;
...
procedure TRptVendasTipoCobranca.AlterarCampo( CampoAlterar, Campo, Tabela, Titulo, Tipo, Alias : string);
...
procedure TRptVendasTipoCobranca.AlterarSubSelect( CampoAlterar, Select, Alias, Titulo, Tipo : string);
var sCampo, sCampoAdicional, sTituloAdicional, sTipoAdicional : string;
		Index : integer;
begin
  with Q_SQLReport do begin
...
procedure TRptVendasTipoCobranca.TotalizarEmCimaClick(Sender: TObject);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.ppmTemplatesPopup(Sender: TObject);
begin
  inherited;
	DefinirPadrao.Enabled := dbgConsulta.TS_TemplatePadrao<>'';
end;

procedure TRptVendasTipoCobranca.TrocaTemplate( Sender : TObject );
begin
...
procedure TRptVendasTipoCobranca.btTemplatesMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.btTemplatesMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var i : integer;
 		MenuItem : TMenuItem;
begin
...
procedure TRptVendasTipoCobranca.ppmSelTemplatePopup(Sender: TObject);
var i : integer;
begin
  inherited;
...
function TRptVendasTipoCobranca.getTipoCampo( sTabela, sCampo : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
function TRptVendasTipoCobranca.getTipoCampo( sSQL : string ) : string;
begin
	with Q_SQLReport do begin
  	close;
...
procedure TRptVendasTipoCobranca.Adicionar2Click(Sender: TObject);
...
procedure TRptVendasTipoCobranca.Alterar2Click(Sender: TObject);
var sCampo : String;
		Index : integer;
begin
  inherited;
...
procedure TRptVendasTipoCobranca.Remover2Click(Sender: TObject);
...
procedure TRptVendasTipoCobranca.ExecutarArquivo1Click(Sender: TObject);
...
procedure TRptVendasTipoCobranca.btMostrarCabClick(Sender: TObject);
begin
  inherited;
	dbgConsulta.ShowHeader := btMostrarCab.Checked;
end;

procedure TRptVendasTipoCobranca.btLayoutMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptVendasTipoCobranca.dbgConsultaMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var i : integer;
begin
  inherited;
...
procedure TRptVendasTipoCobranca.ConfigurarPgina1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarPagina( self );
end;

procedure TRptVendasTipoCobranca.LayoutdeImpresso1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.LayoutImpressao( self );
end;

procedure TRptVendasTipoCobranca.ConfigurarImpressora1Click(Sender: TObject);
begin
  inherited;
	dbgConsulta.ConfigurarImpressora( self );
end;

procedure TRptVendasTipoCobranca.FormVisible(var Msg: TMessage);
var
...
procedure TRptVendasTipoCobranca.GridPrinterStartGenerateReport(Sender: TObject;
  AReportLink: TBasedxReportLink);
...
procedure TRptVendasTipoCobranca.GridPrinterBeforeDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink;
  ADesignWindow: TAbstractdxReportLinkDesignWindow);
begin
  inherited;
...
procedure TRptVendasTipoCobranca.GridPrinterDesignReport(Sender: TObject;
  AReportLink: TBasedxReportLink; var ADone: Boolean);
begin
  inherited;
  if ADone then
...
procedure TRptVendasTipoCobranca.ConfigurarRelatrio1Click(Sender: TObject);
var i : integer;
begin
  inherited;
...
procedure TRptVendasTipoCobranca.GravaRelatorio( sRelatorio, sTitulo, sCabecalho, sImpressora : string; nCopias : integer );
begin
	with Q_SQLReport do begin
  	close;
    sql.text := 'update relatorios '+
...
procedure TRptVendasTipoCobranca.GetFULLSELECT;
Begin
  with Q_FullSelect do Begin
...
procedure TRptVendasTipoCobranca.Atualizar;
var
  sTipoOperacao, sTipoMovimento: String;
begin
  with C_Consulta do begin Close;
        CommandText := 'select tc.tipocobranca,TC.descricao,s.saida, s.data, s.DTMODIFICACAO, s.totalitens, s.Devolucao, s.total - s.devolucao as Total, '+
                       's.imposto, s.numero, s.dataentrega, s.valorcomissao,  s.frete, s.obs, s.desconto, s.juros, s.vendedor,  s.valoricms, '+
                       's.valoricmssubst, s.basecalcicms, s.basecalcsubst, s.substtrib, s.favorecido, f.tipofavorecido, f.nome as nomecliente, '+
                       'f.cpf_cnpj, f.cidade, f.bairro, f.cep, f.endereco, f.uf, f.fone1, v.nome as nomevendedor,  gc.descricao as grupocliente, '+
                       'p.descricao as descplanopagamento, c.descricao as desccaixa, st.descricao as descstatus,  tp.descricao as desctabelapreco, '+
                       'tc.descricao as desctipocobranca, f.ENDERECO, f.bairro, f.cidade, f.uf, s.HORA, f.inscricao_est,u.loginname, s.motivocancelamento,'+
                       's.campo01, s.campo02, s.campo03, s.campo04, m.nome as Profissional, s.OUTRASDESPESAS,t.descricao as TipoDoMovimento '+
                       'from saidas s '+
                       'left join favorecidos f on s.favorecido = f.favorecido '+
                       'left join usuarios u on u.usuario = s.funccancelamento '+
                       'left join favorecidos v on s.vendedor = v.favorecido '+
                       'left join gruposcliente gc on f.grupocliente = gc.grupocliente '+
                       'left join planospagamento p on s.planopagamento = p.planopagamento '+
                       'left join statussaidas st on s.status = st.status '+
                       'left join contas c on s.caixa = c.conta '+
                       'left join tabelaspreco tp on s.tabelapadrao = tp.tabelapreco '+
                       'left join tiposcobranca tc on  s.cobranca = tc.tipocobranca '+
                       'left join favorecidos m on m.favorecido = s.medico '+
                       'left join tiposmovimento t on s.tipomovimento = t.tipomovimento '+
                       ' where '+
                       '    (s.data >= :d1 and s.data <= :d2)   and '+
                       '    s.situacao = ''N'' and  '+
                       '    s.tipopadrao = 1  ';

        sTipoOperacao := clbTipoOperacao.Selecionados;
        if (sTipoOperacao <> '') then begin
           CommandText := CommandText + 'and tc.tipocobranca in ('+sTipoOperacao+')';
        end;

        sTipoMovimento := clbTipoMovimento.Selecionados;
        if (sTipoMovimento <> '') then begin
           CommandText := CommandText + 'and t.tipomovimento in ('+sTipoMovimento+')';
        end;

        CommandText := CommandText + ' Order by s.data';
      	Params.ParamByName('d1').AsDateTime := DataI.Date;
        Params.ParamByName('d2').AsDateTime := DataF.Date;
       	Open;
  end;
        FormsComponent.Caption := 'Vendas por Tipos de Cobranças no Período de: '+DateTostr(DataI.Date) +' a '+
                                                DateTostr(DataF.Date);

end;

procedure TRptVendasTipoCobranca.btAtualizarClick(Sender: TObject);
begin
  inherited;
  Atualizar;
end;

procedure TRptVendasTipoCobranca.ppeTipoOperacaoCloseUp(Sender: TObject;
...
procedure TRptVendasTipoCobranca.FormsComponentBeforeClearParams(
  Sender: TObject);
  var
  sCamposSelecionados, sCamposSelecionadosMovimento : string;
  i : integer;
begin
  inherited;
  ...
  C_TiposCobranca.close;
  C_TiposCobranca.Open;
  clbTipoOperacao.SetDataSet(C_TiposCobranca);
  clbTipoOperacao.UpdateItems;

  C_TipoMovimento .close;
  C_TipoMovimento.Open;
  clbTipoMovimento.SetDataSet(C_TipoMovimento);
  clbTipoMovimento.UpdateItems;

  C_TiposCobranca.First;
  C_TipoMovimento.First;

  while NOT C_TiposCobranca.Eof do
  begin
    sCamposSelecionados := sCamposSelecionados + ',' + C_TiposCobranca.FieldByName('TIPOCOBRANCA').AsString ;
    C_TiposCobranca.Next;
  end;

  while NOT C_TipoMovimento.Eof do
  begin
    sCamposSelecionadosMovimento := sCamposSelecionadosMovimento + ',' + C_TipoMovimento.FieldByName('TIPOMOVIMENTO').AsString ;
    C_TipoMovimento.Next;
  end;
  ...
  clbTipoMovimento.SetSelecionados( sCamposSelecionadosMovimento );
  ppeTipomovimento.Text := clbTipoMovimento.Selecionados( true );

end;

procedure TRptVendasTipoCobranca.ppeTipoMovimentoCloseUp(Sender: TObject;
    var Text: String; var Accept: Boolean);
begin
  inherited;
