...
type
    ...
    ppLine349: TppLine;
    ppDBCalc8: TppDBCalc;
    C_InvoiceCB_DOC2: TStringField;
    C_InvoiceTIPOIMPRESSAO_OP2: TStringField;
...
var
    RptInvoicesDoc2: TRptInvoicesDoc2;
...
procedure TRptInvoicesDoc2.imprimeRbInvoiceProdServ;
var
    i: Integer;
begin
    if Template <> 0 then
    ...
    DefineColunas(RptInvoicesDoc2, 6, getColunasProdServ(C_InvoiceTipoMovimento.Value, sTipoImpressao));
...
procedure TRptInvoicesDoc2.rbRodapeBeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ppDBText7GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.AtualizaIdioma(Idioma: integer);
var campo: string;
begin
...
procedure TRptInvoicesDoc2.ppDetailBand2BeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ppDBText2GetText(Sender: TObject; var Text: string);
begin
    Text := '#' + Text;
end;

procedure TRptInvoicesDoc2.rgBalancePrint(Sender: TObject);
begin
    TppRegion(Sender).Visible := C_InvoiceTipoPadrao.Value = 1;
end;

procedure TRptInvoicesDoc2.imgPagoPrint(Sender: TObject);
begin
    TppPrintable(Sender).Visible := C_ParcelasStatus.Value >= 50;
end;

procedure TRptInvoicesDoc2.imgAtrasadoPrint(Sender: TObject);
begin
    TppPrintable(Sender).Visible := C_ParcelasStatus.Value = 3;
end;

procedure TRptInvoicesDoc2.ppDBText30GetText(Sender: TObject;
    var Text: string);
var sStatus: string;
begin
    sStatus := 'Status: ';
...
procedure TRptInvoicesDoc2.zrInvoiceBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := UpperCase(C_InvoiceDescricao.AsString) + ' #' + C_InvoiceInvoice.AsString + Chr(32) + C_InvoiceDATA.AsString;
end;

procedure TRptInvoicesDoc2.dbtTotalItemPrint(Sender: TObject);
begin
    if rbInvoice.PageNo < rbInvoice.PageCount then
        begin
...
function TRptInvoicesDoc2.SetSaltos: string;
...
procedure TRptInvoicesDoc2.GeraCabecalho(zrNome, zrEnd, zrCid, zrFone, zrLin1, zrLin2, zrLin3, zrLin4: TZRLabel);
...
function TRptInvoicesDoc2.getArquivoTemplate(Template: integer): string;
begin
    with DMProjeto.Q_SQL do
        begin
            Close;
...
procedure TRptInvoicesDoc2.ImprimeMovimento;
                ...
                if sTipoImpressao = 'P' then
                    begin
                        SQL.Text := 'Select si.saida, si.empresa, si.pdv, si.saidaitem, i.codigo, ' +
                            ...
                            'l.descricao as Local, s.descricao as StatusItem , si.taxavel, SI.ordem, si.sequencia, si.precosempromocao as precotabela, si.QUANTIDADEVOLUME, si.Observacao, ' +
...
//+ QuotedStr(StrRepeat(' ', 50)) + ' as NomeFuncionario, ' +
                        ' i.tipoitem, si.unidade, i.referencia, si.Coluna1, si.Coluna2, si.Coluna3, si.Coluna4, ' +
                            ...
                            ' si.precocustolicitacao, si.observacao ' +
                            ' from saidasitens si ' +
...
//                if (ZRTecnico.Caption = '') then ZRLabeTecnico.Caption := '';
            ...
            begin
                ...
                DefineColunas(RptInvoicesDoc2, 6, getColunasMovimento(C_InvoiceTipoMovimento.Value, sTipoImpressao));
            ...
            begin
                ...
                DefineColunas(RptInvoicesDoc2, 6, getColunasOrcamento(C_InvoiceTipoMovimento.Value, sTipoImpressao), true);
            ...
            begin
                ...
                DefineColunas(RptInvoicesDoc2, 6, getColunasEconomico(C_InvoiceTipoMovimento.Value, sTipoImpressao), true);
            ...
            begin
                ...
                DefineColunas(RptInvoicesDoc2, 6, getColunasMeiaFolha(C_InvoiceTipoMovimento.Value, sTipoImpressao), true);
...
//            XXXXXXX
            ...
            begin
                try
                    ...
                    DefineColunas(RptInvoicesDoc2, 6, getColunasMeiaFolhaLX300(C_InvoiceTipoMovimento.Value, sTipoImpressao), true);
...
procedure TRptInvoicesDoc2.DefineColunas;
...
function TRptInvoicesDoc2.getColunasMovimento;
...
function TRptInvoicesDoc2.getColunasProdServ;
var slColunas: TStringList;
begin
    slColunas := TStringList.Create;
    with DMProjeto.Q_SQL2 do
...
function TRptInvoicesDoc2.getColunasEconomico;
var slColunas: TStringList;
begin
    slColunas := TStringList.Create;
    with DMProjeto.Q_SQL2 do
...
function TRptInvoicesDoc2.getColunasMeiaFolha;
var slColunas: TStringList;
begin
    slColunas := TStringList.Create;
    with DMProjeto.Q_SQL2 do
...
function TRptInvoicesDoc2.getColunasMeiaFolhaLX300;
var
...
function TRptInvoicesDoc2.getColunasOrcamento;
var slColunas: TStringList;
begin
    slColunas := TStringList.Create;
    with DMProjeto.Q_SQL2 do
...
function TRptInvoicesDoc2.getColunasPropostas;
var slColunas: TStringList;
begin
    slColunas := TStringList.Create;
    with DMProjeto.Q_SQL2 do
...
procedure TRptInvoicesDoc2.ppDBText14GetText(Sender: TObject;
    var Text: string);
begin
    Text := 'Fax: ' + Text;
end;

procedure TRptInvoicesDoc2.ZRLabel86BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := UpperCase(C_InvoiceDescricao.AsString) + ' #' + C_InvoiceInvoice.AsString;
end;

procedure TRptInvoicesDoc2.ppDetailBand6BeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ppLabel15GetText(Sender: TObject; var Text: string);
begin
    Text := formatfloat('#,###,##0.00', nTotalServ);
end;

procedure TRptInvoicesDoc2.dbtSubTotalProd2GetText(Sender: TObject;
    var Text: string);
begin
    Text := formatfloat('#,###,##0.00', nTotalProd);
end;

procedure TRptInvoicesDoc2.DetalheItensBeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ppDBText141GetText(Sender: TObject;
    var Text: string);
begin
    Text := Text + ': ' + C_InvoiceData.AsString;
end;

procedure TRptInvoicesDoc2.DetalheSimplesBeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ChildDescComplementarBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    DoPrint := C_ItensDescricaoComplementar.AsString <> '';
end;

procedure TRptInvoicesDoc2.ChildDescComplementar2BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    DoPrint := C_ItensDescricaoComplementar.AsString <> '';
end;

procedure TRptInvoicesDoc2.ZRVendaRapidaDetailBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    DoPrint := (sTipoItem <> C_ItensDescTipoItem.AsString) and (Copy(C_InvoiceTIPOIMPRESSAO_OP2.AsString, 1, 2) = 'RS');
    sTipoItem := C_ItensDescTipoItem.AsString;
end;

function TRptInvoicesDoc2.getTipoArquivo(sArquivo: string): string;
var sExt: string;
begin
...
function TRptInvoicesDoc2.GerarArquivo(Report: TppReport; Arquivo: string = ''; bEmail: boolean = false): string;
var
...
procedure TRptInvoicesDoc2.EnviarEmail(Report: TppReport; Nome: string);
var sArquivo: string;
begin
    if Report <> nil then
...
procedure TRptInvoicesDoc2.dbtUnidadeGetText(Sender: TObject;
    var Text: string);
begin
    if C_ItensTipoItem.Value > 3 then
        Text := '';
...
procedure TRptInvoicesDoc2.ppLabel92GetText(Sender: TObject; var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppLabel91GetText(Sender: TObject; var Text: string);
begin
    if (rbServicos.PageCount > 1) and (rbServicos.PageNo <> rbServicos.PageCount) then
        Text := '*********'
    else
...
procedure TRptInvoicesDoc2.ppFooterBand11BeforeGenerate(Sender: TObject);
var i: integer;
begin
...
procedure TRptInvoicesDoc2.ppLabel70GetText(Sender: TObject; var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppLabel71GetText(Sender: TObject; var Text: string);
begin
    if pos(Copy(C_InvoiceCFOPNota.AsString, 1, 1), '567') = 0 then
        Text := ' x '
    else
...
procedure TRptInvoicesDoc2.ppLabel67GetText(Sender: TObject; var Text: string);
begin
    if pos(Copy(C_InvoiceCFOPNota.AsString, 1, 1), '567') = 0 then
        Text := ' x '
    else
...
procedure TRptInvoicesDoc2.ppLabel66GetText(Sender: TObject; var Text: string);
begin
    if pos(Copy(C_InvoiceCFOPNota.AsString, 1, 1), '567') > 0 then
        Text := ' x '
    else
...
procedure TRptInvoicesDoc2.ppDBText225GetText(Sender: TObject;
    var Text: string);
begin
    if Text = 'C' then
        Text := '1'
...
procedure TRptInvoicesDoc2.ppDBText275GetText(Sender: TObject;
    var Text: string);
begin
    if Text = 'C' then
        Text := '1'
...
procedure TRptInvoicesDoc2.ppLabel68GetText(Sender: TObject; var Text: string);
begin
...
procedure TRptInvoicesDoc2.dbtDescontoGetText(Sender: TObject;
    var Text: string);
begin
    if C_InvoiceDesconto.Value = 0 then
        Text := '';
...
procedure TRptInvoicesDoc2.lbExtensoTotalGetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppDBText171GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppLabel69GetText(Sender: TObject; var Text: string);
begin
    if C_InvoiceDesconto.Value = 0 then
        Text := '';
end;

procedure TRptInvoicesDoc2.ppLabel7GetText(Sender: TObject; var Text: string);
begin
    if Text = 'C' then
        Text := 'X'
    else
...
procedure TRptInvoicesDoc2.ppLabel13GetText(Sender: TObject; var Text: string);
begin
    if Text <> 'C' then
        Text := 'X'
    else
...
procedure TRptInvoicesDoc2.ppLabel93GetText(Sender: TObject; var Text: string);
begin
    if C_InvoiceDesconto.Value = 0 then
        Text := '';
end;

procedure TRptInvoicesDoc2.ppLabel14GetText(Sender: TObject; var Text: string);
begin
    if Text = 'C' then
        Text := 'X'
    else
...
procedure TRptInvoicesDoc2.ppLabel23GetText(Sender: TObject; var Text: string);
begin
    if Text <> 'C' then
        Text := 'X'
    else
...
procedure TRptInvoicesDoc2.ppDBText195GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppDBText204GetText(Sender: TObject;
    var Text: string);
begin
    Text := MascaraCPFCNPJ(Text);
end;

procedure TRptInvoicesDoc2.ppDBText217GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppDBText269GetText(Sender: TObject;
    var Text: string);
begin
    if lbContinuacao.Visible then
        Text := '*********';
...
procedure TRptInvoicesDoc2.ppDBText266GetText(Sender: TObject;
    var Text: string);
begin
    if lbContinuacao.Visible then
        Text := '';
...
procedure TRptInvoicesDoc2.ppDBText267GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppDBText271GetText(Sender: TObject;
    var Text: string);
begin
    if lbContinuacaoServ.Visible then
        Text := '';
...
procedure TRptInvoicesDoc2.ppDBCalc1GetText(Sender: TObject; var Text: string);
begin
...
procedure TRptInvoicesDoc2.rbServicosStartPage(Sender: TObject);
var i: integer;
begin
    if (rbServicos.PageCount > 1) and (rbServicos.PageNo <> rbServicos.PageCount) then
        begin
...
procedure TRptInvoicesDoc2.BaseCalculoISSGetText(Sender: TObject;
    var Text: string);
begin
    Text := formatfloat('#,###,##0.00', nTotalServ);
end;

procedure TRptInvoicesDoc2.ZRLabel39BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := C_InvoiceDescricao.AsString + ' #' + C_InvoiceInvoice.AsString;
end;

procedure TRptInvoicesDoc2.ZRLabel44BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := MascaraCPFCNPJ(C_InvoiceCPF_CNPJ.Value);
end;

procedure TRptInvoicesDoc2.zrChildDescComplementarBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    DoPrint := (C_InvoiceCB_DESCRICAOCOMPLEMENTAR.Value = 'S') and (C_ItensDescricaoComplementar.Value <> '');
end;

procedure TRptInvoicesDoc2.rgMensagem3Print(Sender: TObject);
begin
    rgMensagem3.Visible := C_InvoiceObs.Value <> '';
end;

procedure TRptInvoicesDoc2.rbNotaFiscalPreviewFormCreate(Sender: TObject);
begin
    rbNotaFiscal.PreviewForm.WindowState := wsMaximized;
    TppViewer(rbNotaFiscal.PreviewForm.Viewer).ZoomSetting := zspageWidth;
end;

procedure TRptInvoicesDoc2.rbServicosPreviewFormCreate(Sender: TObject);
begin
    rbServicos.PreviewForm.WindowState := wsMaximized;
    TppViewer(rbServicos.PreviewForm.Viewer).ZoomSetting := zspageWidth;
end;

procedure TRptInvoicesDoc2.ppDBText307GetText(Sender: TObject;
    var Text: string);
begin
    if (rbServicos.PageCount > 1) and (rbServicos.PageNo <> rbServicos.PageCount) then
        Text := '*********'
...
procedure TRptInvoicesDoc2.C_ItensCalcFields(DataSet: TDataSet);
begin
...
procedure TRptInvoicesDoc2.ZRLabelBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
...
procedure TRptInvoicesDoc2.ppDetailBand11BeforeGenerate(Sender: TObject);
begin
    if (rbServicos.PageCount > 1) and (rbServicos.PageNo <> rbServicos.PageCount) then
        begin
            ppLabel91.Text := '*********';
...
procedure TRptInvoicesDoc2.ZRLabel126BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := 'Ord.Ret. ' + C_InvoiceInvoice.AsString;
end;

procedure TRptInvoicesDoc2.ZRLabel156BeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
    TZRLabel(Sender).Caption := 'Autorizo Retirada => ' + DMProjeto.q_sql.FieldByName('DESCRICAO').AsString;
end;

procedure TRptInvoicesDoc2.zrlDescontoBeforePrint(Sender: TObject;
    var DoPrint: Boolean);
begin
...
procedure TRptInvoicesDoc2.C_InvoiceCalcFields(DataSet: TDataSet);
begin
...
procedure TRptInvoicesDoc2.ppFooterBand_PPGBeforePrint(Sender: TObject);
begin
...
procedure TRptInvoicesDoc2.ppPreImpresso_IIStartFirstPass(Sender: TObject);
begin
    ppFooterBand_PPG.PrintOnFirstPage := true;
end;

procedure TRptInvoicesDoc2.ppDBText341GetText(Sender: TObject;
    var Text: string);
begin
    Text := Text + ' - ';
end;

procedure TRptInvoicesDoc2.ppDBText186GetText(Sender: TObject;
    var Text: string);
begin
    Text := IntToStr(Trunc(C_InvoiceVALIDADE.AsDateTime) - Trunc(Now)) + ' Dias.';
end;

procedure TRptInvoicesDoc2.ppmAlertaContratoPrint(Sender: TObject);
begin
    ppmAlertaContrato.Lines.LoadFromFile(ExtractFilePath(Application.ExeName) + 'AlertaContrato.TXT');
end;

procedure TRptInvoicesDoc2.ppDBMemo7GetMemo(Sender: TObject; aLines: TStrings);
begin
    aLines.Append(C_ItensITEMDESC.AsString);
    aLines.Append(C_ItensDESCRICAOCOMPLEMENTAR.AsString);
end;

procedure TRptInvoicesDoc2.ppRichTextIntroducaoPrint(Sender: TObject);
begin
    try
...
procedure TRptInvoicesDoc2.ppRichExplicacoesPrint(Sender: TObject);
begin
    try
...
procedure TRptInvoicesDoc2.ppDBText412GetText(Sender: TObject;
    var Text: string);
begin
    Text := DMProjeto.sNomeEmpresa;
end;

procedure TRptInvoicesDoc2.ppDBText414GetText(Sender: TObject;
    var Text: string);
begin
    Text := DMProjeto.sEnderecoEmpresa;
end;

procedure TRptInvoicesDoc2.ppDBText447GetText(Sender: TObject;
    var Text: string);
begin
    Text := 'CEP: ' + DMProjeto.sCEPEmpresa;
end;

procedure TRptInvoicesDoc2.pfcInvoiceGetText(Sender: TObject;
    var Text: string);
begin
    Text := UpperCase(C_InvoiceDescricao.AsString) + ' #' + C_InvoiceInvoice.AsString + Chr(32) + C_InvoiceDATA.AsString;
end;

procedure TRptInvoicesDoc2.ppDBText445GetText(Sender: TObject;
    var Text: string);
begin
    Text := DMProjeto.sCidadeEmpresa + '-' + DMProjeto.sUFEmpresa;
end;

procedure TRptInvoicesDoc2.ppDBText413GetText(Sender: TObject;
    var Text: string);
begin
    Text := FormatDateTime('DD/MM/YYYY hh:mm:ss', now);
end;

procedure TRptInvoicesDoc2.ppDBText416GetText(Sender: TObject;
    var Text: string);
begin
...
procedure TRptInvoicesDoc2.ppDBText446GetText(Sender: TObject;
    var Text: string);
begin
    text := 'by Synctech';
end;

function TRptInvoicesDoc2.TotalizarItensLicitacao(idSaida: integer; Empresa: integer; Pdv: integer): Currency;
begin
    with DMProjeto.Q_SQL do
        begin
            Close;
...
function TRptInvoicesDoc2.CalcularLucro(idSaida: integer; Empresa: integer; Pdv: integer): Currency;
begin
    with DMProjeto.Q_SQL do
        begin
            Close;
...
function TRptInvoicesDoc2.TotalizarPercentualLucro(idSaida: integer; Empresa: integer; Pdv: integer): Currency;
begin
    try
        with DMProjeto.Q_SQL do
            begin
...
procedure TRptInvoicesDoc2.PrintPDF();
