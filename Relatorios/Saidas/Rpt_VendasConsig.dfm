inherited RptVendasConsig: TRptVendasConsig
  Left = 230
  Top = 171
  Width = 800
  Height = 472
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
      'select si.saidaitem, si.saida, si.descricao, i.unidade,'
      
        'cast(si.quantidade as Numeric(15,4)) * si.fator / i.fatorundvend' +
        'a  as quantidade,'
      
        'si.preco, si.subtotalitem, f.nome as nomecliente, v.nome as nome' +
        'vendedor, s.data, s.numero,  '
      
        's.favorecido, f.tipofavorecido, gi.descricaogrupo,fb.descricao a' +
        's fabricante, '
      
        'fn.nome as nomefornecedor, si.customedio*si.fator as customedio,' +
        ' '
      'si.custocontabil*si.fator as custocontabil, '
      
        'cast(si.rateiodesconto * si.quantidade as numeric(15,2)) as rate' +
        'iodesconto, si.coluna1, '
      'si.coluna2, si.coluna3, si.coluna4,'
      
        'I.piscofins, cast(si.subtotalitem - (si.rateiodesconto * si.quan' +
        'tidade) as Numeric(15,2)) AS  ValorFinal'
      'from'
      'Saidas s '
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaRATEIODESCONTO: TBCDField
      FieldName = 'RATEIODESCONTO'
      Precision = 18
      Size = 2
    end
    ...
    object C_ConsultaVALORFINAL: TBCDField
      FieldName = 'VALORFINAL'
      Precision = 18
      Size = 2
    end
  ...
  object Q_TiposMovimentos: TIBQuery
    ...
    SQL.Strings = (
        ...
        'PADRAO in (4) order by DESCRICAO')
    Left = 425
    Top = 152
