inherited RptProdutosOrcamentos: TRptProdutosOrcamentos
  Left = 194
  Top = 99
  Width = 1198
  Height = 608
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select i.codigo, si.descricao, i.unidade, gi.descricaogrupo, si.' +
        'preco, f.descricao as fabricante, i.referencia,  Sum(si.quantida' +
        'de) as Quantidade, Sum(si.preco * si.quantidade) as SUBTOTALITEM'
      
        'From Saidas s    LEFT join SaidasItens si on si.saida = s.saida ' +
        '  LEFT join itens i on i.item = si.item   LEFT join favorecidos ' +
        'v on v.favorecido = s.vendedor   LEFT join Fabricantes f on f.fa' +
        'bricante = i.fabricante    LEFT join Grupos gi on gi.grupo = i.g' +
        'rupo'
