inherited RptOrcamentosProdutos: TRptOrcamentosProdutos
  Left = 237
  Top = 71
  Width = 1001
  Height = 583
  ...
  object Q_TiposMovimentos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select s.status, s.descricao from statussaidas s order by ordem')
    Left = 425
    Top = 152
    object Q_TiposMovimentosSTATUS: TIBStringField
      FieldName = 'STATUS'
