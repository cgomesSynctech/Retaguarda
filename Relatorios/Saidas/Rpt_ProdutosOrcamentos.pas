...
type
    TRptProdutosOrcamentos = class(TRptPadrao)
        TS_Label1: TTS_Label;
        TS_Label2: TTS_Label;
...
var
    RptProdutosOrcamentos: TRptProdutosOrcamentos;
...
procedure TRptProdutosOrcamentos.FormsComponentBeforeClearParams(
    Sender: TObject);
var
    i: integer;
    bAccept: Boolean;
...
begin
    ...
    clbTipoPadrao.SetSelecionados('3');
...
procedure TRptProdutosOrcamentos.Atualizar;
var
...
//            sSituacao := sSituacao + ' and si.situacao = ' + iif(cbItensCancelados.Checked, ' ''C'' ', ' ''N'' ');
            ...
            CommandText := CommandText + ' Group by 1,2,3,4,5,6,7 ';
    ...
    FormsComponent.Caption := 'Produtos de Orçamentos no Período: ' + DateTostr(DataI.Date) + ' a ' +
        DateTostr(DataF.Date);
end;

procedure TRptProdutosOrcamentos.btAtualizarClick(Sender: TObject);
begin
    inherited;
    Atualizar;
end;

procedure TRptProdutosOrcamentos.TS_LCBTipoMovimentoChange(Sender: TObject);
begin
    inherited;
    Atualizar;
end;

procedure TRptProdutosOrcamentos.PopupFiltrarItensSelecionou(
    Sender: TObject);
begin
    inherited;
    //	Atualizar;
...
procedure TRptProdutosOrcamentos.cbCanceladasChange(Sender: TObject);
begin
    inherited;
    //  Atualizar;
end;

procedure TRptProdutosOrcamentos.TS_PopupEdit1CloseUp(Sender: TObject;
...
procedure TRptProdutosOrcamentos.DataIDateChange(Sender: TObject);
begin
    inherited;
    //  Atualizar;
end;

procedure TRptProdutosOrcamentos.PPE_TIPOMOVIMENTOCloseUp(Sender: TObject;
    var Text: string; var Accept: Boolean);
begin
    inherited;
...
procedure TRptProdutosOrcamentos.PPE_TipoPadraoCloseUp(Sender: TObject;
    var Text: string; var Accept: Boolean);
begin
    inherited;
...
procedure TRptProdutosOrcamentos.btVendedorClick(Sender: TObject);
begin
    inherited;
    with DMProjeto do
        begin
