inherited RptProdutosVendidos: TRptProdutosVendidos
  Left = 216
  Top = 120
  Width = 983
  Height = 494
  ...
  inherited pnGrid: TPanel
    ...
    inherited pnDados: TTS_Panel
      ...
      object PPE_TIPOMOVIMENTO: TTS_PopupEdit
        Left = 311
        Top = 26
        Width = 155
        TabOrder = 5
        ...
        StyleController = DMProjeto.esClientes
        HideEditCursor = True
        PopupControl = clbTIPOMOVIMENTO
        PopupFormBorderStyle = pbsSysPanel
        OnCloseUp = PPE_TIPOMOVIMENTOCloseUp
        LookupKeyValue = 0
        Height = 19
      end
      object PPE_TipoPadrao: TTS_PopupEdit
        Left = 84
        Top = 26
        Width = 129
        TabOrder = 6
        ...
        PopupFormBorderStyle = pbsSysPanel
        OnCloseUp = PPE_TipoPadraoCloseUp
        LookupKeyValue = 0
        Height = 19
      end
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      SummaryGroups = <
        item
          ...
          SummaryItems = <
            ...
            item
              SummaryField = 'VOLUMES'
              SummaryFormat = '>VOLUMES=#,###,##0.00'
              SummaryType = cstSum
            end>
          Name = 'Default'
        end>
      ...
      object dbgConsultaVolumes: TdxDBGridMaskColumn
        Caption = 'Qtd. Volume'
        HeaderAlignment = taCenter
        Width = 78
        BandIndex = 0
      ...
      object dbgConsultaCliente: TdxDBGridColumn
        Caption = 'Cliente'
        HeaderAlignment = taCenter
        Sorted = csUp
        Visible = False
      ...
      object dbgConsultaVendedor: TdxDBGridColumn
        Caption = 'Vendedor'
        HeaderAlignment = taCenter
        Width = 100
        BandIndex = 0
      ...
      object dbgConsultaCusto: TdxDBGridColumn
        Caption = 'Custo'
        HeaderAlignment = taCenter
        BandIndex = 0
        RowIndex = 0
  ...
  object clbTIPOMOVIMENTO: TTS_CheckListBox [3]
    Left = 349
    Top = 110
    Width = 174
    Height = 147
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select si.descricao, i.unidade, gi.descricaogrupo, si.preco, f.d' +
        'escricao,'
      ' c.nome, v.nome as Vendedor,'
      'gc.Descricao as DescsGrupoComissao,'
      ' Max(s.total) as Total,'
      ' Sum((si.fator*si.quantidade)/i.fatorundvenda) as Quantidade,'
      ' Sum(si.preco * si.quantidade) as SUBTOTALITEM,'
      ' sum(si.customedio * si.quantidade) as Custo,'
      ' sum(si.quantidadevolume) as Volumes'
      'From Saidas s'
      '   LEFT join SaidasItens si on si.saida = s.saida'
      '   LEFT join itens i on i.item = si.item'
      '   LEFT join favorecidos c on c.favorecido = s.favorecido'
      ...
      '   LEFT join Grupos gi on gi.grupo = i.grupo'
        ...
        '   LEFT join GruposComissoes gc on gc.grupocomissao = i.grupocom' +
        'issao'
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaDESCSGRUPOCOMISSAO: TStringField
      FieldName = 'DESCSGRUPOCOMISSAO'
      Size = 30
    end
    object C_ConsultaVOLUMES: TFloatField
      FieldName = 'VOLUMES'
    end
  ...
  object Q_TiposMovimentos: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'Select TIPOMOVIMENTO, DESCRICAO from TIPOSMOVIMENTO '
      'order by DESCRICAO')
    Left = 425
    Top = 150
  ...
  object Q_TipoPadrao: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select tipopadrao, descricao from tipospadrao where tipo = '#39'S'#39' o' +
        'rder by descricao')
    Left = 534
    Top = 118
  end
