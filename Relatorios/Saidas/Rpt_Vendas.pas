...
begin
    { Felipe - As mudanças feitas abaixo foram para acelerar o resultado da consulta (04/11/2016) }
    ...
    with C_Consulta do
        begin Close;
            ...
            Open;
            FormsComponent.Caption := 'Vendas com Lucro no Período de: ' + DateTostr(DataI.Date) + ' a ' +
