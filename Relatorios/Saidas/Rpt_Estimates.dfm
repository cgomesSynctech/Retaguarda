inherited RptEstimates: TRptEstimates
  Left = 19
  Top = 77
  Width = 791
  Height = 462
  ...
  inherited pnGrid: TPanel
    ...
    inherited pnDados: TTS_Panel
      ...
      object edValidadeI: TTS_DateTimePicker
        Left = 67
        Top = 21
        Width = 78
        TabOrder = 2
        ...
        Date = -700000
        UseEditMask = True
        OnDateChange = edValidadeIDateChange
        Height = 19
        StoredValues = 4
      end
      object edValidadeF: TTS_DateTimePicker
        Left = 163
        Top = 21
        Width = 81
        TabOrder = 3
      ...
      object cbValidade: TTS_CheckBox
        Left = 1
        Top = 20
        Width = 21
        Style.BorderStyle = xbsNone
  ...
  inherited ppmPadrao: TTS_PopupMenu
    ...
    object AbrirEstimate1: TMenuItem [1]
      Caption = 'Abrir Estimate'
      OnClick = AbrirEstimate1Click
    end
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        's.desconto, s.frete, s.outrasdespesas, s.juros, s.validade, f.co' +
        'digo,'
      
        's.imposto, s.total, s.baseimposto, s.status, ss.descricao as sta' +
        'tusdesc'
      'from saidas s join favorecidos f'
      'on s.favorecido = f.favorecido'
      'left join favorecidos fu on s.vendedor = fu.favorecido'
      'inner join statussaidas ss on s.status = ss.status'
      'where s.tipopadrao = 3 and s.situacao = '#39'N'#39' ')
    Left = 293
    Top = 111
  end
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaSTATUSDESC: TStringField
      FieldName = 'STATUSDESC'
      Origin = 'STATUSSAIDAS.STATUSDESC'
      Size = 30
    end
