inherited DlgGraficoFaturamento: TDlgGraficoFaturamento
  Left = 23
  Top = 31
  Width = 1138
  Height = 591
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 241
      AutoSize = True
      Caption = 'Analitico de Faturamento'
  ...
  inherited FormsComponent: TFormsComponent
    ...
    FormColor = 15724519
    Modulo = 'Financeiro'
    Caption = 'GraficoFaturamento de Faturamento'
    Left = 209
    Top = 178
  end
  object Q_GraficoFaturamento: TIBQuery
  ...
  object C_GraficoFaturamento: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'P_GraficoFaturamento'
    Left = 272
    Top = 273
    object C_GraficoFaturamentoMESANO: TStringField
      FieldName = 'MESANO'
      Size = 10
    end
    object C_GraficoFaturamentoTOTAL: TBCDField
      FieldName = 'TOTAL'
      Precision = 18
      Size = 2
    end
  end
  object P_GraficoFaturamento: TDataSetProvider
    DataSet = Q_GraficoFaturamento
    Constraints = True
    Left = 336
    Top = 293
  end
  object C_GraficoFaturamentoDS: TDataSource
    DataSet = C_GraficoFaturamento
    Left = 324
    Top = 365
  end
