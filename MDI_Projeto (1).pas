...
type
    ...
    procedure ProjetoAccera1Click(Sender: TObject);
...
procedure TMDIProjeto.ToolButton27Click(Sender: TObject);
begin
  inherited;
        DMProjeto.CriarForm('DLGIP', self, false);
end;

procedure TMDIProjeto.ProjetoAccera1Click(Sender: TObject);
begin
  inherited;
        DMProjeto.CriarForm('DlgProjetoAccera', self, false);
end;

procedure TMDIProjeto.Boletos2Click(Sender: TObject);
begin
  inherited;
       DMProjeto.CriarForm('dlgip', self, false);
end;

procedure TMDIProjeto.ApagarEntrada1Click(Sender: TObject);
begin
  inherited;
     DMProjeto.CriarForm('DlgDelEntrada', self, false);
end;

procedure TMDIProjeto.Embalagem1Click(Sender: TObject);
begin
  inherited;
         DMProjeto.CriarForm('FrmEmbalagem', self, false);
end;
