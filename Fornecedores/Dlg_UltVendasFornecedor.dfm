inherited DlgUltVendasFornecedor: TDlgUltVendasFornecedor
  Left = 53
  Top = 131
  Width = 696
  Height = 358
  ...
  inherited pnDados: TTS_Panel [1]
    ...
    object mvUltimasVendas: TdxMasterView
      ...
      object stBranco: TdxMasterViewStyle
      ...
      object stCinzaEscuro: TdxMasterViewStyle
        Color = 13224393
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object stGroup: TdxMasterViewStyle
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object stSubTotal: TdxMasterViewStyle
        Color = clGray
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -11
      ...
      object stJuros: TdxMasterViewStyle
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clMaroon
        Font.Height = -11
      ...
      object stDescontos: TdxMasterViewStyle
        Color = clWhite
      ...
      object mvUltimasVendasStyle1: TdxMasterViewStyle
        Color = 14608375
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object mvVendas: TdxMasterViewLevel
        Caption = 'Vendas'
        ContentStyle = stBranco
        DataSource = C_VendasDS
        FooterStyle = stBranco
        GroupByBoxStyle = stGroup
        HeaderStyle = stCinzaAndre
        ID = 'ENTRADA'
        ...
        object mvVendasProd: TdxMasterViewLevel
          Caption = 'Itens'
          CaptionStyle = mvUltimasVendasStyle1
          ...
          OptionsDB = [lodConfirmDelete, lodSmartReload]
          OptionsView = [lovFooter, lovGrid, lovGridWithPreview, lovHeader, lovOccupyRestSpace]
          OnGetContentStyle = mvVendasProdGetContentStyle
  ...
  inherited pnTitulo: TTS_MaxPanel [2]
    ...
    inherited lbUpperHint: TTS_Label
      ...
      Width = 0
      Height = 36
      Caption = 'Compras a '#13#10'Fornecedores'
    end
  ...
  object C_Vendas: TClientDataSet
    ...
    Left = 385
    Top = 79
    object C_VendasENTRADA: TIntegerField
      FieldName = 'ENTRADA'
      Required = True
    end
  ...
  object Q_Vendas: TIBQuery
    ...
    SQL.Strings = (
      ...
      'Where s.Favorecido = :Favorecido and s.TipoPadrao = 101'
  ...
  object Q_VendasProd: TIBQuery
    ...
    SQL.Strings = (
      ...
      '        si.quantidade,'
      '        si.preco,'
      '        si.quantidade*si.preco as subtotal,'
      '        si.taxavel'
  ...
  object C_VendasProd: TClientDataSet
    ...
    Left = 400
    Top = 152
    object C_VendasProdENTRADA: TIntegerField
      FieldName = 'ENTRADA'
    end
  ...
  object ppmVendasProd: TTS_PopupMenu
    Left = 216
    Top = 101
    object EstatsticasdeVendasdoProduto1: TMenuItem
      Caption = 'Estat'#237'sticas de Vendas do Produto'
    end
  end
