inherited DlgExtFinFornecedor: TDlgExtFinFornecedor
  Left = 82
  Top = 110
  Width = 667
  Height = 348
  ...
  object Q_Invoices: TIBQuery
    ...
    SQL.Strings = (
      ...
      '        tr.notafiscal,'
        ...
        '        (tr.valor-tr.valorpago-tr.creditoutilizado-tr.descontos)' +
        ' as Saldo,'
      '        f.tipofavorecido'
      'From DuplicatasAPagar tr'
      'Join StatusTitulos st On tr.status=st.status'
      'Join favorecidos f on tr.fornecedor=f.favorecido'
      'Where tr.fornecedor=:Favorecido')
    Left = 432
    Top = 152
    ParamData = <
      item
