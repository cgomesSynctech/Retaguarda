...
begin
  inherited;
     MessageDlg('O Sistema ira excluir todas as informações da entrada com a chave Informada. Sera gerado auditoria interna para analises futuras.', mtInformation, [mbOK], 0);
