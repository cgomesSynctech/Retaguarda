inherited DMMecanica: TDMMecanica
  Left = 382
  Top = 19
  Height = 560
  Width = 661
  ...
  inherited U_Tabela: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'FORAGARANTIA, '
      'GARANTIAFABRICA,SEMEMBALAGEM,OBSAVARIA,TECNICOENTRADA,   PLACA,'
      
        '  MARCAMODELO,   PRISMA,    ANO,   HODOMETRO, COR, MOTOR, MOTORI' +
        'STA '
      ')'
      'values'
      '  (:SERVICO, :OSNUMERO, :CLIENTE, :DATAENTRADA, :HORAENTRADA, '
      ...
      ':PLACA, :MARCAMODELO, :PRISMA, :ANO, :HODOMETRO, :COR, :MOTOR, '
      ':MOTORISTA)')
    DeleteSQL.Strings = (
  ...
  inherited C_Tabela: TClientDataSet
    ...
    object C_Tabelalkmarcamodelo: TStringField
      FieldKind = fkLookup
      FieldName = 'lkmarcamodelo'
      LookupDataSet = C_MarcaModelo
      LookupKeyFields = 'ID'
      LookupResultField = 'MODELO'
      KeyFields = 'MARCAMODELO'
      Size = 25
      Lookup = True
    end
    ...
    object C_TabelaMARCAMODELO: TIntegerField
      FieldName = 'MARCAMODELO'
    end
    object C_TabelaPRISMA: TStringField
      FieldName = 'PRISMA'
      Size = 4
    end
    object C_TabelaANO: TStringField
      FieldName = 'ANO'
      Size = 4
    end
    object C_TabelaHODOMETRO: TIntegerField
      FieldName = 'HODOMETRO'
    end
    object C_TabelaMOTOR: TStringField
      FieldName = 'MOTOR'
    end
    ...
    object C_TabelaMOTORISTA: TStringField
      FieldName = 'MOTORISTA'
    end
  end
  ...
  object P_MarcaModelo: TDataSetProvider
    DataSet = Q_MarcaModelo
    Constraints = True
    Options = [poIncFieldProps, poCascadeDeletes, poCascadeUpdates, poPropogateChanges, poAllowCommandText]
    Left = 201
    Top = 453
  end
  object C_MarcaModelo: TClientDataSet
    Tag = 100
    Aggregates = <>
    Params = <>
    ProviderName = 'P_MarcaModelo'
    AfterOpen = C_TabelaAfterOpen
    AfterClose = C_TabelaAfterClose
    AfterPost = C_TabelaAfterPost
    OnNewRecord = C_TabelaNewRecord
    ...
    object C_MarcaModeloID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object C_MarcaModeloMODELO: TStringField
      FieldName = 'MODELO'
      Size = 25
    end
  end
  object C_MarcaModeloDS: TDataSource
    Tag = 100
    DataSet = C_MarcaModelo
    Left = 396
    Top = 450
  end
end
