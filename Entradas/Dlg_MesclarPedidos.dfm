inherited DlgMesclarPedidos: TDlgMesclarPedidos
  Left = 510
  Top = 54
  Width = 750
  Height = 377
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbEstadoForm: TTS_Label
      Top = 25
      Width = 242
      Caption = 'Escolha os Pedidos e os Itens que ser'#227'o faturados'
    end
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      #9'tp.Descricao as DescTipoPadrao'
        ...
        'Where '#9'e.Situacao = '#39'N'#39' and KK and  e.TipoPadrao in (ZZ) and e.F' +
        'avorecido in (XX)'
      '')
    UniDirectional = True
    Left = 49
  ...
  object C_Movimentos: TClientDataSet
    ...
    object C_MovimentosEMPRESA: TIntegerField
      FieldName = 'EMPRESA'
      Required = True
    end
