...
type
  TDlgMescEntConsig = class(TFrmModeloCadastros)
...
var
  DlgMescEntConsig: TDlgMescEntConsig;
...
procedure TDlgMescEntConsig.FormShow(Sender: TObject);
...
begin
  ...
  try
    ...
    while not C_Acerto.EOF do begin
      ...
      C_Acerto.Edit;
      if est <= qtdconsig - qtddev - qtdacert then begin
        C_Acerto.FieldByName('qtdvalidar').Value := est;
        C_Acerto.FieldByName('qtddevolvida').Value := est;
      end
      else begin
...
procedure TDlgMescEntConsig.Q_MovimentosBeforeOpen(DataSet: TDataSet);
var
...
procedure TDlgMescEntConsig.GridMovsTS_OnAfterSelection(
...
procedure TDlgMescEntConsig.dbgItensTS_OnAfterSelection(
  Sender: TObject; bSelected: Boolean; QtdSel: Integer);
begin
  inherited;
...
procedure TDlgMescEntConsig.GridMovsItensCloseUp(Sender: TObject;
...
procedure TDlgMescEntConsig.AtualizarSelecionados;
begin
...
procedure TDlgMescEntConsig.dbgItensEditing(Sender: TObject;
...
procedure TDlgMescEntConsig.dbgItensEdited(Sender: TObject;
...
procedure TDlgMescEntConsig.C_ItensicQtdMesclarValidate(
  Sender: TField);
begin
  inherited;
...
procedure TDlgMescEntConsig.btGravarClick(Sender: TObject);
var
  m, i : Integer;
...
procedure TDlgMescEntConsig.JoinItemToOperation;
...
procedure TDlgMescEntConsig.dbgItensTS_OnSelection(Sender: TObject;
...
procedure TDlgMescEntConsig.gridAcertoCustomDrawCell(Sender: TObject;
...
procedure TDlgMescEntConsig.C_AcertoQtddevolvidaValidate(Sender: TField);
begin
  inherited;
