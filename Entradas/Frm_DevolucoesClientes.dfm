      ...
      inherited pgItens: TTS_PageControl
        ...
        inherited tsItens: TTS_TabSheet
          ...
          inherited dbgItens: TTS_QDBGrid
            ...
            inherited dbgItensBASECALCICMSPROD: TdxDBGridColumn [28]
              Width = 68
            end
            inherited dbgItensAliqICMS: TdxDBGridMaskColumn [29]
              Visible = True
              Width = 58
            end
            inherited dbgItensVALORICMSPROD: TdxDBGridColumn [30]
            end
            inherited dbgItensBASECALCSUBSTPROD: TdxDBGridColumn [31]
              Width = 103
            end
            inherited dbgItensvaloricmssubstprod: TdxDBGridColumn [32]
            end
            object dbgItensCSTIPI: TdxDBGridLookupColumn [33]
              Caption = 'Cst IPI'
              HeaderAlignment = taCenter
              BandIndex = 0
              RowIndex = 0
            ...
            inherited dbgItensIPI: TdxDBGridMaskColumn [34]
              Caption = '% IPI'
              Visible = True
              Width = 50
            end
            inherited dbgItensVALORIPIPROD: TdxDBGridColumn [35]
              Width = 64
            end
            inherited dbgItensTVA: TdxDBGridMaskColumn [36]
              Width = 59
            end
            inherited dbgItensCFOP: TdxDBGridPopupColumn [37]
            end
            inherited dbgItensCSTPISCOFINS: TdxDBGridLookupColumn [38]
              Caption = 'Cst Pis/Cofins'
              Width = 77
              FieldName = 'lookUpCSTsPisCofins'
              DropDownWidth = 680
            end
            inherited dbgItensALIQPIS: TdxDBGridColumn [39]
              Caption = '% Pis'
              Width = 55
            end
            inherited dbgItensALIQCOFINS: TdxDBGridColumn [40]
              Caption = '% Cofins'
              Width = 69
            end
            object dbgItensVALORPISPROD: TdxDBGridMaskColumn [41]
              Caption = 'Valor Pis'
              HeaderAlignment = taCenter
              BandIndex = 0
              RowIndex = 0
            ...
            object dbgItensVALORCOFINSPROD: TdxDBGridMaskColumn [42]
            ...
            inherited dbgItensColumn27: TdxDBGridColumn [43]
              Width = 95
            end
            inherited dbgItensDesconto: TdxDBGridMaskColumn [44]
            end
            inherited dbgItensPDESCONTO: TdxDBGridMaskColumn [45]
              Visible = False
            end
            ...
            inherited dbgItensSitECF: TdxDBGridLookupColumn [48]
              Visible = True
              Width = 59
              DropDownWidth = 150
            end
            inherited dbgItensColumn26: TdxDBGridColumn [49]
              HeaderAlignment = taCenter
              Width = 59
            end
            inherited dbgItensCST: TdxDBGridLookupColumn [50]
              Alignment = taCenter
              Visible = True
              Width = 57
              DropDownWidth = 380
