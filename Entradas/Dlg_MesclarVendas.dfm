inherited DlgMesclarVendas: TDlgMesclarVendas
  Left = 339
  Top = 155
  Width = 750
  Height = 462
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbEstadoForm: TTS_Label
      Top = 25
      Width = 187
      Caption = 'Escolha os Itens que ser'#227'o devolvidos.'
    end
    ...
    inherited lbCaption: TdxfLabel
      Width = 280
      AutoSize = True
      Caption = 'Vendas Realizadas do Cliente'
  ...
  inherited pnDados: TTS_Panel
    ...
    object TS_Label3: TTS_Label
      ...
      Top = 36
      Width = 284
      Caption = 'Informe o Periodo de Vendas que deseja Pesquisar -->'
      FormatoTabela = False
      LinkToResult = 0
    end
  ...
  object Q_Movimentos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'LEFT JOIN Favorecidos v ON v.Favorecido = s.Vendedor'
        ...
        'Where s.Situacao = '#39'N'#39' and  KK and s.TipoPadrao = ZZ and s.Favor' +
        'ecido  =  XX and s.data = :datainicio and s.data <= :datafinal'
