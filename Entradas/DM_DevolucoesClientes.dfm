inherited DMDevolucoesClientes: TDMDevolucoesClientes
  Left = 250
  Top = 22
  Height = 633
  Width = 1001
  inherited Q_Tabela: TIBQuery
    SQL.Strings = (
      ...
      '        inner join recibosnfe r on r.idmestre = t.entrada')
  end
  inherited U_Tabela: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'VENDEDOR, ESPECIE, PDV, EMPRESA, CHAVENFE )'
      'values'
      ...
      ':NOTAORIGEM, :FRETEEXTERNO, :INDEXADOR, :FONTE, '
        ...
        ':BAIXAESTOQUEFISCAL, :VENDEDOR, :ESPECIE, :PDV, :EMPRESA, :CHAVE' +
        'NFE )')
  end
  ...
  inherited U_Itens: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '    ALIQIPI, V_BCII, V_DESPADUII, V_II, V_IOFII, RATEIODESPESAS,'
      '    RATEIOFRETE,  RATEIOSEGURO, FRETE, SEGURO, OUTRASDESPESAS)'
      'values'
      ...
      ':QUANTIDADEVOLUME, :FABRICACAO, :PDV, :EMPRESA, '
      '   :CSTPISCOFINS, :ALIQPIS, :ALIQCOFINS, :VALORPISPROD,'
      '    :VALORCOFINSPROD, :CSTIPI, :ALIQIPI,  :V_BCII,'
      '    :V_DESPADUII, :V_II, :V_IOFII, :RATEIODESPESAS,'
  ...
  inherited C_Itens: TClientDataSet
    Left = 164
    inherited C_ItenslkCST: TStringField
  ...
  inherited Q_TiposMovimento: TIBQuery
    SQL.Strings = (
      ...
      'Where t.TipoPadrao = 106 and t.TipoPadrao = tp.TipoPadrao'
