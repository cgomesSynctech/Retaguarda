...
type
    ...
    C_ItensicValorUnitarioExtenso: TStringField;
    dbpInvItensppField54: TppField;
    C_ItensicSubTotalItemExtenso: TStringField;
    dbpInvItensppField55: TppField;
    ppDBValorUnitarioExtenso: TppDBText;
    ppDBSubTotalItemExtenso: TppDBText;
    ppLabel293: TppLabel;
    ppLabel294: TppLabel;
    ppShape122: TppShape;
    ppShape123: TppShape;
    zrvCenter_NomeCliente: TZRField;
    zrvCenter_CNPJ: TZRField;
    zrvField_Nome: TZRField;
...
//                if (ZRTecnico.Caption = '') then ZRLabeTecnico.Caption := '';
       ...
       { aCRESENTADO POR cESAR 10-10-2017 , IMPRESSÃO DO PEDIDO DUAS VIAS , PARA APENAS UMA vIA ... SEM SER ATRAVEZ DE pdf.}
...
begin
    ...
    DataSet.FieldByName('icValorUnitarioExtenso').AsString := Util2.Extenso(C_ItensPRECO.Value);
    DataSet.FieldByName('icSubTotalItemExtenso').AsString := Util2.Extenso(C_ItensTOTAL.Value);
