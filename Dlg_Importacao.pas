      ...
      while (sRegistro <> '') do begin
        ...
        with DMBBClientes do begin
          ...
          if (sVendedor <> '') and (nIDVendedor = 0) then begin
            DlgMsg.ShowMsg(6015,['funcionários']);
            bCancelar := true;
            break;
          end
          else begin
  ...
  if OpenDialog.Execute then begin
    ...
    try
      ...
      while (sRegistro <> '') do begin
        ...
        with DMBBClientes do begin // Inventário
          nIDCliente := 0;
          if sCodigo <> '' then
  ...
  if OpenDialog.Execute then begin
    ...
    try
      ...
      while (sRegistro <> '') do begin
        ...
        with DMBBFornecedores do begin // Inventário
          nIDFornecedor := 0;
          if sCodigo <> '' then
...
begin
  inherited;
  DMProjeto.ImprimirCabecalho( ppCabecalho9 );
  ppTitulo.caption := sTituloRel +' dos Cheques Pagos à Compensar';
  Q_Layout.close;
...
begin
  ...
  if OpenDialog.Execute then begin
    ...
    //  nTipoFavImport := 2
    //else if nTipoFavImport = 200 then // Funcionários
    //  nTipoFavImport := 3
  ...
  if OpenDialog.Execute then begin
    ...
    try
      ...
      while (sRegistro <> '') do begin
        ...
        with DMBBItens do begin // Inventário
  ...
  if OpenDialog.Execute then begin
    ...
    try
      ...
      while (sRegistro <> '') do begin
        ...
        if sTipo = '1' then with DMBBItens do begin // Inventário
...
begin
  ...
  sTituloRel := 'Formato/Layout do Arquivo de Importação de dados';
