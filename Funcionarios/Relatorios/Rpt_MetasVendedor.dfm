inherited RptMetasVendedor: TRptMetasVendedor
  Left = 41
  Top = 40
  Caption = 'Financeiro'
  PixelsPerInch = 96
  ...
  inherited pnTitulo: TTS_MaxPanel
    inherited lbCaption: TdxfLabel
      Width = 349
      Caption = 'Metas de Faturamento por Vendedor'
    end
    inherited lbDescricaoRelatorio: TTS_Label
      Width = 374
      Caption = 
        'Lista as metas de vendas di'#225'rias para cada vendedor e o quanto f' +
        'oi faturado.'
    end
  end
  inherited pnGrid: TPanel
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      object dbgConsultaFATPERIODO: TdxDBGridCurrencyColumn
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaFATPERIODO: TFloatField
      FieldName = 'FATPERIODO'
    end
  end
