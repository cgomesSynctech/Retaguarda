...
begin
    ...
    begin
        ...
        cmbUnidadePrecoChange(self); //Já chama o AdicionaTabelaPreco
...
begin
    ...
    begin
        ...
        begin
            DMItens.C_Tabela.Edit;
            DMItens.C_TabelaTipoItem.Value := 1; {Obrigando que seja item de inventário}
...
begin
    ...
    begin
        ...
        case lbDescMax1.Font.Color of
            ...
            clTeal: lbDescMax1.Hint := 'Maior Desconto que os Usuário podem dar';
...
begin
    inherited;
    {Gerando ProdutosPreco se os preços da unidade foram modificados pelo usuário}
    if dbgTabelaPreco.DataSource.DataSet.Name = 'C_ProdutosPrecoTmp' then
    begin
        {Verificando se houve Alteração dos precos}
...
begin
    ...
    {O Registro será salvo automaticamene se o usuário modificar o Preco;
     Para subitens, no momento em que a tela é fechada já é salvo o registro}
    with DMItens do
    begin
