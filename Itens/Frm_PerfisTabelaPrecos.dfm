inherited FrmPerfisTabelaPrecos: TFrmPerfisTabelaPrecos
  Left = 99
  Top = 141
  ...
  inherited pnDados: TTS_Panel
    ...
    object dbgTabelas: TTS_QDBGrid
      ...
      object dbgTabelasCONSULTAR: TdxDBGridCheckColumn
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 270
      Caption = 'Perfis das Tabelas de Pre'#231'os'
  ...
  object Q_Tabelas: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select ptp.id,tp.tabelapreco,tp.descricao, ptp.consultar, ptp.ut' +
        'ilizar'
      'from tabelaspreco tp left join perfistabelaprecos ptp on'
      'tp.tabelapreco = ptp.tabelapreco and ptp.perfil = :perfil'
      'where tp.desativado = '#39'N'#39
      'order by tp.tabelapreco')
  ...
  object C_Tabelas: TClientDataSet
    ...
    object C_TabelasCONSULTAR: TStringField
      FieldName = 'CONSULTAR'
      Size = 1
    end
    ...
    object C_TabelasTABELAPRECO: TIntegerField
      FieldName = 'TABELAPRECO'
      Required = True
    end
