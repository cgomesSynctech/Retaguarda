...
begin
    ...
    btComando1.Down := True; //  deixar botão pressionado
    ...
    btComando1.Down := False; // deixar botão livre
end;
...
begin
    ...
    if (True) then
        ...
        begin
            DlgMsg.ShowMsg(50, ['Existem itens na produção que estão com estoque negativo ou insuficiente. Não será possível prosseguir com a ' +
                'operação.']);
                btComando2.Down := False;
        end;
