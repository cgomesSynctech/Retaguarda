inherited FrmAcomphMontagens: TFrmAcomphMontagens
  Left = 367
  Top = 163
  Width = 779
  Height = 415
  ...
  inherited pnNavigator: TTS_Panel
    ...
    object btEntregar: TTS_SpeedButton
      Left = 1
      Top = 139
      Width = 109
      Caption = 'Entregar'
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 399
      AutoSize = True
      Caption = 'Acompanhamento de Ordens de Produ'#231#227'o'
  ...
  inherited pnDados: TTS_Panel
    ...
    object dbgSubItens: TTS_QDBGrid
      ...
      TabOrder = 8
      Visible = False
      OnDblClick = dbgSubItensDblClick
      ...
      BandFont.Style = []
      DataSource = C_MontagensFilhosDS
    ...
    object dbgItens: TTS_QDBGrid
      ...
      TS_SummaryFooterQtdText = 'Qtd. Geral:'
      TS_SummaryFooterQtdSelectedText = 'Qtd. Selecionada:'
      object dbgItensMONTAGEM: TdxDBGridMaskColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 52
        BandIndex = 0
      ...
      object dbgItensColumn17: TdxDBGridColumn
        Caption = 'N'#250'mero'
        HeaderAlignment = taCenter
        Width = 68
        BandIndex = 0
      ...
      object dbgItensMONTADOR: TdxDBGridMaskColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 52
        BandIndex = 0
      ...
      object dbgItensQTDESOLIC: TdxDBGridMaskColumn
        Caption = 'Qtde.'
        HeaderAlignment = taCenter
        Width = 58
        BandIndex = 0
      ...
      object dbgItensQTDEPRODUZIDO: TdxDBGridMaskColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 97
        BandIndex = 0
      ...
      object dbgItensOBS: TdxDBGridMaskColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 1253
        BandIndex = 0
      ...
      object dbgItensDATACONCLUSAO: TdxDBGridDateColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 78
        BandIndex = 0
      ...
      object dbgItensHORACONCLUSAO: TdxDBGridMaskColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 79
        BandIndex = 0
      ...
      object dbgItensPREVISAOCONCLUSAO: TdxDBGridDateColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 97
        BandIndex = 0
      ...
      object dbgItensDATAENTREGA: TdxDBGridDateColumn
        HeaderAlignment = taCenter
        Visible = False
        Width = 61
        BandIndex = 0
      ...
      object dbgItensTIPO: TdxDBGridMaskColumn
        Caption = 'Tipo'
        HeaderAlignment = taCenter
        Visible = False
        Width = 81
      ...
      object dbgItensURGENTE: TdxDBGridCheckColumn
        Caption = 'Urgente'
        HeaderAlignment = taCenter
        Width = 48
        BandIndex = 0
    ...
    object dfQtdeProd: TTS_DBEditNumber
      Left = 92
      Top = 234
      Width = 86
      Color = 14019327
    ...
    object cmbStatus: TTS_LookupComboBox
      ...
      KeyFieldName = 'STATUS'
      ListSource = C_StatusDS
      LookupKeyValue = Null
      Height = 19
    end
    object cmbOperador: TTS_LookupComboBox
      Left = 253
      Top = 7
      Width = 137
      TabOrder = 2
      ...
      ClearKey = 32
      ListFieldName = 'NOME'
      KeyFieldName = 'OPERADOR'
      ListSource = C_OperadoresDS
      LookupKeyValue = Null
      Height = 19
    end
    object clbTabelaPreco: TTS_CheckListBox
      Left = 463
      Top = 243
      Width = 174
      Height = 147
  ...
  object Q_MontagensDS: TDataSource
    DataSet = C_Montagens
    Left = 468
    Top = 138
  end
  object Q_Montagens: TIBQuery
    Database = DMProjeto.DB_Projeto
    Transaction = DMProjeto.IBT_Projeto
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select m.*, i.codigo, i.descricao from montagens m, itens i'
      'where m.item = i.item and m.status = :status and m.tipo = :tipo'
      'and (:bOper = 1 or m.montador = :operador)'
      'order by m.urgente desc, m.data , m.montagem ')
    UpdateObject = U_Montagens
    Left = 467
    Top = 91
    ParamData = <
      item
  ...
  object P_Montagens: TDataSetProvider
    DataSet = Q_Montagens
    Constraints = True
    Left = 468
    Top = 186
  end
  object C_Montagens: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'P_Montagens'
    BeforeScroll = C_MontagensBeforeScroll
    AfterScroll = C_MontagensAfterScroll
    OnCalcFields = C_MontagensCalcFields
    Left = 470
    Top = 242
    object C_MontagensMONTAGEM: TIntegerField
      FieldName = 'MONTAGEM'
      Origin = 'MONTAGENS.MONTAGEM'
      Required = True
    end
    object C_MontagensDATA: TDateField
      FieldName = 'DATA'
      Origin = 'MONTAGENS.DATA'
    end
    object C_MontagensMONTADOR: TIntegerField
      FieldName = 'MONTADOR'
      Origin = 'MONTAGENS.MONTADOR'
    end
    object C_MontagensITEM: TIntegerField
      FieldName = 'ITEM'
      Origin = 'MONTAGENS.ITEM'
    end
    object C_MontagensQTDESOLIC: TBCDField
      FieldName = 'QTDESOLIC'
    ...
    object C_MontagensOBS: TStringField
      FieldName = 'OBS'
      Origin = 'MONTAGENS.OBS'
      Size = 255
    end
    object C_MontagensDATACONCLUSAO: TDateField
      FieldName = 'DATACONCLUSAO'
      Origin = 'MONTAGENS.DATACONCLUSAO'
    end
    object C_MontagensHORACONCLUSAO: TStringField
      FieldName = 'HORACONCLUSAO'
      Origin = 'MONTAGENS.HORACONCLUSAO'
      Size = 5
    end
    object C_MontagensPREVISAOCONCLUSAO: TDateField
      FieldName = 'PREVISAOCONCLUSAO'
      Origin = 'MONTAGENS.PREVISAOCONCLUSAO'
    end
    object C_MontagensDATAENTREGA: TDateField
      FieldName = 'DATAENTREGA'
      Origin = 'MONTAGENS.DATAENTREGA'
    end
    object C_MontagensTIPO: TStringField
      FieldName = 'TIPO'
      Origin = 'MONTAGENS.TIPO'
      Size = 1
    end
    object C_MontagensURGENTE: TStringField
      FieldName = 'URGENTE'
      Origin = 'MONTAGENS.URGENTE'
      Size = 1
    end
    object C_MontagensDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'ITENS.DESCRICAO'
      Size = 50
    end
    object C_MontagensDescTipo: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'DescTipo'
    end
    object C_MontagenslkOperador: TStringField
      FieldKind = fkLookup
    ...
    object C_MontagensQ_MontagensFilhos: TDataSetField
      FieldName = 'Q_MontagensFilhos'
    end
    object C_MontagensNUMERO: TStringField
      FieldName = 'NUMERO'
      Origin = 'MONTAGENS.NUMERO'
      Size = 10
    end
    object C_MontagensUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Origin = 'MONTAGENS.UNIDADE'
      Size = 6
    end
    object C_MontagensCODIGO: TStringField
      FieldName = 'CODIGO'
      Origin = 'ITENS.CODIGO'
      Size = 14
    end
  ...
  object C_MontagensFilhos: TClientDataSet
    Aggregates = <>
    DataSetField = C_MontagensQ_MontagensFilhos
    Params = <>
    Left = 354
    Top = 96
  ...
  object Q_MontagensFilhos: TIBQuery
    ...
    SQL.Strings = (
      'select mi.*, i.codigo, i.descricao, f.descricao as fabricante'
      'from montagensfilhos mi inner join itens i on mi.item = i.item'
  ...
  object C_OperadoresDS: TDataSource
    DataSet = C_Operadores
    Left = 217
    Top = 249
  end
  ...
  object P_MontagensFilho: TDataSetProvider
    DataSet = Q_MontagensFilhos
    Constraints = True
    Left = 354
    Top = 188
  end
