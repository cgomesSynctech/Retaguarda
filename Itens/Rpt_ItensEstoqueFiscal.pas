...
type
  TRptItensEstoqueFiscal = class(TRptPadrao)
    ...
    dbgConsultaDifierenca: TdxDBGridColumn;
    C_ConsultaESTOQUEFISCAL: TBCDField;
    dbgConsultaESTOQUEFISCAL: TdxDBGridColumn;
...
var
  RptItensEstoqueFiscal: TRptItensEstoqueFiscal;
...
procedure TRptItensEstoqueFiscal.AtualizaItens(WhereAdicional:string ='');
...
begin
  ...
  if cmbAlmox.LookupKeyValue <> null then begin
...
procedure TRptItensEstoqueFiscal.btAtualizarClick(Sender: TObject);
begin
  inherited;
  AtualizaItens;
end;

procedure TRptItensEstoqueFiscal.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  Action := caFree;
end;

procedure TRptItensEstoqueFiscal.Coluna(coluna: TdxTreeListColumn; Habilita: boolean);
begin
  coluna.DisableCustomizing := not Habilita;
  coluna.Visible := Habilita;
end;

procedure TRptItensEstoqueFiscal.dbgConsultaDblClick(Sender: TObject);
var
   nItem : Integer;
   sForm : String;
begin
...
procedure TRptItensEstoqueFiscal.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
  C_Indexadores.Close;
  C_Indexadores.Open;
  if DMProjeto.Parametro('MultiAlmox') = 'S' then begin
...
procedure TRptItensEstoqueFiscal.PopupFiltroItensSelecionou(
  Sender: TObject);
begin
  inherited;
	AtualizaItens;
...
procedure TRptItensEstoqueFiscal.cmbAlmoxChange(Sender: TObject);
begin
  inherited;
	AtualizaItens;
end;

procedure TRptItensEstoqueFiscal.C_ConsultaCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TRptItensEstoqueFiscal.cmbIndexSelectionChange(Sender: TObject);
begin
  inherited;
  AtualizaItens;
end;
