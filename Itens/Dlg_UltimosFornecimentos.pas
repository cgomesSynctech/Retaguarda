...
type
  TDlgUltimosFornecimentos = class(TFrmModeloCadastros)
    ...
    C_FornecCUSTOMANUAL: TBCDField;
    C_FornecCUSTOCOMPRA: TFloatField;
    dbgFornecColumn15: TdxDBGridDateColumn;
    dbgFornecColumn16: TdxDBGridMaskColumn;
    dbgFornecTAXAVEL: TdxDBGridMaskColumn;
    dbgFornecColumn18: TdxDBGridMaskColumn;
    dbgFornecColumn19: TdxDBGridMaskColumn;
    dbgFornecColumn20: TdxDBGridMaskColumn;
    dbgFornecUNIDADE: TdxDBGridMaskColumn;
    dbgFornecColumn22: TdxDBGridColumn;
    dbgFornecColumn23: TdxDBGridMaskColumn;
    dbgFornecTIPOMOVIMENTO: TdxDBGridMaskColumn;
    dbgFornecEMPRESA: TdxDBGridMaskColumn;
    dbgFornecPDV: TdxDBGridMaskColumn;
    dbgFornecOBS: TdxDBGridMaskColumn;
    dbgFornecTAX: TdxDBGridMaskColumn;
    dbgFornecPERCENTUALTAX: TdxDBGridCurrencyColumn;
    dbgFornecColumn30: TdxDBGridCurrencyColumn;
    dbgFornecPLANOPAGAMENTO: TdxDBGridMaskColumn;
    dbgFornecFRETE: TdxDBGridCurrencyColumn;
    dbgFornecTOTAL: TdxDBGridMaskColumn;
    dbgFornecTIPOENTREGA: TdxDBGridMaskColumn;
    dbgFornecDATAENTREGA: TdxDBGridDateColumn;
    dbgFornecIMPORTACAO: TdxDBGridMaskColumn;
    dbgFornecSITUACAO: TdxDBGridMaskColumn;
    dbgFornecPREVISAOENTREGA: TdxDBGridDateColumn;
    dbgFornecTIPOMOVIMENTO1: TdxDBGridMaskColumn;
    dbgFornecTIPOPADRAO: TdxDBGridMaskColumn;
    dbgFornecDATACANCELAMENTO: TdxDBGridDateColumn;
    dbgFornecFUNCCANCELAMENTO: TdxDBGridMaskColumn;
    dbgFornecMOTIVOCANCELAMENTO: TdxDBGridMaskColumn;
    dbgFornecBAIXAESTOQUE: TdxDBGridMaskColumn;
    dbgFornecSTATUS: TdxDBGridMaskColumn;
    dbgFornecIMPOSTO: TdxDBGridMaskColumn;
    dbgFornecTOTALITENS: TdxDBGridMaskColumn;
    dbgFornecOUTRASDESPESAS: TdxDBGridMaskColumn;
    dbgFornecJUROS: TdxDBGridMaskColumn;
    dbgFornecCAMPO01: TdxDBGridMaskColumn;
    dbgFornecCAMPO02: TdxDBGridMaskColumn;
    dbgFornecCAMPO03: TdxDBGridMaskColumn;
    dbgFornecCAMPO04: TdxDBGridMaskColumn;
    dbgFornecPJUROS: TdxDBGridMaskColumn;
    dbgFornecPOSSUITAX: TdxDBGridMaskColumn;
    dbgFornecCALCCOMISSAO: TdxDBGridMaskColumn;
    dbgFornecPOSSUIENTREGA: TdxDBGridMaskColumn;
    dbgFornecTOTALITENS123: TdxDBGridMaskColumn;
    dbgFornecDESCONTOITENS: TdxDBGridMaskColumn;
    dbgFornecLOCALENTREGA: TdxDBGridMaskColumn;
    dbgFornecLOCALCLIENTE: TdxDBGridMaskColumn;
    dbgFornecINCLUIDESCONTO: TdxDBGridMaskColumn;
    dbgFornecATUALIZACUSTO: TdxDBGridMaskColumn;
    dbgFornecATUALIZAPRECO: TdxDBGridMaskColumn;
    dbgFornecATUALIZAPRECOMANUAL: TdxDBGridMaskColumn;
    dbgFornecSTATUSANTERIOR: TdxDBGridMaskColumn;
    dbgFornecUSUARIO: TdxDBGridMaskColumn;
    dbgFornecTOTALPGTOS: TdxDBGridMaskColumn;
    dbgFornecBASEIMPOSTO: TdxDBGridMaskColumn;
    dbgFornecBASEINCLUSO: TdxDBGridMaskColumn;
    dbgFornecIMPOSTO_INCLUSO: TdxDBGridMaskColumn;
    dbgFornecREDUCOESBASE: TdxDBGridMaskColumn;
    dbgFornecACRESCIMOSBASE: TdxDBGridMaskColumn;
    dbgFornecVOLUMES: TdxDBGridMaskColumn;
    dbgFornecALMOXPADRAO: TdxDBGridMaskColumn;
    dbgFornecUFORIGEM: TdxDBGridMaskColumn;
    dbgFornecCFOPNOTA: TdxDBGridMaskColumn;
    dbgFornecCFOPENTRADA: TdxDBGridMaskColumn;
    dbgFornecSERIENOTA: TdxDBGridMaskColumn;
    dbgFornecVALORSEGURO: TdxDBGridMaskColumn;
    dbgFornecBASECALCICMS: TdxDBGridMaskColumn;
    dbgFornecVALORICMS: TdxDBGridMaskColumn;
    dbgFornecBASECALCSUBST: TdxDBGridMaskColumn;
    dbgFornecVALORICMSSUBST: TdxDBGridMaskColumn;
    dbgFornecVALORIPI: TdxDBGridMaskColumn;
    dbgFornecPESOBRUTO: TdxDBGridMaskColumn;
    dbgFornecPESOLIQUIDO: TdxDBGridMaskColumn;
    dbgFornecALIQICMSCOMPRA: TdxDBGridCurrencyColumn;
    dbgFornecFRETEINCLUSO: TdxDBGridMaskColumn;
    dbgFornecVALORISENTAS: TdxDBGridMaskColumn;
    dbgFornecCONSIDERARDESCONTO: TdxDBGridMaskColumn;
    dbgFornecMODELO: TdxDBGridMaskColumn;
    dbgFornecVALOROUTRASICMS: TdxDBGridMaskColumn;
    dbgFornecVALORISENTASIPI: TdxDBGridMaskColumn;
    dbgFornecVALOROUTRASIPI: TdxDBGridMaskColumn;
    dbgFornecPOSSUIICMS: TdxDBGridMaskColumn;
    dbgFornecCONTABILIZAICMS: TdxDBGridMaskColumn;
    dbgFornecCIF_FOB: TdxDBGridMaskColumn;
    dbgFornecPOSSUIIPI: TdxDBGridMaskColumn;
    dbgFornecDATANOTA: TdxDBGridDateColumn;
    dbgFornecIMPRESSO: TdxDBGridMaskColumn;
    dbgFornecNOTAORIGEM: TdxDBGridMaskColumn;
    dbgFornecTRANSPORTADORA: TdxDBGridMaskColumn;
    dbgFornecPLACAVEIC: TdxDBGridMaskColumn;
    dbgFornecVENDEDOR: TdxDBGridMaskColumn;
    dbgFornecDESCESPECIE: TdxDBGridMaskColumn;
    dbgFornecDESCMARCA: TdxDBGridMaskColumn;
    dbgFornecDESCNUMERO: TdxDBGridMaskColumn;
    dbgFornecFRETEEXTERNO: TdxDBGridCurrencyColumn;
    dbgFornecINDEXADOR: TdxDBGridMaskColumn;
    dbgFornecFONTE: TdxDBGridMaskColumn;
    dbgFornecBAIXAESTOQUEFISCAL: TdxDBGridMaskColumn;
    dbgFornecESPECIE: TdxDBGridMaskColumn;
    dbgFornecHORA: TdxDBGridTimeColumn;
    dbgFornecDETALHEIMPORTACAO: TdxDBGridMaskColumn;
    dbgFornecCHAVENFE: TdxDBGridMaskColumn;
    dbgFornecRATEAROUTRASDESPESAS: TdxDBGridMaskColumn;
    dbgFornecORIGEMREPLIC: TdxDBGridMaskColumn;
    dbgFornecEMPRESA1: TdxDBGridMaskColumn;
    dbgFornecENTRADA1: TdxDBGridMaskColumn;
    dbgFornecENTRADAITEM: TdxDBGridMaskColumn;
    dbgFornecPDV1: TdxDBGridMaskColumn;
    dbgFornecSEQUENCIA: TdxDBGridMaskColumn;
    dbgFornecITEM: TdxDBGridMaskColumn;
    dbgFornecDESCRICAO1: TdxDBGridMaskColumn;
    dbgFornecColumn126: TdxDBGridMaskColumn;
    dbgFornecColumn127: TdxDBGridMaskColumn;
    dbgFornecIMPORTACAO1: TdxDBGridMaskColumn;
    dbgFornecUSOTIPOITEM: TdxDBGridMaskColumn;
    dbgFornecCUSTOMEDIO: TdxDBGridMaskColumn;
    dbgFornecSITUACAO1: TdxDBGridMaskColumn;
    dbgFornecSUBTOTALITEM: TdxDBGridMaskColumn;
    dbgFornecQTDRECEBIDA: TdxDBGridCurrencyColumn;
    dbgFornecHASCHILDREN: TdxDBGridMaskColumn;
    dbgFornecORDEM: TdxDBGridMaskColumn;
    dbgFornecCOLUNA1: TdxDBGridMaskColumn;
    dbgFornecCOLUNA2: TdxDBGridMaskColumn;
    dbgFornecCOLUNA3: TdxDBGridMaskColumn;
    dbgFornecCOLUNA4: TdxDBGridMaskColumn;
    dbgFornecCLIENTEREF: TdxDBGridMaskColumn;
    dbgFornecREFERENCIA: TdxDBGridMaskColumn;
    dbgFornecSAIDAITEM: TdxDBGridMaskColumn;
    dbgFornecNAOCOBRAR: TdxDBGridMaskColumn;
    dbgFornecCUSTOCONTABIL: TdxDBGridMaskColumn;
    dbgFornecRATEIODESCONTO: TdxDBGridMaskColumn;
    dbgFornecCUSTOMEDIO_ANT: TdxDBGridMaskColumn;
    dbgFornecCUSTOCONTABIL_ANT: TdxDBGridMaskColumn;
    dbgFornecSEMLUCRO: TdxDBGridMaskColumn;
    dbgFornecLUCRO: TdxDBGridMaskColumn;
    dbgFornecINDICELUCRO: TdxDBGridMaskColumn;
    dbgFornecNOVOPRECO: TdxDBGridMaskColumn;
    dbgFornecANALISADO: TdxDBGridMaskColumn;
    dbgFornecATUALIZOUCUSTO: TdxDBGridMaskColumn;
    dbgFornecATUALIZOUPRECO: TdxDBGridMaskColumn;
    dbgFornecFRETEPROPORCIONAL: TdxDBGridMaskColumn;
    dbgFornecMESCLADO: TdxDBGridMaskColumn;
    dbgFornecSTATUS1: TdxDBGridMaskColumn;
    dbgFornecCODIGOFORN: TdxDBGridMaskColumn;
    dbgFornecNUMEROLOTE: TdxDBGridMaskColumn;
    dbgFornecVALIDADE: TdxDBGridDateColumn;
    dbgFornecVENDEDOR1: TdxDBGridMaskColumn;
    dbgFornecFATOR: TdxDBGridMaskColumn;
    dbgFornecESTOQUE_ANT: TdxDBGridCurrencyColumn;
    dbgFornecBAIXAESTOQUE1: TdxDBGridMaskColumn;
    dbgFornecALMOXARIFADO: TdxDBGridMaskColumn;
    dbgFornecBASECALCICMSPROD: TdxDBGridMaskColumn;
    dbgFornecIPI: TdxDBGridMaskColumn;
    dbgFornecALIQICMS: TdxDBGridMaskColumn;
    dbgFornecCST: TdxDBGridMaskColumn;
    dbgFornecREDUCAOCST: TdxDBGridMaskColumn;
    dbgFornecCFOPENTRADA1: TdxDBGridMaskColumn;
    dbgFornecDESCONTO1: TdxDBGridMaskColumn;
    dbgFornecBASECALCSUBSTPROD: TdxDBGridMaskColumn;
    dbgFornecVALORIPIPROD: TdxDBGridMaskColumn;
    dbgFornecTVA: TdxDBGridMaskColumn;
    dbgFornecSITUACAOECF: TdxDBGridMaskColumn;
    dbgFornecVALORICMSPROD: TdxDBGridMaskColumn;
    dbgFornecVALORISENTASPROD: TdxDBGridMaskColumn;
    dbgFornecVALORICMSSUBSTPROD: TdxDBGridMaskColumn;
    dbgFornecQTDDEVOLVIDO: TdxDBGridMaskColumn;
    dbgFornecQTDACERTADO: TdxDBGridMaskColumn;
    dbgFornecPDESCONTO: TdxDBGridMaskColumn;
    dbgFornecCOMPENSACAOCUSTO: TdxDBGridMaskColumn;
    dbgFornecCFOPCST: TdxDBGridMaskColumn;
    dbgFornecFATORPRECO: TdxDBGridMaskColumn;
    dbgFornecPRECOVENDA: TdxDBGridCurrencyColumn;
    dbgFornecBAIXAESTOQUEFISCAL1: TdxDBGridMaskColumn;
    dbgFornecIDTRIBFEDERAL: TdxDBGridMaskColumn;
    dbgFornecQUANTIDADEVOLUME: TdxDBGridMaskColumn;
    dbgFornecCSTPISCOFINS: TdxDBGridMaskColumn;
    dbgFornecALIQPIS: TdxDBGridMaskColumn;
    dbgFornecALIQCOFINS: TdxDBGridMaskColumn;
    dbgFornecVALORPISPROD: TdxDBGridMaskColumn;
    dbgFornecVALORCOFINSPROD: TdxDBGridMaskColumn;
    dbgFornecCSTIPI: TdxDBGridMaskColumn;
    dbgFornecALIQIPI: TdxDBGridMaskColumn;
    dbgFornecFABRICACAO: TdxDBGridDateColumn;
    dbgFornecV_BCII: TdxDBGridMaskColumn;
    dbgFornecV_DESPADUII: TdxDBGridMaskColumn;
    dbgFornecV_II: TdxDBGridMaskColumn;
    dbgFornecV_IOFII: TdxDBGridMaskColumn;
    dbgFornecRATEIODESPESAS: TdxDBGridMaskColumn;
    dbgFornecRATEIOFRETE: TdxDBGridMaskColumn;
    dbgFornecFRETE1: TdxDBGridMaskColumn;
    dbgFornecSEGURO: TdxDBGridMaskColumn;
    dbgFornecOUTRASDESPESAS1: TdxDBGridMaskColumn;
    dbgFornecRATEIOSEGURO: TdxDBGridMaskColumn;
    dbgFornecORIGEMREPLIC1: TdxDBGridMaskColumn;
    dbgFornecColumn209: TdxDBGridColumn;
    dbgFornecCUSTOMANUAL: TdxDBGridCurrencyColumn;
    dbgFornecCUSTOCOMPRA: TdxDBGridMaskColumn;
