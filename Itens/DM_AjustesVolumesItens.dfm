inherited DMAjustesVolumesItens: TDMAjustesVolumesItens
  Left = 374
  Top = 102
  Height = 365
  Width = 412
  ...
  inherited Q_Tabela: TIBQuery
    ...
    SQL.Strings = (
        ...
        'presa, i.ultimofornecedor, i.fornecpreferencia, ai.QUANTIDADEVOL' +
        'UME '
  ...
  inherited U_Tabela: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      ' QUANTIDADEVOLUME =:QUANTIDADE '
      'where'
      '  AJUSTEITEM = :OLD_IDMESTRE')
    InsertSQL.Strings = (
      'insert into AjustesItens'
      '  (AJUSTEITEM, ITEM, NUMERO, DATA, CUSTO, CONTA, '
      'MOTIVO, NUMEROLOTE, VALIDADE, UNIDADE, FATOR, ALMOXARIFADO, '
      'QUANTIDADEVOLUME )'
      'values'
      '  (:IDMESTRE, :ITEM, :NUMERO, :DATA,:CUSTO, :CONTA, '
  ...
  inherited DMComponent: TDMComponent
    ...
    KeyForIDs = 'AjustesItens'
    Tabela_Nome = 'AjustesItens'
  ...
  inherited C_Tabela: TClientDataSet
    ...
    object C_TabelaQUANTIDADEVOLUME: TBCDField
