inherited RptItensEstoque: TRptItensEstoque
  ...
  inherited pnGrid: TPanel
    ...
    inherited pnDados: TTS_Panel
      ...
      object Button1: TButton
        ...
        Width = 193
        Height = 20
        Caption = 'Atualizar Custo M'#233'dio Composi'#231#227'o '
        TabOrder = 4
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      SummaryGroups = <
        item
          ...
          SummaryItems = <
            ...
            item
              SummaryField = 'ESTOQUEALMOX'
              SummaryFormat = '>ESTOQUEALMOX=#,###,##0.00'
              SummaryType = cstSum
            end
            item
              SummaryField = 'icPreco'
              SummaryFormat = '>icPreco=#,###,##0.00'
              SummaryType = cstSum
            end>
          Name = 'Default'
        end>
      ...
      object dbgConsultaESTOQUEVOLUME: TdxDBGridMaskColumn
        Caption = 'Qtd. Volume'
        HeaderAlignment = taCenter
        Width = 37
        BandIndex = 0
      ...
      object dbgConsultaDESCGRUPOPAI: TdxDBGridColumn
        Caption = 'Grupo Pai'
        HeaderAlignment = taCenter
        Width = 107
        BandIndex = 0
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'CUSTOMEDIO, I.ESTOQUE AS ESTOQUE, I.REFERENCIA,  '
        ...
        'l.descricao as Localizacao,  tf.descricao as TributacaoFederal, ' +
        'I.ESTOQUEVOLUME, gp.descricaogrupo as DescGrupoPai, i.custoconta' +
        'bil,'
      'i.cstpiscofins, i.cstipi, i.cstpiscofinssaida'
      'From itens i'
