...
type
  TDlgAlteraStatusCheqPago = class(TFrmModeloCadastros)
    TS_Label1: TTS_Label;
    TS_Label2: TTS_Label;
    TS_Label3: TTS_Label;
...
var
  DlgAlteraStatusCheqPago: TDlgAlteraStatusCheqPago;
...
procedure TDlgAlteraStatusCheqPago.FormsComponentBeforeClearParams(
  Sender: TObject);
begin
  inherited;
...
procedure TDlgAlteraStatusCheqPago.btGravarClick(Sender: TObject);
var i : integer;
begin
  inherited;
