inherited DlgRecebimentoLight: TDlgRecebimentoLight
  Left = 192
  Top = 119
  Width = 495
  Height = 339
  ...
  inherited pnDados: TTS_Panel
    ...
    object cmbBanco: TTS_LookupComboBox
      Left = 121
      Top = 237
      Width = 213
      TabOrder = 6
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbEstadoForm: TTS_Label
      Width = 153
      Caption = 'Quita'#231#227'o de parcelas em aberto'
    end
  ...
  object Q_FormasPagamento: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select formapagamento, especie, descricao, contaliberacao '
      'from FORMASPAGAMENTO'
      'where not especie IN (6,7,40,50)')
    Left = 232
    Top = 200
    ...
    object Q_FormasPagamentoCONTALIBERACAO: TIntegerField
      FieldName = 'CONTALIBERACAO'
      Origin = 'FORMASPAGAMENTO.CONTALIBERACAO'
    end
  end
