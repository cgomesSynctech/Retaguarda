inherited RptPagamentosComTEF: TRptPagamentosComTEF
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select  f.Nome, t.Data, t.ID, f_abs(t.Valor) as Valor, t.favorec' +
        'ido, f.tipofavorecido, c.Descricao as DescConta, t.historico, t.' +
        'idgerador, t.tipooperacao, f.codigo'
      'From Transacoes t '
