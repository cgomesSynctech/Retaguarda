inherited RptChequesDevolvidos: TRptChequesDevolvidos
  Left = 91
  Top = 135
  Width = 762
  Caption = 'Financeiro'
  ...
  inherited pnTitulo: TTS_MaxPanel
    ...
    inherited lbCaption: TdxfLabel
      Width = 308
      Caption = 'Cheques Devolvidos Atualmente'
    end
  ...
  inherited pnGrid: TPanel
    ...
    inherited dbgConsulta: TTS_QDBGrid
      ...
      object dbgConsultaDIASPENDENTES: TdxDBGridMaskColumn
        Alignment = taCenter
        DisableEditor = True
  ...
  inherited Q_Consulta: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select dd.IDDoc, dd.Vencimento, dd.Valor, f.Nome, dd.NumCheque, ' +
        '           b.Nome as NomeBanco, d.Favorecido, f.TipoFavorecido,'
      
        '           (Current_Date-dd.Vencimento) as DiasPendentes, f.codi' +
        'go,'
      
        '           f.Endereco, f.Cidade, f.UF, f.fone1, f.fax, f.cep, f.' +
        'email,                       f.CaixaPostal, f.celular, f.fone2'
  ...
  inherited C_Consulta: TClientDataSet
    ...
    object C_ConsultaDIASPENDENTES: TIntegerField
      DisplayLabel = 'Dias Pendentes'
      FieldName = 'DIASPENDENTES'
    end
