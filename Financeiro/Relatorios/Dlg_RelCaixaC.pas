...
type
  TDlgRelCaixaC = class(TFrmModeloCadastros)
...
procedure TDlgRelCaixaC.Q_DisponivelCalcFields(DataSet: TDataSet);
begin
  inherited;
  Q_DisponivelSaldo.Value := Q_DisponivelSaldoAnterior.Value + Q_DisponivelRepasse.Value + Q_DisponivelEntradas.Value;
end;

procedure TDlgRelCaixaC.btGravarClick(Sender: TObject);
begin
  inherited;
  Barra.Position := 0;
  Barra.Visible  := true;
...
procedure TDlgRelCaixaC.Q_ResumoPreCalcFields(DataSet: TDataSet);
begin
  inherited;
//	Q_ResumoPreSaldo.Value := Q_ResumoPreSaldoAnterior.Value + Q_ResumoPreEntradas.Value - Q_ResumoPrePagamentos.Value;
end;

procedure TDlgRelCaixaC.Q_OutrosDocFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDlgRelCaixaC.ppDBText27GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  if Text = '' then
...
procedure TDlgRelCaixaC.Q_DisponivelFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  inherited;
...
procedure TDlgRelCaixaC.dbSaldoAntGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  if text = '' then
...
procedure TDlgRelCaixaC.ppDBText7DrawCommandClick(Sender,
...
procedure TDlgRelCaixaC.ppDBText7DrawCommandCreate(Sender,
  aDrawCommand: TObject);
begin
  inherited;
...
procedure TDlgRelCaixaC.ppDBText20DrawCommandClick(Sender,
  aDrawCommand: TObject);
begin
  inherited;
  if TppDrawCommand(aDrawCommand).Tag <> 0 then begin
...
procedure TDlgRelCaixaC.ppDBText20DrawCommandCreate(Sender,
  aDrawCommand: TObject);
begin
  inherited;
...
procedure TDlgRelCaixaC.ppDBText15DrawCommandCreate(Sender,
  aDrawCommand: TObject);
begin
  inherited;
...
procedure TDlgRelCaixaC.ppDBText13DrawCommandClick(Sender,
  aDrawCommand: TObject);
begin
  inherited;
  if TppDrawCommand(aDrawCommand).Tag <> 0 then begin
...
procedure TDlgRelCaixaC.FormsComponentRefresh(Sender: TObject);
begin
  inherited;
...
procedure TDlgRelCaixaC.FormsComponentBeforeClearParams(Sender: TObject);
begin
  inherited;
  C_Caixas.Open;
...
procedure TDlgRelCaixaC.FormCreate(Sender: TObject);
begin
  inherited;
