...
procedure TFrmEntradasAssistencia.btReimprimirClick(Sender: TObject);
begin
      RptTecnica := TRptTecnica.Create(Self);
      RptTecnica.ImprimirComprovanteEntrega( DMEntradasAssistencia.C_TabelaSERVICO.AsInteger );
      RptTecnica.Release;
      RptTecnica := nil;
end;
...
//  and                        DMEntradasAssistencia.bAlteracao;
  ...
  btComando12.visible := DMEntradasAssistencia.C_TabelaSTATUSSERVICO.AsInteger = 60 ;
