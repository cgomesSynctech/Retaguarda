...
type
  TDMEntradasMecanica = class(TDMManutencao)
...
var
  DMEntradasMecanica: TDMEntradasMecanica;

implementation

uses DM_Projeto, Funcoes, Frm_EntradasMecanica;

{$R *.dfm}

Procedure TDMEntradasMecanica.AtualizaAcessorios;
Begin
...
procedure TDMEntradasMecanica.GerarSerial;
Begin
  if not(C_Tabela.State in [dsEdit,dsInsert]) then
    C_Tabela.Edit;
...
Procedure TDMEntradasMecanica.PegarOSNumero;
Begin
...
procedure TDMEntradasMecanica.C_TabelaNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TDMEntradasMecanica.DataModuleCreate(Sender: TObject);
begin
  inherited;
  DMEntradasMecanica:=Self;
end;

procedure TDMEntradasMecanica.C_ServicosDetCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TDMEntradasMecanica.DMComponentGravar1_Iniciar(
...
procedure TDMEntradasMecanica.DMComponentPesquisar1_Iniciar(
...
procedure TDMEntradasMecanica.DMComponentModoInclusao1_Iniciar(
  Sender: TObject);
begin
  inherited;
  C_Equip.Close;
...
procedure TDMEntradasMecanica.DMComponentPesquisar4_Dados(
  Sender: TObject);
begin
  inherited;
  C_Equip.Close;
