inherited dlgAcompanhamentoAssistencia: TdlgAcompanhamentoAssistencia
  ...
  inherited pnDados: TTS_Panel
    ...
    object qdbServicos: TTS_QDBGrid
      ...
      object qdbServicosLOCAL: TdxDBGridMaskColumn
      ...
      object qdbServicosVALOR: TdxDBGridMaskColumn
        Visible = False
        Width = 57
        BandIndex = 0
        RowIndex = 0
      ...
      object qdbServicosNOMECLIENTE: TdxDBGridMaskColumn
        Caption = 'Cliente'
        Width = 304
        BandIndex = 0
        RowIndex = 0
  ...
  object Q_Assistencia: TIBQuery
    ...
    SQL.Strings = (
        ...
        'ss.descricao as Status, fa.nome as Tecnico, fav.nome as TecnicoO' +
        'rcamento, s.localizacao,'
      ...
      ' m.descricao as desc_modelo, FC.nome AS NomeCliente'
      'from servicos s'
      ...
      '  left join favorecidos fC on s.cliente = fC.favorecido'
  ...
  object C_Assistencia: TClientDataSet
    ...
    object C_AssistenciaNOMECLIENTE: TStringField
      FieldName = 'NOMECLIENTE'
      Size = 50
    end
  end
