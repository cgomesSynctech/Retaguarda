...
uses
    ...
    Placemnt, TS_Label, teIntrlc, Printers, dxEdLib, TS_CheckBox, CheckLst,
    TS_CheckListBox, TS_PopupEdit, dxEditor, TS_ButtonEdit, TS_EditFavorecido,
    TS_Edit;
...
type
    TRptConsultaOS = class(TFormPadrao)
        Q_Consulta: TIBQuery;
        ...
        TS_Label3: TTS_Label;
        ppeTipoEquipamento: TTS_PopupEdit;
        Q_TiposEquipamento: TIBQuery;
        P_TiposEquipamento: TDataSetProvider;
        C_TiposEquipamento: TClientDataSet;
        C_TiposEquipamentoDS: TDataSource;
        C_TiposEquipamentoTIPOEQUIPAMENTO: TIntegerField;
        C_TiposEquipamentoDESCEQUIPAMENTO: TStringField;
        clbTipoEquipamento: TTS_CheckListBox;
        TS_Label2: TTS_Label;
        ...
        C_StatusSTATUSSERVICO: TIntegerField;
        C_StatusDESCRICAO: TStringField;
        TS_Label4: TTS_Label;
        dfNOS: TTS_Edit;
    C_ConsultaATENDENTE: TStringField;
    C_ConsultaSERVICO: TIntegerField;
    C_ConsultaOSNUMERO: TStringField;
    ...
    C_ConsultaPARTESAGRAGADAS: TStringField;
    C_ConsultaDEFEITOALEGADO: TStringField;
    C_ConsultaDEFEITOENCONTRADO: TStringField;
    C_ConsultaOBSERVACAO: TStringField;
    C_ConsultaDATASAIDA: TDateField;
    C_ConsultaHORASAIDA: TTimeField;
    C_ConsultaFUNCENTRADA: TIntegerField;
    C_ConsultaTECNICO: TIntegerField;
    C_ConsultaFUNCSAIDA: TIntegerField;
    C_ConsultaSTATUSSERVICO: TIntegerField;
    C_ConsultaLOCALIZACAO: TIntegerField;
    C_ConsultaTIPOSERVICO: TIntegerField;
    C_ConsultaAVARIA: TStringField;
    C_ConsultaCOMACESSORIO: TStringField;
    C_ConsultaCOMACESSORIOOBS: TStringField;
    C_ConsultaESTADOPRODMANCHADO: TStringField;
    C_ConsultaESTADOPRODARRANHADO: TStringField;
    C_ConsultaESTADOPRODSUJO: TStringField;
    C_ConsultaESTADOPRODCABOELETRICO: TStringField;
    C_ConsultaESTADOPRODQUEBRADO: TStringField;
    C_ConsultaEMBALAGEMPAPELAO: TStringField;
    C_ConsultaEMBALAGEMPLASTICO: TStringField;
    C_ConsultaGARANTIAFABRICA: TStringField;
    C_ConsultaFORAGARANTIA: TStringField;
    C_ConsultaRETORNO: TStringField;
    C_ConsultaORCAMENTOACEITO: TStringField;
    C_ConsultaORCAMENTOCOMUNICADO: TStringField;
    C_ConsultaSEMEMBALAGEM: TStringField;
    C_ConsultaOBSAVARIA: TStringField;
    C_ConsultaNUMEROSERIE: TStringField;
    C_ConsultaMODELO: TIntegerField;
    C_ConsultaDATACOMPRA: TDateField;
    C_ConsultaDIASGARANTIA: TIntegerField;
    C_ConsultaNOTAFISCAL: TStringField;
    C_ConsultaREVENDEDOR: TStringField;
    C_ConsultaCARACTERISTICA: TStringField;
    C_ConsultaNRO: TStringField;
    ...
    C_ConsultaDESCMODELO: TStringField;
    C_ConsultaDESCSTATUS: TStringField;
    C_ConsultaNOMETECNICO: TStringField;
    C_ConsultaDESCLOCAL: TStringField;
    C_ConsultaDESCTIPOSERV: TStringField;
    C_ConsultaDESCTIPOEQUIP: TStringField;
    C_ConsultaDESCMARCA: TStringField;
    C_ConsultaDESCFABRICANTE: TStringField;
    C_ConsultaOBSORCACEITO: TStringField;
    C_ConsultaOBSORCCOMUNICADO: TStringField;
    C_ConsultaDESCRICAO: TStringField;
    C_ConsultaCOR: TStringField;
    C_ConsultaTECNICODAOS: TStringField;
    dbgConsultaATENDENTE: TdxDBGridMaskColumn;
    dbgConsultaSERVICO: TdxDBGridMaskColumn;
    dbgConsultaOSNUMERO: TdxDBGridMaskColumn;
    ...
    dbgConsultaPARTESAGRAGADAS: TdxDBGridMaskColumn;
    dbgConsultaDEFEITOALEGADO: TdxDBGridMaskColumn;
    dbgConsultaDEFEITOENCONTRADO: TdxDBGridMaskColumn;
    dbgConsultaOBSERVACAO: TdxDBGridMaskColumn;
    dbgConsultaDATASAIDA: TdxDBGridDateColumn;
    dbgConsultaHORASAIDA: TdxDBGridTimeColumn;
    dbgConsultaFUNCENTRADA: TdxDBGridMaskColumn;
    dbgConsultaTECNICO: TdxDBGridMaskColumn;
    dbgConsultaFUNCSAIDA: TdxDBGridMaskColumn;
    dbgConsultaSTATUSSERVICO: TdxDBGridMaskColumn;
    dbgConsultaLOCALIZACAO: TdxDBGridMaskColumn;
    dbgConsultaTIPOSERVICO: TdxDBGridMaskColumn;
    dbgConsultaAVARIA: TdxDBGridMaskColumn;
    dbgConsultaCOMACESSORIO: TdxDBGridMaskColumn;
    dbgConsultaCOMACESSORIOOBS: TdxDBGridMaskColumn;
    dbgConsultaESTADOPRODMANCHADO: TdxDBGridMaskColumn;
    dbgConsultaESTADOPRODARRANHADO: TdxDBGridMaskColumn;
    dbgConsultaESTADOPRODSUJO: TdxDBGridMaskColumn;
    dbgConsultaESTADOPRODCABOELETRICO: TdxDBGridMaskColumn;
    dbgConsultaESTADOPRODQUEBRADO: TdxDBGridMaskColumn;
    dbgConsultaEMBALAGEMPAPELAO: TdxDBGridMaskColumn;
    dbgConsultaEMBALAGEMPLASTICO: TdxDBGridMaskColumn;
    dbgConsultaGARANTIAFABRICA: TdxDBGridMaskColumn;
    dbgConsultaFORAGARANTIA: TdxDBGridMaskColumn;
    dbgConsultaRETORNO: TdxDBGridMaskColumn;
    dbgConsultaORCAMENTOACEITO: TdxDBGridMaskColumn;
    dbgConsultaORCAMENTOCOMUNICADO: TdxDBGridMaskColumn;
    dbgConsultaSEMEMBALAGEM: TdxDBGridMaskColumn;
    dbgConsultaOBSAVARIA: TdxDBGridMaskColumn;
    dbgConsultaNUMEROSERIE: TdxDBGridMaskColumn;
    dbgConsultaMODELO: TdxDBGridMaskColumn;
    dbgConsultaDATACOMPRA: TdxDBGridDateColumn;
    dbgConsultaDIASGARANTIA: TdxDBGridMaskColumn;
    dbgConsultaNOTAFISCAL: TdxDBGridMaskColumn;
    dbgConsultaREVENDEDOR: TdxDBGridMaskColumn;
    dbgConsultaCARACTERISTICA: TdxDBGridMaskColumn;
    ...
    dbgConsultaDESCMODELO: TdxDBGridMaskColumn;
    dbgConsultaDESCSTATUS: TdxDBGridMaskColumn;
    dbgConsultaNOMETECNICO: TdxDBGridMaskColumn;
    dbgConsultaDESCLOCAL: TdxDBGridMaskColumn;
    dbgConsultaDESCTIPOSERV: TdxDBGridMaskColumn;
    dbgConsultaDESCTIPOEQUIP: TdxDBGridMaskColumn;
    dbgConsultaDESCMARCA: TdxDBGridMaskColumn;
    dbgConsultaDESCFABRICANTE: TdxDBGridMaskColumn;
    dbgConsultaOBSORCACEITO: TdxDBGridMaskColumn;
    dbgConsultaOBSORCCOMUNICADO: TdxDBGridMaskColumn;
    dbgConsultaDESCRICAO: TdxDBGridMaskColumn;
    dbgConsultaCOR: TdxDBGridMaskColumn;
    dbgConsultaTECNICODAOS: TdxDBGridMaskColumn;
        ...
        procedure ppeTipoEquipamentoCloseUp(Sender: TObject; var Text: string;
            var Accept: Boolean);
...
procedure TRptConsultaOS.FormClose(Sender: TObject; var Action: TCloseAction);
var
    sValor: string;
begin
//  sValor := 'N';
...
procedure TRptConsultaOS.dxBarSubItem4Click(Sender: TObject);
begin
    inherited;
    close;
end;

procedure TRptConsultaOS.btSairClick(Sender: TObject);
begin
    inherited;
    close;
end;

procedure TRptConsultaOS.FormCreate(Sender: TObject);
...
procedure TRptConsultaOS.btLayoutLarguraClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.LarguraAutomatica(btLayoutLargura.Checked);
end;

procedure TRptConsultaOS.btImprimirVisualClick(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.btAgrupamentoPainelClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.MostrarPainelAgrupamento(btAgrupamentoPainel.Checked);
end;

procedure TRptConsultaOS.btDadosFiltrarClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.AtivarFiltro(btDadosFiltrar.Checked);
end;

procedure TRptConsultaOS.btSumarizacaoRodapeClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.MostrarRodape(btSumarizacaoRodape.Checked);
end;

procedure TRptConsultaOS.btLayoutGradeClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.MostrarGrade(btLayoutGrade.Checked);
end;

procedure TRptConsultaOS.TotalizarEmBaixoClick(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.btLayoutFontClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.FonteCabecalho;
end;

procedure TRptConsultaOS.btDadosFontClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.FonteDados;
end;

procedure TRptConsultaOS.btExportacaoHtmlClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ExportarHtml(self);
end;

procedure TRptConsultaOS.btExportacaoExcelClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ExportarExcel(self);
end;

procedure TRptConsultaOS.btExportacaoXmlClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ExportarXml(self);
end;

procedure TRptConsultaOS.btExportacaoTextoClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ExportarTexto(self);
end;

procedure TRptConsultaOS.btAgrupamentoExpandirClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ExpandirGrupos;
end;

procedure TRptConsultaOS.btLayoutColunasClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.AdicionarColunas;
end;

procedure TRptConsultaOS.btImprimirImpressoraClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.Print;
end;

procedure TRptConsultaOS.btAgrupamentoResumirClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ResumirGrupos;
end;

procedure TRptConsultaOS.btAgrupamentoFontClick(Sender: TObject);
begin
    dbgConsulta.FonteGrupo;
end;

procedure TRptConsultaOS.FormShow(Sender: TObject);
var
    sWhere: string;
    ArquivoIni: TIniFile;
...
begin
  ...
  {Template Padrão}
    ...
    C_TiposEquipamento.Open;
    clbTipoEquipamento.SetDataSet(C_TiposEquipamento);
    clbTipoEquipamento.UpdateItems;
    ppeTipoEquipamento.Text := clbTipoEquipamento.Selecionados(true);
...
procedure TRptConsultaOS.RefreshMsg(var Msg: TMessage);
begin
    Refresh;
end;

procedure TRptConsultaOS.Refresh;
begin
...
procedure TRptConsultaOS.RefreshDataSets;
var
    i, j: integer;
    Key: Variant;
    s: string;
...
procedure TRptConsultaOS.CorFundo1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.CorFundoDados;
end;

procedure TRptConsultaOS.CorFundo2Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.CorFundoGrupo;
end;

procedure TRptConsultaOS.btDadosMouseUp(Sender: TObject; Button: TMouseButton;
    Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btAgrupamentoMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btLayoutMouseUp(Sender: TObject; Button: TMouseButton;
    Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btSumarizacaoMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btExportacaoMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btImprimirMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.Ajuda1Click(Sender: TObject);
begin
    inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptConsultaOS.RelatrioPadro1Click(Sender: TObject);
begin
    inherited;
//  HtmlHelp(GetDesktopWindow, PChar(DMProject.sHelp), HH_HELP_CONTEXT, TMenuItem(sender).helpcontext);
end;

procedure TRptConsultaOS.btHelpClick(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.EnviarparaoEmail1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.PrintEmail(FormsComponent.Caption + ';' + DMProject.sNomeEmpresa);
end;

procedure TRptConsultaOS.dbgConsultaMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.dbgConsultaDblClick(Sender: TObject);
begin
    inherited;
    bCarregando := false;
end;

procedure TRptConsultaOS.BarradeBotoesClick(Sender: TObject);
begin
    inherited;
    TS_Panel1.Visible := not TS_Panel1.Visible;
end;

procedure TRptConsultaOS.GridPrinterLinkCustomDrawHeaderCell(
    Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
    AClientRect: TRect; AColumn: TdxTreeListColumn; var AText: string;
    var AColor: TColor; AFont: TFont; var ATextAlignX: TdxTextAlignX;
    var ATextAlignY: TdxTextAlignY; var ASorted: TdxCellSortOrder;
...
procedure TRptConsultaOS.GridPrinterLinkCustomDrawPageHeader(Sender: TObject;
    ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect; ANom,
    ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
var
    APixel: Integer;
...
procedure TRptConsultaOS.GridPrinterLinkCustomDrawReportLinkTitle(
    Sender: TBasedxReportLink; ACanvas: TCanvas; ARect: TRect; ANom,
    ADenom: Integer; var ATextAlignX: TdxTextAlignX;
    var ATextAlignY: TdxTextAlignY; var AColor: TColor; AFont: TFont;
    var ADone: Boolean);
...
procedure TRptConsultaOS.GridPrinterLinkMeasureReportLinkTitle(
    Sender: TBasedxReportLink; var AHeight: Integer);
var
    s: string;
begin
...
function TRptConsultaOS.getTitulos: string;
var sString: string;
    i: integer;
begin
    sString := '';
...
procedure TRptConsultaOS.GerarEtiquetas1Click(Sender: TObject);
var sSQL: string;
begin
    inherited;
...
function TRptConsultaOS.getSQLParam(Query: TIBQuery): string;
var sSQL: string;
    i: integer;
begin
    with Query do begin
...
procedure TRptConsultaOS.GridPrinterLinkCustomDrawCell(
    Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
...
procedure TRptConsultaOS.FormatoPijamaClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.FormatoPijama;
end;

procedure TRptConsultaOS.ConfigurarColunaClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ConfigurarColuna;
end;

procedure TRptConsultaOS.CordaGrade1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.CorGrade;
end;

procedure TRptConsultaOS.ppmLayoutPopup(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.AlturaAutomtica1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.AlturaCelula;
end;

procedure TRptConsultaOS.ppmSumarizacaoPopup(Sender: TObject);
begin
    inherited;
    with dbgConsulta do begin
...
procedure TRptConsultaOS.GridPrinterLinkCustomDrawRowFooterCell(
    Sender: TBasedxReportLink; ACanvas: TCanvas; ABoundsRect,
    AClientRect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
...
procedure TRptConsultaOS.CongelarClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.CongelarColuna(dbgConsulta.TS_SelectedColumn);
end;

procedure TRptConsultaOS.DescongelarColuna1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.DesCongelarColuna;
end;

procedure TRptConsultaOS.ppmDadosPopup(Sender: TObject);
begin
    inherited;
    btDadosFiltrar.Checked := dbgConsulta.Filter.Active;
end;

procedure TRptConsultaOS.ppmAgrupamentoPopup(Sender: TObject);
begin
    inherited;
    btAgrupamentoPainel.Checked := dbgConsulta.ShowGroupPanel;
end;

procedure TRptConsultaOS.tulodoRelatrio1Click(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.SalvarTemplate1Click(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.CarregarTemplate1Click(Sender: TObject);
...
procedure TRptConsultaOS.btAjudaMouseUp(Sender: TObject; Button: TMouseButton;
    Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.NenhumTemplate1Click(Sender: TObject);
begin
    inherited;
    with dbgConsulta do begin
        TS_TemplatePadrao := '';
...
procedure TRptConsultaOS.setTemplatePadrao;
begin
...
function TRptConsultaOS.getTemplatePadrao: string;
begin
    with Q_SQLReport do begin
        close;
...
procedure TRptConsultaOS.DefinirPadraoClick(Sender: TObject);
begin
    inherited;
    with dbgConsulta do begin
...
procedure TRptConsultaOS.ExcluirTemplate1Click(Sender: TObject);
...
procedure TRptConsultaOS.FormResize(Sender: TObject);
begin
    inherited;
...
function TRptConsultaOS.getCampos: string;
begin
    with Q_SQLReport do begin
        close;
...
function TRptConsultaOS.getTabelas: string;
var sTabelas: string;
    i: integer;
begin
    with Q_SQLReport do begin
...
function TRptConsultaOS.getListaTabelas(bSomenteAdicional: boolean = false): TStringList;
...
procedure TRptConsultaOS.CriarCampos;
var i: integer;
    sCampo: string;
begin
    with Q_SQLReport do begin
...
procedure TRptConsultaOS.CriarCampo(sCampo, sTitulo, sTipoCampo: string);
...
procedure TRptConsultaOS.RemoverCampo(sCampo: string);
begin
...
procedure TRptConsultaOS.AdicionarCampo(sTabelas, sCampo, sTitulo, sTipo, sAlias: string);
...
procedure TRptConsultaOS.AdicionarSubSelect(sSelect, sAlias, sTitulo, sTipo: string);
var bJaExiste: boolean;
    sCampo: string;
begin
...
function TRptConsultaOS.getListaCampos: TStringList;
var i: integer;
...
procedure TRptConsultaOS.AlterarCampo(CampoAlterar, Campo, Tabela, Titulo, Tipo, Alias: string);
...
procedure TRptConsultaOS.AlterarSubSelect(CampoAlterar, Select, Alias, Titulo, Tipo: string);
var sCampo, sCampoAdicional, sTituloAdicional, sTipoAdicional: string;
    Index: integer;
begin
    with Q_SQLReport do begin
...
procedure TRptConsultaOS.TotalizarEmCimaClick(Sender: TObject);
begin
    inherited;
...
procedure TRptConsultaOS.ppmTemplatesPopup(Sender: TObject);
begin
    inherited;
    DefinirPadrao.Enabled := dbgConsulta.TS_TemplatePadrao <> '';
end;

procedure TRptConsultaOS.TrocaTemplate(Sender: TObject);
begin
...
procedure TRptConsultaOS.btTemplatesMouseUp(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
    inherited;
...
procedure TRptConsultaOS.btTemplatesMouseDown(Sender: TObject;
    Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var i: integer;
    MenuItem: TMenuItem;
begin
...
procedure TRptConsultaOS.ppmSelTemplatePopup(Sender: TObject);
var i: integer;
begin
    inherited;
...
function TRptConsultaOS.getTipoCampo(sTabela, sCampo: string): string;
begin
    with Q_SQLReport do begin
        close;
...
function TRptConsultaOS.getTipoCampo(sSQL: string): string;
begin
    with Q_SQLReport do begin
        close;
...
procedure TRptConsultaOS.Adicionar2Click(Sender: TObject);
...
procedure TRptConsultaOS.Alterar2Click(Sender: TObject);
var sCampo: string;
    Index: integer;
begin
    inherited;
...
procedure TRptConsultaOS.Remover2Click(Sender: TObject);
...
procedure TRptConsultaOS.ExecutarArquivo1Click(Sender: TObject);
...
procedure TRptConsultaOS.btMostrarCabClick(Sender: TObject);
begin
    inherited;
    dbgConsulta.ShowHeader := btMostrarCab.Checked;
end;

procedure TRptConsultaOS.btLayoutMouseMove(Sender: TObject; Shift: TShiftState;
    X, Y: Integer);
var i: integer;
begin
    inherited;
...
procedure TRptConsultaOS.dbgConsultaMouseMove(Sender: TObject;
    Shift: TShiftState; X, Y: Integer);
var i: integer;
begin
    inherited;
...
procedure TRptConsultaOS.ConfigurarPgina1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.ConfigurarPagina(self);
end;

procedure TRptConsultaOS.LayoutdeImpresso1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.LayoutImpressao(self);
end;

procedure TRptConsultaOS.ConfigurarImpressora1Click(Sender: TObject);
begin
    inherited;
    dbgConsulta.ConfigurarImpressora(self);
end;

procedure TRptConsultaOS.FormVisible(var Msg: TMessage);
var
...
procedure TRptConsultaOS.GridPrinterStartGenerateReport(Sender: TObject;
    AReportLink: TBasedxReportLink);
...
procedure TRptConsultaOS.GridPrinterBeforeDesignReport(Sender: TObject;
    AReportLink: TBasedxReportLink;
    ADesignWindow: TAbstractdxReportLinkDesignWindow);
begin
    inherited;
...
procedure TRptConsultaOS.GridPrinterDesignReport(Sender: TObject;
    AReportLink: TBasedxReportLink; var ADone: Boolean);
begin
    inherited;
    if ADone then
...
procedure TRptConsultaOS.ConfigurarRelatrio1Click(Sender: TObject);
var i: integer;
begin
    inherited;
...
procedure TRptConsultaOS.GravaRelatorio(sRelatorio, sTitulo, sCabecalho, sImpressora: string; nCopias: integer);
begin
    with Q_SQLReport do begin
        close;
        sql.text := 'update relatorios ' +
...
procedure TRptConsultaOS.GetFULLSELECT;
begin
    with Q_FullSelect do begin
...
procedure TRptConsultaOS.ppeTipoEquipamentoCloseUp(Sender: TObject;
    var Text: string; var Accept: Boolean);
begin
    inherited;
    Text := clbTipoEquipamento.Selecionados(true);
    Accept := true;
end;

procedure TRptConsultaOS.ppeStatusCloseUp(Sender: TObject;
    var Text: string; var Accept: Boolean);
begin
    inherited;
...
procedure TRptConsultaOS.btAtualizarClick(Sender: TObject);
begin
    inherited;
    Atualizar;
end;

procedure TRptConsultaOS.Atualizar;
var
    sTipoEquipamento, sStatus: string;
begin
    with C_Consulta do begin Close;
        CommandText := 'SELECT ' +
            ...
            '       M.descricao,          ' +
            '       M.cor,                ' +
            '       fav.nome as tecnicodaos ' +
            '    From SERVICOS S            ' +
            '    INNER JOIN FAVORECIDOS F ON F.FAVORECIDO = S.CLIENTE                 ' +
            '    left JOIN FAVORECIDOS Fa ON S.TECNICOENTRADA = fa.codigo and fa.tipo_func = ''E'' ' +
            '    left JOIN FAVORECIDOS Fav ON S.tecnicodaos = fav.favorecido                     ' +
            ...
            '    LEFT JOIN FABRICANTES FR ON FR.FABRICANTE = M.FABRICANTE  WHERE s.statusservico > 0        ';

        sTipoEquipamento := clbTipoEquipamento.Selecionados;
        sStatus := clbStatus.Selecionados;

        if dfNOS.Text <> '' then begin
            CommandText := CommandText + 'and S.OSNUMERO LIKE ''%' + dfNOS.Text + '%'' ';
        end
        else begin
            if (sTipoEquipamento <> '') then begin
                CommandText := CommandText + 'and TE.TIPOEQUIPAMENTO in (' + sTipoEquipamento + ') ';
            end;

            if (sStatus <> '') then begin
                CommandText := CommandText + 'and SS.STATUSSERVICO in (' + sStatus + ') ';
            end;

            if (dfFavorecido.ID <> 0) then begin
                CommandText := CommandText + 'and S.CLIENTE in (' + inttostr(dfFavorecido.ID) + ') ';
            end;
        end;
