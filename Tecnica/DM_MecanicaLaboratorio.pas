...
type
  TDMMecanicaLaboratorio = class(TDMManutencao)
    ...
    C_TabelaHODOMETRO: TIntegerField;
    C_TabelaPRISMA: TStringField;
    C_TabelaCOR: TStringField;
    C_TabelaMOTOR: TStringField;
    C_TabelaMOTORISTA: TStringField;
    C_TabelaANO: TStringField;
    Q_MarcaModelo: TIBQuery;
    P_MarcaModelo: TDataSetProvider;
    C_MarcaModelo: TClientDataSet;
    IntegerField2: TIntegerField;
    C_MarcaModeloDS: TDataSource;
    C_MarcaModeloID: TIntegerField;
    C_MarcaModeloMARCA: TIntegerField;
    C_MarcaModeloMODELO: TStringField;
    C_TabelaMARCAMODELO: TIntegerField;
    C_TabelalkMarcaModelo: TStringField;
...
var
  DMMecanicaLaboratorio: TDMMecanicaLaboratorio;

implementation

uses DM_Projeto, Funcoes, dlg_AcompanhamentoMecanica;

{$R *.dfm}


procedure TDMMecanicaLaboratorio.GerarSerial;
Begin
...
Procedure TDMMecanicaLaboratorio.PegarOSNumero;
Begin
...
procedure TDMMecanicaLaboratorio.C_TabelaNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TDMMecanicaLaboratorio.DataModuleCreate(Sender: TObject);
begin
  inherited;
  DMMecanicaLaboratorio:=Self;
  nSeq := -1;
end;

procedure TDMMecanicaLaboratorio.C_ServicosDetCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TDMMecanicaLaboratorio.DMComponentGravar2_AposIDS_Tabela(
  Sender: TObject);
var nEquip : integer;
begin
  inherited;
...
procedure TDMMecanicaLaboratorio.DMComponentGravar1_Iniciar(
...
procedure TDMMecanicaLaboratorio.DMComponentPesquisar1_Iniciar(
...
procedure TDMMecanicaLaboratorio.C_ServicosDetNewRecord(
  DataSet: TDataSet);
begin
  inherited;
  Dec(nSeq);
...
procedure TDMMecanicaLaboratorio.C_TabelaSTATUSSERVICOValidate(
  Sender: TField);
begin
  inherited;
...
procedure TDMMecanicaLaboratorio.C_ServicosDetITEMChange(
  Sender: TField);
begin
  inherited;
